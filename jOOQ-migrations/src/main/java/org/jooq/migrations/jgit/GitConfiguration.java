...
public class GitConfiguration {
  ...
  /** The patterns of files in the repository to be searched for schema definition files. */
  @NotNull
  ...
  /** The patterns of files in the repository to be searched for increment definition files. */
  @NotNull
  ...
  /**
   * Whether the uncommitted (and untracked) changes in the index should be included as virtual
   * {@link Commit}.
   */
  @NotNull
