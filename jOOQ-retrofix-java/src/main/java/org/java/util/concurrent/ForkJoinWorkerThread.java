 ...
 * also need to supply a custom {@link ForkJoinPool.ForkJoinWorkerThreadFactory} to <a
 * href="../../../java8/util/concurrent/ForkJoinPool.html#ForkJoinPool-int-java8.util.concurrent.ForkJoinPool.ForkJoinWorkerThreadFactory-java.lang.Thread.UncaughtExceptionHandler-boolean-int-int-int-java8.util.function.Predicate-long-java.util.concurrent.TimeUnit-">
...
public class ForkJoinWorkerThread extends Thread {
  ...
  ForkJoinWorkerThread(
      ForkJoinPool pool, ClassLoader ccl, ThreadGroup threadGroup, AccessControlContext acc) {
        ...
        AccessController.doPrivileged(
            new PrivilegedAction<ThreadGroup>() {
              ...
              public ThreadGroup run() {
                ...
                for (ThreadGroup p; (p = group.getParent()) != null; ) group = p;
