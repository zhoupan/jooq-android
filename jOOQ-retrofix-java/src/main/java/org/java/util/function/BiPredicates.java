 ...
 * interface methods in the {@link BiPredicate} interface.
 */
public final class BiPredicates {
  ...
  public static <T, U> BiPredicate<T, U> and(
      BiPredicate<? super T, ? super U> this_, BiPredicate<? super T, ? super U> other) {
   ...
   * @throws NullPointerException if {@code this_} is null
   */
  public static <T, U> BiPredicate<T, U> negate(BiPredicate<? super T, ? super U> this_) {
    Objects.requireNonNull(this_);
   ...
   * @param other a predicate that will be logically-ORed with {@code this_} predicate
