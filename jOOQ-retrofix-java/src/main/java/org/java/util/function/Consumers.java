 ...
 * interface methods in the {@link Consumer} interface.
 */
public final class Consumers {

  /**
   * Returns a composed {@code Consumer} that performs, in sequence, the {@code this_} operation
   ...
   * @return a composed {@code Consumer} that performs in sequence the {@code this_} operation
