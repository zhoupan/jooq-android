 ...
 *
 * <p>Unless otherwise stated, streams are created as sequential streams. A sequential stream can be
...
final class Streams {
  ...
  static final class RangeIntSpliterator implements Spliterator.OfInt {
    ...
    /**
     * The spliterator size below which the spliterator will be split at the mid-point to produce
     * balanced splits. Above this size the spliterator will be split at a ratio of
     * 1:(RIGHT_BALANCED_SPLIT_RATIO - 1) to produce right-balanced splits.
     *
     * <p>Such splitting ensures that for very large ranges that the left side of the range will
     ...
     *
     * <p>This is optimized for cases such as IntStream.range(0, Integer.MAX_VALUE) that is
     * implemented as range of 0 to Integer.MAX_VALUE but is likely to be augmented with a limit
     * operation that limits the number of elements to a count lower than this threshold.
     */
   ...
   *
   * <p>This implementation cannot be used for ranges whose size is greater than Long.MAX_VALUE
   */
  static final class RangeLongSpliterator implements Spliterator.OfLong {
     ...
     * higher-depth for the right side of the range.
     *
     * <p>This is optimized for cases such as LongStream.range(0, Long.MAX_VALUE) that is
     * implemented as range of 0 to Long.MAX_VALUE but is likely to be augmented with a limit
     * operation that limits the number of elements to a count lower than this threshold.
     */
  ...
  static final class IntStreamBuilderImpl
    ...
    public IntStream build() {
      ...
      if (c >= 0) {
        ...
        // the spliterator of the spined buffer
        return (c < 2)
            ? StreamSupport.intStream(this, false)
  ...
  static final class LongStreamBuilderImpl
    ...
    @Override
    public org.java.util.stream.LongStream.Builder add(long t) {
      accept(t);
      return this;
    }
    ...
    public LongStream build() {
      ...
      if (c >= 0) {
        ...
        // the spliterator of the spined buffer
        return (c < 2)
            ? StreamSupport.longStream(this, false)
  ...
  static final class DoubleStreamBuilderImpl
    ...
    @Override
    public org.java.util.stream.DoubleStream.Builder add(double t) {
      accept(t);
      return this;
    }
    ...
    public DoubleStream build() {
      ...
      if (c >= 0) {
        ...
        // the spliterator of the spined buffer
        return (c < 2)
            ? StreamSupport.doubleStream(this, false)
  ...
  abstract static class ConcatSpliterator<T, T_SPLITR extends Spliterator<T>>
    ...
    public int characteristics() {
      if (beforeSplit) {
        ...
        return aSpliterator.characteristics()
  ...
  /**
   * Given two Runnables, return a Runnable that executes both in sequence, even if the first throws
   * an exception, and if both throw exceptions, add any exceptions thrown by the second as
