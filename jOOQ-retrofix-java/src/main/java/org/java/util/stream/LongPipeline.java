 ...
 * whose elements are of type {@code long}.
 *
...
abstract class LongPipeline<E_IN> extends AbstractPipeline<E_IN, Long, LongStream>
   ...
   * The implementation attempts to cast to a Spliterator.OfLong, and throws an exception if this
  ...
  @Override
  final <P_IN> Spliterator<Long> wrap(
      PipelineHelper<Long> ph, Supplier<Spliterator<P_IN>> supplier, boolean isParallel) {
  ...
  public final DoubleStream asDoubleStream() {
    return new DoublePipeline.StatelessOp<Long>(
        this, StreamShape.LONG_VALUE, StreamOpFlag.NOT_DISTINCT) {
  ...
  public final LongStream map(LongUnaryOperator mapper) {
    ...
    return new StatelessOp<Long>(
        this, StreamShape.LONG_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  public final IntStream mapToInt(LongToIntFunction mapper) {
    Objects.requireNonNull(mapper);
    return new IntPipeline.StatelessOp<Long>(
        this, StreamShape.LONG_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  public final LongStream mapMulti(LongMapMultiConsumer mapper) {
    Objects.requireNonNull(mapper);
    return new LongPipeline.StatelessOp<Long>(
        this,
        StreamShape.LONG_VALUE,
        StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT | StreamOpFlag.NOT_SIZED) {
  ...
  public final LongStream skip(long n) {
    ...
    if (n == 0) return this;
    else return SliceOps.makeLong(this, n, -1);
  }
  ...
  public final LongSummaryStatistics summaryStatistics() {
    return collect(
        Collectors.LNG_SUM_STATS, LongSummaryStatistics::accept, LongSummaryStatistics::combine);
  }
  ...
  abstract static class StatelessOp<E_IN> extends LongPipeline<E_IN> {
    ...
    /**
     * Construct a new LongStream by appending a stateless intermediate operation to an existing
     * stream.
     *
  ...
  abstract static class StatefulOp<E_IN> extends LongPipeline<E_IN> {
    ...
    /**
     * Construct a new LongStream by appending a stateful intermediate operation to an existing
     * stream.
     *
     * @param upstream The upstream pipeline stage
     * @param inputShape The stream shape for the upstream pipeline stage
