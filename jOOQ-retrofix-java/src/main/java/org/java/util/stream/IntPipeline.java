 ...
 * whose elements are of type {@code int}.
 *
...
abstract class IntPipeline<E_IN> extends AbstractPipeline<E_IN, Integer, IntStream>
   ...
   * The implementation attempts to cast to a Spliterator.OfInt, and throws an exception if this
  ...
  @Override
  final <P_IN> Node<Integer> evaluateToNode(
  ...
  @Override
  final <P_IN> Spliterator<Integer> wrap(
      PipelineHelper<Integer> ph, Supplier<Spliterator<P_IN>> supplier, boolean isParallel) {
  ...
  final Node.Builder<Integer> makeNodeBuilder(
      long exactSizeIfKnown, IntFunction<Integer[]> generator) {
  ...
  public final IntStream map(IntUnaryOperator mapper) {
    ...
    return new StatelessOp<Integer>(
        this, StreamShape.INT_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  public final LongStream mapToLong(IntToLongFunction mapper) {
    Objects.requireNonNull(mapper);
    return new LongPipeline.StatelessOp<Integer>(
        this, StreamShape.INT_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  public final DoubleStream mapToDouble(IntToDoubleFunction mapper) {
    Objects.requireNonNull(mapper);
    return new DoublePipeline.StatelessOp<Integer>(
        this, StreamShape.INT_VALUE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  public final IntStream skip(long n) {
    ...
    if (n == 0) return this;
    else return SliceOps.makeInt(this, n, -1);
  }
  ...
  public final IntSummaryStatistics summaryStatistics() {
    return collect(
        Collectors.INT_SUM_STATS, IntSummaryStatistics::accept, IntSummaryStatistics::combine);
  }
  ...
  abstract static class StatelessOp<E_IN> extends IntPipeline<E_IN> {
    ...
    /**
     * Construct a new IntStream by appending a stateless intermediate operation to an existing
     * stream.
     *
  ...
  abstract static class StatefulOp<E_IN> extends IntPipeline<E_IN> {
    ...
    /**
     * Construct a new IntStream by appending a stateful intermediate operation to an existing
     * stream.
     *
     * @param upstream The upstream pipeline stage
     * @param inputShape The stream shape for the upstream pipeline stage
