 ...
 * whose elements are of type {@code U}.
 *
...
abstract class ReferencePipeline<P_IN, P_OUT> extends AbstractPipeline<P_IN, P_OUT, Stream<P_OUT>>
  ...
  @Override
  final <P_IN_> Node<P_OUT> evaluateToNode(
  ...
  @Override
  final <P_IN_> Spliterator<P_OUT> wrap(
      PipelineHelper<P_OUT> ph, Supplier<Spliterator<P_IN_>> supplier, boolean isParallel) {
  ...
  public final <R> Stream<R> map(Function<? super P_OUT, ? extends R> mapper) {
    ...
    return new StatelessOp<P_OUT, R>(
  ...
  public final IntStream mapToInt(ToIntFunction<? super P_OUT> mapper) {
    Objects.requireNonNull(mapper);
    return new IntPipeline.StatelessOp<P_OUT>(
        this, StreamShape.REFERENCE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  public final LongStream mapToLong(ToLongFunction<? super P_OUT> mapper) {
    Objects.requireNonNull(mapper);
    return new LongPipeline.StatelessOp<P_OUT>(
        this, StreamShape.REFERENCE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  public final DoubleStream mapToDouble(ToDoubleFunction<? super P_OUT> mapper) {
    Objects.requireNonNull(mapper);
    return new DoublePipeline.StatelessOp<P_OUT>(
        this, StreamShape.REFERENCE, StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT) {
  ...
  @Override
  public final DoubleStream mapMultiToDouble(
      BiConsumer<? super P_OUT, ? super DoubleConsumer> mapper) {
    Objects.requireNonNull(mapper);
    return new DoublePipeline.StatelessOp<P_OUT>(
        this,
        StreamShape.REFERENCE,
  ...
  public final <A> A[] toArray(IntFunction<A[]> generator) {
    ...
    // The runtime type of U is never checked for equality with the component type of the runtime
    // type of A[].
    ...
    return (A[])
        Nodes.flatten((Node<A>) evaluateToArrayNode(rawGenerator), generator).asArray(rawGenerator);
  }
  ...
  @Override
  public final <R> R reduce(
      R identity, BiFunction<R, ? super P_OUT, R> accumulator, BinaryOperator<R> combiner) {
