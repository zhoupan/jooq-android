...
/**
 * A description of various additional {@link Table} options to describe the table runtime meta
 * model.
 *
 * @author Lukas Eder
 */
public final class TableOptions implements Serializable {
  ...
  /** Create a new {@link TableOptions} object for a {@link TableType#VIEW} of unknown content. */
  @NotNull
  ...
  /**
   * Create a new {@link TableOptions} object for a {@link TableType#MATERIALIZED_VIEW} of unknown
   * content.
   */
  @NotNull
   ...
   * The table type.
   *
   * <p>This is never <code>null</code>.
   */
  @NotNull
   ...
   *
   * <p>This may be <code>null</code>, if it is undefined, or unknown, or if the table is not a
   * {@link TableType#TEMPORARY} table.
   */
  @Nullable
  ...
  /**
   * The <code>SELECT</code> statement defining this {@link TableType#VIEW} or {@link
  ...
  /**
   * The <code>SELECT</code> statement defining this {@link TableType#VIEW} or {@link
   * TableType#MATERIALIZED_VIEW}, in source form.
   *
   * <p>This may be <code>null</code>, if it is undefined, or unknown, or if the table is not a
   * view.
   */
  ...
  public boolean equals(Object obj) {
    ...
    if (onCommit != other.onCommit) return false;
    if (select == null) {
