...
public interface InsertOnConflictWhereStep<R extends Record> extends InsertReturningStep<R> {
  ...
  /**
   * Add a <code>WHERE</code> clause to the <code>INSERT</code> statement's <code>
  ...
  /**
   * Add a <code>WHERE</code> clause to the <code>INSERT</code> statement's <code>
   * ON DUPLICATE KEY UPDATE</code> or <code>ON CONFLICT ... DO UPDATE</code> clause, connecting
   * them with each other using {@link Operator#AND}.
   */
  @NotNull
  @CheckReturnValue
  @Support({CUBRID, DERBY, H2, MARIADB, POSTGRES, SQLITE})
  ...
  /**
   * Add a <code>WHERE EXISTS</code> clause to the <code>INSERT</code> statement's <code>
   * ON DUPLICATE KEY UPDATE</code> or <code>ON CONFLICT ... DO UPDATE</code> clause.
   */
  @NotNull
  @CheckReturnValue
  ...
  /**
   * Add a <code>WHERE NOT EXISTS</code> clause to the <code>INSERT</code> statement's <code>
   * ON DUPLICATE KEY UPDATE</code> or <code>ON CONFLICT ... DO UPDATE</code> clause.
   */
  @NotNull
  @CheckReturnValue
