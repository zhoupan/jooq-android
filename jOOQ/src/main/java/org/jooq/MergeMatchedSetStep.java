...
public interface MergeMatchedSetStep<R extends Record> {
  ...
  /**
   * Set values for <code>UPDATE</code> in the <code>MERGE</code> statement's <code>WHEN MATCHED
   * </code> clause.
   */
  @NotNull
  @CheckReturnValue
  ...
  /**
   * Set a <code>null</code> value for <code>UPDATE</code> in the <code>MERGE</code> statement's
  ...
  /**
   * Set multiple values for <code>UPDATE</code> in the <code>MERGE</code> statement's <code>
   * WHEN MATCHED</code> clause.
   *
