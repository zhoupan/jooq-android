...
public interface WindowSpecificationRowsStep extends WindowSpecificationFinalStep {
  ...
  /** Add a <code>ROWS UNBOUNDED PRECEDING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rowsUnboundedPreceding();

  /** Add a <code>ROWS [number] PRECEDING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rowsPreceding(int number);

  /** Add a <code>ROWS CURRENT ROW</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rowsCurrentRow();

  /** Add a <code>ROWS UNBOUNDED FOLLOWING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rowsUnboundedFollowing();

  /** Add a <code>ROWS [number] FOLLOWING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rowsFollowing(int number);

  /**
   * Add a <code>ROWS BETWEEN UNBOUNDED PRECEDING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /**
   * Add a <code>ROWS BETWEEN [number] PRECEDING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /** Add a <code>ROWS BETWEEN CURRENT ROW ...</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationRowsAndStep rowsBetweenCurrentRow();

  /**
   * Add a <code>ROWS BETWEEN UNBOUNDED FOLLOWING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /**
   * Add a <code>ROWS BETWEEN [number] FOLLOWING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /** Add a <code>RANGE UNBOUNDED PRECEDING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rangeUnboundedPreceding();

  /** Add a <code>RANGE [number] PRECEDING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rangePreceding(int number);

  /** Add a <code>RANGE CURRENT ROW</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rangeCurrentRow();

  /** Add a <code>RANGE UNBOUNDED FOLLOWING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rangeUnboundedFollowing();

  /** Add a <code>RANGE [number] FOLLOWING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep rangeFollowing(int number);

  /**
   * Add a <code>RANGE BETWEEN UNBOUNDED PRECEDING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /**
   * Add a <code>RANGE BETWEEN [number] PRECEDING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /** Add a <code>RANGE BETWEEN CURRENT ROW ...</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  WindowSpecificationRowsAndStep rangeBetweenCurrentRow();

  /**
   * Add a <code>RANGE BETWEEN UNBOUNDED FOLLOWING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /**
   * Add a <code>RANGE BETWEEN [number] FOLLOWING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, MARIADB, MYSQL, POSTGRES, SQLITE})
  ...
  /** Add a <code>GROUPS UNBOUNDED PRECEDING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep groupsUnboundedPreceding();

  /** Add a <code>GROUPS [number] PRECEDING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep groupsPreceding(int number);

  /** Add a <code>GROUPS CURRENT ROW</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep groupsCurrentRow();

  /** Add a <code>GROUPS UNBOUNDED FOLLOWING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep groupsUnboundedFollowing();

  /** Add a <code>GROUPS [number] FOLLOWING</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  WindowSpecificationExcludeStep groupsFollowing(int number);

  /**
   * Add a <code>GROUPS BETWEEN UNBOUNDED PRECEDING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  ...
  /**
   * Add a <code>GROUPS BETWEEN [number] PRECEDING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  ...
  /** Add a <code>GROUPS BETWEEN CURRENT ROW ...</code> frame clause to the window specification. */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  WindowSpecificationRowsAndStep groupsBetweenCurrentRow();

  /**
   * Add a <code>GROUPS BETWEEN UNBOUNDED FOLLOWING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
  ...
  /**
   * Add a <code>GROUPS BETWEEN [number] FOLLOWING ...</code> frame clause to the window
   * specification.
   */
  @NotNull
  @Support({H2, POSTGRES, SQLITE})
