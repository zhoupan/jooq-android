...
public interface SelectOrderByStep<R extends Record> extends SelectLimitStep<R> {
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3> SelectSeekStep3<R, T1, T2, T3> orderBy(
      OrderField<T1> field1, OrderField<T2> field2, OrderField<T3> field3);

  /** Add an <code>ORDER BY</code> clause to the query. */
  @NotNull
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4> SelectSeekStep4<R, T1, T2, T3, T4> orderBy(
      OrderField<T1> field1, OrderField<T2> field2, OrderField<T3> field3, OrderField<T4> field4);

  /** Add an <code>ORDER BY</code> clause to the query. */
  @NotNull
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5> SelectSeekStep5<R, T1, T2, T3, T4, T5> orderBy(
      OrderField<T1> field1,
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5, T6> SelectSeekStep6<R, T1, T2, T3, T4, T5, T6> orderBy(
      OrderField<T1> field1,
      OrderField<T2> field2,
      OrderField<T3> field3,
      OrderField<T4> field4,
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5, T6, T7> SelectSeekStep7<R, T1, T2, T3, T4, T5, T6, T7> orderBy(
      OrderField<T1> field1,
      OrderField<T2> field2,
      OrderField<T3> field3,
      OrderField<T4> field4,
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5, T6, T7, T8> SelectSeekStep8<R, T1, T2, T3, T4, T5, T6, T7, T8> orderBy(
      OrderField<T1> field1,
      OrderField<T2> field2,
      OrderField<T3> field3,
      OrderField<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9>
      SelectSeekStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> orderBy(
          OrderField<T1> field1,
          OrderField<T2> field2,
          OrderField<T3> field3,
          OrderField<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
      SelectSeekStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> orderBy(
          OrderField<T1> field1,
          OrderField<T2> field2,
          OrderField<T3> field3,
          OrderField<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
      SelectSeekStep11<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> orderBy(
          OrderField<T1> field1,
          OrderField<T2> field2,
          OrderField<T3> field3,
          OrderField<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
      SelectSeekStep12<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> orderBy(
          OrderField<T1> field1,
          OrderField<T2> field2,
          OrderField<T3> field3,
          OrderField<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
      SelectSeekStep13<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> orderBy(
          OrderField<T1> field1,
          OrderField<T2> field2,
          OrderField<T3> field3,
          OrderField<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
      SelectSeekStep14<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> orderBy(
          OrderField<T1> field1,
          OrderField<T2> field2,
          OrderField<T3> field3,
          OrderField<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>
      SelectSeekStep15<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> orderBy(
          OrderField<T1> field1,
          OrderField<T2> field2,
          OrderField<T3> field3,
          OrderField<T4> field4,
   ...
   *
   * <p>Note, you can use <code>orderBy(DSL.val(1).desc())</code> or <code>
   * orderBy(DSL.literal(1).desc())</code> to apply descending ordering
   */
  @NotNull
  @CheckReturnValue
  @Support
