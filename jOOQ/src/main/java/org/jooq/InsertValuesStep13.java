 ...
 * @author Lukas Eder
 */
public interface InsertValuesStep13<
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep13<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> values(
      T1 value1,
      T2 value2,
      T3 value3,
      T4 value4,
  ...
  InsertValuesStep13<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> valuesOfRows(
      Row13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>... values);
  ...
  @Support
  InsertValuesStep13<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> valuesOfRows(
      Collection<? extends Row13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> values);
  ...
  @Support
  @SuppressWarnings("unchecked")
  InsertValuesStep13<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> valuesOfRecords(
      Record13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>... values);
  ...
  @Support
  InsertValuesStep13<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> valuesOfRecords(
      Collection<? extends Record13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>>
          values);
