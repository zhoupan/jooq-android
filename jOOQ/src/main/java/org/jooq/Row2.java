...
public interface Row2<T1, T2> extends Row, SelectField<Record2<T1, T2>> {
  ...
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record2} to custom type {@link RecordMapper} that
   * can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING</code>
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function2)}, this method attempts to work
  ...
  <U> SelectField<U> mapping(
      Class<U> uType, Function2<? super T1, ? super T2, ? extends U> function);
  ...
  @NotNull
  @Support
  Condition between(Row2<T1, T2> minValue, Row2<T1, T2> maxValue);
  ...
  @NotNull
  @Support
  Condition between(Record2<T1, T2> minValue, Record2<T1, T2> maxValue);
  ...
  @NotNull
  @Support
  Condition betweenSymmetric(Row2<T1, T2> minValue, Row2<T1, T2> maxValue);
  ...
  @NotNull
  @Support
  Condition betweenSymmetric(Record2<T1, T2> minValue, Record2<T1, T2> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetween(Row2<T1, T2> minValue, Row2<T1, T2> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetween(Record2<T1, T2> minValue, Record2<T1, T2> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetweenSymmetric(Row2<T1, T2> minValue, Row2<T1, T2> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetweenSymmetric(Record2<T1, T2> minValue, Record2<T1, T2> maxValue);
   ...
   *
   * <p>The SQL standard specifies a temporal <code>OVERLAPS</code> predicate, which comes in two
   * flavours:
   *
   * <ul>
   *   <li><code>(DATE, DATE) OVERLAPS (DATE, DATE)</code>
   *   <li><code>(DATE, INTERVAL) OVERLAPS (DATE, INTERVAL)</code>
   * </ul>
   *
   * <p>jOOQ also supports arbitrary 2-degree row value expression comparisons, by emulating them as
   * such <code><pre>
   * -- This predicate
   * (A, B) OVERLAPS (C, D)
   *
