 ...
 * @author Lukas Eder
 */
public interface InsertValuesStep4<R extends Record, T1, T2, T3, T4>
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep4<R, T1, T2, T3, T4> values(
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep4<R, T1, T2, T3, T4> valuesOfRows(
      Collection<? extends Row4<T1, T2, T3, T4>> values);
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep4<R, T1, T2, T3, T4> valuesOfRecords(
      Collection<? extends Record4<T1, T2, T3, T4>> values);
