 ...
 *
 * <p>In order to facilitate the lifecycle management of <code>MigrationListener</code> instances
 * that are provided to a jOOQ {@link Configuration}, clients can implement this API. To jOOQ, it is
 * thus irrelevant, if migration listeners are stateful or stateless, local to an execution, or
...
public interface MigrationListenerProvider {
   ...
   *
   * <p>An <code>MigrationListener</code> shall be provided exactly once per {@link Migration}
