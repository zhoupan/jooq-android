 ...
 * as the more specific, type-safe {@link Record3} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl3<T1, T2, T3> extends AbstractRecord
    implements InternalRecord, Record3<T1, T2, T3> {
  ...
  @Override
  public <T, U> Record3<T1, T2, T3> with(
