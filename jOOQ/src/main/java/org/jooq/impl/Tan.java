...
final class Tan extends AbstractField<BigDecimal> {

  private final Field<? extends Number> number;

  Tan(Field<? extends Number> number) {
    super(N_TAN, allNotNull(NUMERIC, number));
  ...
  public boolean equals(Object that) {
    if (that instanceof Tan) {
      return StringUtils.equals(number, ((Tan) that).number);
