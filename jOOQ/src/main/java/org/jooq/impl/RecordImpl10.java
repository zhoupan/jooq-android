 ...
 * as the more specific, type-safe {@link Record10} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends AbstractRecord
    implements InternalRecord, Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
  ...
  @Override
  public final Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> values(
  ...
  @Override
  public <T, U> Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> with(
