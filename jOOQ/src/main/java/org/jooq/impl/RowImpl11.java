...
final class RowImpl11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
    extends AbstractRow<Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>
    implements Row11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
  ...
  @Override
  public final BetweenAndStep11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> betweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11) {
  ...
  @Override
  public final BetweenAndStep11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> notBetween(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11) {
    return notBetween(
        row(
            Tools.field(t1, (DataType) dataType(0)),
  ...
  @Override
  public final BetweenAndStep11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> notBetweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11) {
  ...
  public final Condition in(
      Collection<? extends Row11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> rows) {
    return new RowInCondition(this, new QueryPartList<Row>(rows), false);
  }

  @Override
  public final Condition in(
      Result<? extends Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> result) {
