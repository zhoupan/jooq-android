...
final class ResultsImpl extends AbstractList<Result<Record>> implements Results {
  ...
  static final class /* record */ ResultOrRowsImpl implements ResultOrRows {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof ResultOrRowsImpl)) return false;
      ResultOrRowsImpl other = (ResultOrRowsImpl) o;
      if (!java.util.Objects.equals(this.result, other.result)) return false;
      if (!java.util.Objects.equals(this.rows, other.rows)) return false;
      if (!java.util.Objects.equals(this.exception, other.exception)) return false;
      return true;
    }

    @Override
    public int hashCode() {
      return java.util.Objects.hash(this.result, this.rows, this.exception);
    }
    ...
    public String toString() {
      ...
      else if (result != null) return result.toString();
      else return "" + rows;
    }
  }
}
