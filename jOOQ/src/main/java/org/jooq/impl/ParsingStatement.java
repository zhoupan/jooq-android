...
final class ParsingStatement implements CallableStatement {
  ...
  public final long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
    return statement.executeLargeUpdate(
        translate(connection.configuration, sql).sql, autoGeneratedKeys);
  }

  @Override
  public final long executeLargeUpdate(String sql, int[] columnIndexes) throws SQLException {
    return statement.executeLargeUpdate(
        translate(connection.configuration, sql).sql, columnIndexes);
  }
  ...
  public final int[] executeBatch() throws SQLException {
    if (statement != null) return statement.executeBatch();
    else return prepareAndBind().executeBatch();
  }

  @Override
  public final long[] executeLargeBatch() throws SQLException {
    if (statement != null) return statement.executeLargeBatch();
    else return prepareAndBind().executeLargeBatch();
  }
  ...
  public final void close() throws SQLException {
    ...
    else if (statement != null) statement.close();
  }

  @Override
  public final boolean isClosed() throws SQLException {
    if (last != null) return last.isClosed();
    else if (statement != null) return statement.isClosed();
    else return true;
  }
  ...
  public final void setNull(int parameterIndex, int sqlType) throws SQLException {
    set(
        parameterIndex,
        () -> val(null, DefaultDataType.getDataType(connection.configuration.dialect(), sqlType)));
  }
  ...
  public final void setObject(int parameterIndex, Object x, int targetSqlType) throws SQLException {
    set(
        parameterIndex,
        () ->
            val(x, DefaultDataType.getDataType(connection.configuration.dialect(), targetSqlType)));
  }
  ...
  public final void setObject(
      int parameterIndex, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException {
    set(
        parameterIndex,
        () ->
            val(x, DefaultDataType.getDataType(connection.configuration.dialect(), targetSqlType)));
  ...
  @Override
  public final void setObject(
      String parameterName, Object x, SQLType targetSqlType, int scaleOrLength)
      throws SQLException {
    throw new SQLFeatureNotSupportedException();
  }
