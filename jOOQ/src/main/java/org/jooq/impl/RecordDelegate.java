...
/**
 * A stub for {@link Record} objects, abstracting {@link RecordListener} lifecycle handling.
 *
 * @author Lukas Eder
 */
final class RecordDelegate<R extends Record> {
  ...
  static final <R extends Record> RecordDelegate<R> delegate(
      Configuration configuration, R record, RecordLifecycleType type) {
    return new RecordDelegate<>(configuration, () -> record, null, type);
  }
