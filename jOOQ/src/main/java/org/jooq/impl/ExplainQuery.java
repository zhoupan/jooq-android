...
final class ExplainQuery {
  ...
  static Explain explain(final DSLContext ctx, final Query query) {
    ...
    switch (ctx.family()) {
      ...
      case POSTGRES:
        {
          Matcher matcher =
              Pattern.compile(".*\\bcost=\\d+\\.\\d+\\.\\.(\\d+\\.\\d+)\\s+rows=(\\d+).*")
  ...
  private static final /* record */ class ExplainImpl implements Explain {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof ExplainImpl)) return false;
      ExplainImpl other = (ExplainImpl) o;
      if (!java.util.Objects.equals(this.rows, other.rows)) return false;
      if (!java.util.Objects.equals(this.cost, other.cost)) return false;
      if (!java.util.Objects.equals(this.plan, other.plan)) return false;
      return true;
    }

    @Override
    public int hashCode() {
      return java.util.Objects.hash(this.rows, this.cost, this.plan);
    }
