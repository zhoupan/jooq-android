...
/**
 * [#2965] This is a {@link Configuration}-based cache that can cache reflection information and
 * other things
 */
final class Cache {
   ...
   *
   * @param configuration The configuration that may cache the outcome of the cached operation.
          ...
          configuration.data(
              ...
              cacheOrNull =
                  defaultIfNull(
                      configuration
                          .cacheProvider()
                          .provide(new DefaultCacheContext(configuration, type)),
                      NULL));
      }
    }
  ...
  private static final class /* record */ Key2 implements Serializable {
    ...
    public boolean equals(Object o) {
      ...
      Key2 other = (Key2) o;
      if (!java.util.Objects.equals(this.key1, other.key1)) return false;
      if (!java.util.Objects.equals(this.key2, other.key2)) return false;
      return true;
    }

    @Override
    public int hashCode() {
      return java.util.Objects.hash(this.key1, this.key2);
    }

    @Override
    public String toString() {
      return new StringBuilder("Key2[")
          .append("key1=")
          .append(this.key1)
          .append(", key2=")
          .append(this.key2)
