 ...
 * as the more specific, type-safe {@link Record7} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl7<T1, T2, T3, T4, T5, T6, T7> extends AbstractRecord
    implements InternalRecord, Record7<T1, T2, T3, T4, T5, T6, T7> {
  ...
  @Override
  public final Record7<T1, T2, T3, T4, T5, T6, T7> values(
  ...
  @Override
  public <T, U> Record7<T1, T2, T3, T4, T5, T6, T7> with(
