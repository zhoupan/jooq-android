 ...
 *
 * <p>These types are usually the ones that are referenced by generated source code. Most RDBMS have
 * an almost 1:1 mapping between their vendor-specific types and the ones in this class (except
 * Oracle). Some RDBMS also have extensions, e.g. for geospacial data types. See the
 * dialect-specific data type classes for more information.
 *
 * @author Lukas Eder
 */
public final class SQLDataType {
  ...
  public static final DataType<String> LONGVARCHAR =
      new DefaultDataType<>(null, String.class, "longvarchar(l)");
  ...
  public static final DataType<String> NVARCHAR =
      new DefaultDataType<>(null, String.class, "nvarchar(l)");
  ...
  public static final DataType<String> NCHAR =
      new DefaultDataType<>(null, String.class, "nchar(l)");
  ...
  public static final DataType<String> LONGNVARCHAR =
      new DefaultDataType<>(null, String.class, "longnvarchar(l)");
  ...
  public static final DataType<Short> SMALLINT =
      new DefaultDataType<>(null, Short.class, "smallint");

  /** The {@link Types#INTEGER} type. */
  public static final DataType<Integer> INTEGER =
      new DefaultDataType<>(null, Integer.class, "integer");
  ...
  public static final DataType<BigInteger> DECIMAL_INTEGER =
      new DefaultDataType<>(null, BigInteger.class, "decimal_integer");
  ...
  public static final DataType<BigDecimal> DECIMAL =
      new DefaultDataType<>(null, BigDecimal.class, "decimal(p, s)");
  ...
  public static final DataType<Timestamp> TIMESTAMP =
      new DefaultDataType<>(null, Timestamp.class, "timestamp(p)");
  ...
  /**
   * A vendor specific <code>INTERVAL YEAR TO SECOND</code> data type, which combines {@link
   * #INTERVALYEARTOMONTH} and {@link #INTERVALDAYTOSECOND}.
   */
  public static final DataType<YearToSecond> INTERVAL =
      new DefaultDataType<>(null, YearToSecond.class, "interval");

  /** The SQL standard <code>INTERVAL YEAR TO MONTH</code> data type. */
  public static final DataType<YearToMonth> INTERVALYEARTOMONTH =
      new DefaultDataType<>(null, YearToMonth.class, "interval year to month");

  /** The SQL standard <code>INTERVAL DAY TO SECOND</code> data type. */
  public static final DataType<DayToSecond> INTERVALDAYTOSECOND =
      new DefaultDataType<>(null, DayToSecond.class, "interval day to second");
  ...
  public static final DataType<LocalTime> LOCALTIME =
      new DefaultDataType<>(null, LocalTime.class, "time(p)");
  ...
  public static final DataType<LocalDateTime> LOCALDATETIME =
      new DefaultDataType<>(null, LocalDateTime.class, "timestamp(p)");
   ...
   *
   * <p>The behaviour of this data type is influenced by the JDBC driver and the database that is
   * used. Some databases support actual time zones (as in {@link ZonedDateTime}), other databases
   * support only offsets (as in {@link OffsetDateTime}). Some databases retain the actual time zone
   * information that is stored and reproduce it with every fetch (e.g. {@link SQLDialect#ORACLE}),
   * others use this type as a synonym for a timestamp in UTC (e.g. {@link SQLDialect#POSTGRES}),
   * producing possibly a value in the current time zone of the database or the client. Please refer
   * to your database for more information about the behaviour of this data type.
   */
  public static final DataType<OffsetTime> OFFSETTIME =
      new DefaultDataType<>(null, OffsetTime.class, "time(p) with time zone");
  ...
  public static final DataType<OffsetDateTime> OFFSETDATETIME =
      new DefaultDataType<>(null, OffsetDateTime.class, "timestamp(p) with time zone");
   ...
   * The {@link Types#TIME_WITH_TIMEZONE} type.
   *
   * <p>An alias for {@link #OFFSETTIME}
   */
   ...
   * The {@link Types#TIMESTAMP_WITH_TIMEZONE} type.
   *
   * <p>An alias for {@link #OFFSETDATETIME}
   */
   ...
   *
   * <p>Neither JDBC, nor most SQL databases support the <code>INSTANT</code> data type, which is
   * often the only kind of timestamp which can be expected to behave across all server and client
   * time zone settings. This implementation is backed by the database vendor's <code>
   * TIMESTAMP WITH TIME ZONE</code> data type implementation, which may (e.g. Oracle) or may not
   * (e.g. PostgreSQL) store the timestamp information. Irrespective of that storage, this type will
   * always produce time zone agnostic instants in client code.
   */
  public static final DataType<Instant> INSTANT =
      new DefaultDataType<>(null, Instant.class, "instant");
  ...
  public static final DataType<byte[]> VARBINARY =
      new DefaultDataType<>(null, byte[].class, "varbinary(l)");
  ...
  public static final DataType<byte[]> LONGVARBINARY =
      new DefaultDataType<>(null, byte[].class, "longvarbinary(l)");
   ...
   *
   * <p>This is not a SQL or JDBC standard. This type emulates REF CURSOR types and similar
   * constructs
   */
  @SuppressWarnings({"unchecked", "rawtypes"})
  public static final DataType<Result<Record>> RESULT =
      new DefaultDataType<>(null, (Class) Result.class, "result");

  /**
   * The {@link UUID} type.
   *
   * <p>This is not a SQL or JDBC standard. This type handles UUID types where they are supported
   */
   ...
   * The {@link JSON} type.
   *
   * <p>This is not a SQL or JDBC standard. This type handles JSON types where they are supported.
   */
   ...
   * The {@link JSONB} type.
   *
   * <p>This is not a SQL or JDBC standard. This type handles JSONB types where they are supported
   */
   ...
   * The {@link XML} type.
   *
   * <p>This is not a SQL or JDBC standard. This type handles XML types where they are supported
   */
  ...
  private static final void initJSR310Types(SQLDialect family) {
    ...
    new DefaultDataType<>(
        ...
        DATE.getTypeName(configuration),
        DATE.getCastTypeName(configuration));
    new DefaultDataType<>(
        family,
        SQLDataType.LOCALTIME,
        TIME.getTypeName(configuration),
        TIME.getCastTypeName(configuration));
    new DefaultDataType<>(
        family,
        SQLDataType.LOCALDATETIME,
        TIMESTAMP.getTypeName(configuration),
        TIMESTAMP.getCastTypeName(configuration));
  }
