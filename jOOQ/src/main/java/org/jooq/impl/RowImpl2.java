...
final class RowImpl2<T1, T2> extends AbstractRow<Record2<T1, T2>> implements Row2<T1, T2> {
  ...
  public final Condition compare(Comparator comparator, T1 t1, T2 t2) {
    return compare(
        comparator,
        row(Tools.field(t1, (DataType) dataType(0)), Tools.field(t2, (DataType) dataType(1))));
  }
  ...
  public final Condition compare(
      Comparator comparator, QuantifiedSelect<? extends Record2<T1, T2>> select) {
    return new RowSubqueryCondition(this, select, comparator);
  }
  ...
  public final Condition isNotDistinctFrom(T1 t1, T2 t2) {
    return isNotDistinctFrom(
        Tools.field(t1, (DataType) dataType(0)), Tools.field(t2, (DataType) dataType(1)));
  }
