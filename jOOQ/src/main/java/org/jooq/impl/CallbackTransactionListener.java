...
public final class CallbackTransactionListener implements TransactionListener {
  ...
  public final void beginStart(TransactionContext ctx) {
    if (onBeginStart != null) onBeginStart.accept(ctx);
  }

  @Override
  public final void beginEnd(TransactionContext ctx) {
    if (onBeginEnd != null) onBeginEnd.accept(ctx);
  }

  @Override
  public final void commitStart(TransactionContext ctx) {
    if (onCommitStart != null) onCommitStart.accept(ctx);
  }

  @Override
  public final void commitEnd(TransactionContext ctx) {
    if (onCommitEnd != null) onCommitEnd.accept(ctx);
  }

  @Override
  public final void rollbackStart(TransactionContext ctx) {
    if (onRollbackStart != null) onRollbackStart.accept(ctx);
  }

  @Override
  public final void rollbackEnd(TransactionContext ctx) {
    if (onRollbackEnd != null) onRollbackEnd.accept(ctx);
  }

  public final CallbackTransactionListener onBeginStart(
      Consumer<? super TransactionContext> newOnBeginStart) {
    return new CallbackTransactionListener(
        newOnBeginStart, onBeginEnd, onCommitStart, onCommitEnd, onRollbackStart, onRollbackEnd);
  }

  public final CallbackTransactionListener onBeginEnd(
      Consumer<? super TransactionContext> newOnBeginEnd) {
    return new CallbackTransactionListener(
        onBeginStart, newOnBeginEnd, onCommitStart, onCommitEnd, onRollbackStart, onRollbackEnd);
  }

  public final CallbackTransactionListener onCommitStart(
      Consumer<? super TransactionContext> newOnCommitStart) {
    return new CallbackTransactionListener(
        onBeginStart, onBeginEnd, newOnCommitStart, onCommitEnd, onRollbackStart, onRollbackEnd);
  }

  public final CallbackTransactionListener onCommitEnd(
      Consumer<? super TransactionContext> newOnCommitEnd) {
    return new CallbackTransactionListener(
        onBeginStart, onBeginEnd, onCommitStart, newOnCommitEnd, onRollbackStart, onRollbackEnd);
  }

  public final CallbackTransactionListener onRollbackStart(
      Consumer<? super TransactionContext> newOnRollbackStart) {
    return new CallbackTransactionListener(
        onBeginStart, onBeginEnd, onCommitStart, onCommitEnd, newOnRollbackStart, onRollbackEnd);
  }

  public final CallbackTransactionListener onRollbackEnd(
      Consumer<? super TransactionContext> newOnRollbackEnd) {
    return new CallbackTransactionListener(
        onBeginStart, onBeginEnd, onCommitStart, onCommitEnd, onRollbackStart, newOnRollbackEnd);
  }
}
