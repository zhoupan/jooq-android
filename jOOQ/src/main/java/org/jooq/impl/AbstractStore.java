 ...
 *
 * <p>This base class takes care of implementing similar {@link Attachable} and {@link
 * Object#equals(Object)}, {@link Object#hashCode()} behaviour.
 *
 * @author Lukas Eder
 */
abstract class AbstractStore extends AbstractFormattable implements Attachable {
  ...
  /**
   * This method coincides with {@link Record#get(int)} and <code>ArrayRecordImpl.getValue(int)
   * </code>
   */
