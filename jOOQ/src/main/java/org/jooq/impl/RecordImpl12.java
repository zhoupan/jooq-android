 ...
 * as the more specific, type-safe {@link Record12} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> extends AbstractRecord
    implements InternalRecord, Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> {
  ...
  @Override
  public final Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> values(
  ...
  @Override
  public <T> Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> with(
      Field<T> field, T value) {
    return (Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>) super.with(field, value);
  }

  @Override
  public <T, U> Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> with(
