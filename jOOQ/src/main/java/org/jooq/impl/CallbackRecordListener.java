...
public final class CallbackRecordListener implements RecordListener {
  ...
  public final void storeStart(RecordContext ctx) {
    if (onStoreStart != null) onStoreStart.accept(ctx);
  }

  @Override
  public final void storeEnd(RecordContext ctx) {
    if (onStoreEnd != null) onStoreEnd.accept(ctx);
  }

  @Override
  public final void insertStart(RecordContext ctx) {
    if (onInsertStart != null) onInsertStart.accept(ctx);
  }

  @Override
  public final void insertEnd(RecordContext ctx) {
    if (onInsertEnd != null) onInsertEnd.accept(ctx);
  }

  @Override
  public final void updateStart(RecordContext ctx) {
    if (onUpdateStart != null) onUpdateStart.accept(ctx);
  }

  @Override
  public final void updateEnd(RecordContext ctx) {
    if (onUpdateEnd != null) onUpdateEnd.accept(ctx);
  }

  @Override
  public final void mergeStart(RecordContext ctx) {
    if (onMergeStart != null) onMergeStart.accept(ctx);
  }

  @Override
  public final void mergeEnd(RecordContext ctx) {
    if (onMergeEnd != null) onMergeEnd.accept(ctx);
  }

  @Override
  public final void deleteStart(RecordContext ctx) {
    if (onDeleteStart != null) onDeleteStart.accept(ctx);
  }

  @Override
  public final void deleteEnd(RecordContext ctx) {
    if (onDeleteEnd != null) onDeleteEnd.accept(ctx);
  }

  @Override
  public final void loadStart(RecordContext ctx) {
    if (onLoadStart != null) onLoadStart.accept(ctx);
  }

  @Override
  public final void loadEnd(RecordContext ctx) {
    if (onLoadEnd != null) onLoadEnd.accept(ctx);
  }

  @Override
  public final void refreshStart(RecordContext ctx) {
    if (onRefreshStart != null) onRefreshStart.accept(ctx);
  }

  @Override
  public final void refreshEnd(RecordContext ctx) {
    if (onRefreshEnd != null) onRefreshEnd.accept(ctx);
  }

  @Override
  public final void exception(RecordContext ctx) {
    if (onException != null) onException.accept(ctx);
  }

  public final CallbackRecordListener onStoreStart(
      Consumer<? super RecordContext> newOnStoreStart) {
  ...
  public final CallbackRecordListener onInsertStart(
      Consumer<? super RecordContext> newOnInsertStart) {
    return new CallbackRecordListener(
        onStoreStart,
        onStoreEnd,
        newOnInsertStart,
  ...
  public final CallbackRecordListener onUpdateStart(
  ...
  public final CallbackRecordListener onMergeStart(
      Consumer<? super RecordContext> newOnMergeStart) {
    return new CallbackRecordListener(
        onStoreStart,
        onStoreEnd,
        onInsertStart,
  ...
  public final CallbackRecordListener onDeleteStart(
      Consumer<? super RecordContext> newOnDeleteStart) {
    return new CallbackRecordListener(
        onStoreStart,
        onStoreEnd,
        onInsertStart,
  ...
  public final CallbackRecordListener onRefreshStart(
      Consumer<? super RecordContext> newOnRefreshStart) {
    return new CallbackRecordListener(
        onStoreStart,
        onStoreEnd,
        onInsertStart,
  ...
  public final CallbackRecordListener onRefreshEnd(
      Consumer<? super RecordContext> newOnRefreshEnd) {
    return new CallbackRecordListener(
        onStoreStart,
        onStoreEnd,
        onInsertStart,
