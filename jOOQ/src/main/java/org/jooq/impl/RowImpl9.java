...
final class RowImpl9<T1, T2, T3, T4, T5, T6, T7, T8, T9>
    extends AbstractRow<Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>>
    implements Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  ...
  public final Condition compare(
      Comparator comparator, Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> row) {
    return new RowCondition(this, row, comparator);
  }

  @Override
  public final Condition compare(
      Comparator comparator, Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> record) {
  ...
  // ------------------------------------------------------------------------
  @Override
  public final BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> between(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) {
    return between(
        row(
            Tools.field(t1, (DataType) dataType(0)),
  ...
  @Override
  public final BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> betweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) {
  ...
  @Override
  public final BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> notBetween(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) {
    return notBetween(
        row(
            Tools.field(t1, (DataType) dataType(0)),
  ...
  @Override
  public final BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> notBetweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9) {
  ...
  public final Condition notIn(
      Collection<? extends Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> rows) {
    return new RowInCondition(this, new QueryPartList<Row>(rows), true);
  }

  @Override
  public final Condition notIn(
      Result<? extends Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> result) {
