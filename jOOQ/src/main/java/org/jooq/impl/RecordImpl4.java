 ...
 * as the more specific, type-safe {@link Record4} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl4<T1, T2, T3, T4> extends AbstractRecord
    implements InternalRecord, Record4<T1, T2, T3, T4> {
  ...
  @Override
  public <T, U> Record4<T1, T2, T3, T4> with(
