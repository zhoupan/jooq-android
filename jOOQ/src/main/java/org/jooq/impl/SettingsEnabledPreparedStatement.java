...
/**
 * A proxy for a JDBC {@link PreparedStatement} that emulates the API of a prepared statement, when
 * in fact executing an ad-hoc {@link Statement}
 *
 * @author Lukas Eder
 */
final class SettingsEnabledPreparedStatement extends DefaultStatement implements PreparedStatement {
  ...
  private SettingsEnabledPreparedStatement(
      Connection connection, String sql, MethodType type, Statement statement) {
    super(statement);
  ...
  SettingsEnabledPreparedStatement(
      Connection connection, String sql, int resultSetType, int resultSetConcurrency)
      throws SQLException {
    this(
        connection,
        sql,
        MethodType.SQL_RST_RSC,
  ...
  /** A descriptor for the various methods that can create a prespared statement */
  private static enum MethodType {
    ...
    /** Corresponds to {@link Connection#prepareStatement(String, int, int, int)} */
    SQL_RST_RSC_RSH,

    /** Corresponds to {@link Connection#prepareStatement(String, int)} */
    SQL_AGK,

    /** Corresponds to {@link Connection#prepareStatement(String, int[])} */
    SQL_CI,

    /** Corresponds to {@link Connection#prepareStatement(String, String[])} */
    SQL_CN,

    /** Corresponds to {@link Connection#createStatement()} and {@link Statement#executeBatch()} */
    BATCH
  }
  ...
  public final void addBatch() throws SQLException {
    throw new UnsupportedOperationException(
        "Cannot batch execute statements on PreparedStatementProxy");
  }
  ...
  public final ResultSetMetaData getMetaData() throws SQLException {
    throw new UnsupportedOperationException(
        "Cannot fetch ResultSetMetaData early on PreparedStatementProxy");
  }

  @Override
  public final void clearParameters() throws SQLException {
    throw new UnsupportedOperationException(
        "Cannot operate on bind values on a PreparedStatementProxy");
  }
