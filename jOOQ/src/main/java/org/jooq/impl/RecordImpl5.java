 ...
 * as the more specific, type-safe {@link Record5} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl5<T1, T2, T3, T4, T5> extends AbstractRecord
    implements InternalRecord, Record5<T1, T2, T3, T4, T5> {
  ...
  @Override
  public <T, U> Record5<T1, T2, T3, T4, T5> with(
