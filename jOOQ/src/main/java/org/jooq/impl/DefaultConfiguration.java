...
/**
 * A default implementation for configurations within a {@link DSLContext}, if no custom
 * configuration was supplied to {@link DSL#using(Configuration)}.
 *
 * <p>The <code>DefaultConfiguration</code>
 *
 * @author Lukas Eder
 */
public class DefaultConfiguration extends AbstractConfiguration {
   ...
   *
   * <p>This copies all properties from a pre-existing configuration into a new, derived one.
   *
   ...
   *
   * <p>This constructor has been made package-private to allow for adding new configuration
   * properties in the future, without breaking client code. Consider creating a configuration by
   * chaining calls to various <code>derive()</code> methods.
   */
  DefaultConfiguration(
  ...
  @Override
  public final Configuration deriveSettings(
  ...
  public final Configuration set(MigrationListenerProvider... newMigrationListenerProviders) {
    this.migrationListenerProviders =
  ...
  public final Configuration set(TransactionListenerProvider... newTransactionListenerProviders) {
    this.transactionListenerProviders =
  ...
  public final Configuration set(DiagnosticsListenerProvider... newDiagnosticsListenerProviders) {
    this.diagnosticsListenerProviders =
  ...
  public final void setRecordListenerProvider(
  ...
  public final void setExecuteListenerProvider(
  ...
  public final void setTransactionListenerProvider(
      TransactionListenerProvider... newTransactionListenerProviders) {
  ...
  public final void setDiagnosticsListenerProvider(
      DiagnosticsListenerProvider... newDiagnosticsListenerProviders) {
  ...
  public final ConnectionProvider systemConnectionProvider() {
    return systemConnectionProvider != null ? systemConnectionProvider : connectionProvider();
  }

  @Override
  public final ConnectionFactory connectionFactory() {
    return connectionFactory != null ? connectionFactory : new NoConnectionFactory();
  }

  @Override
  public final MetaProvider metaProvider() {
    return metaProvider != null ? metaProvider : new DefaultMetaProvider(this);
  }
  ...
  public final ExecutorProvider executorProvider() {
    return executorProvider != null ? executorProvider : new DefaultExecutorProvider();
  }

  @Override
  public final CacheProvider cacheProvider() {
    return cacheProvider != null ? cacheProvider : new DefaultCacheProvider();
  }
  ...
  public final UnwrapperProvider unwrapperProvider() {
    return unwrapperProvider != null ? unwrapperProvider : new DefaultUnwrapperProvider();
  }

  @Override
  public final CharsetProvider charsetProvider() {
    return charsetProvider != null ? charsetProvider : new DefaultCharsetProvider();
  }

  @Override
  public final ConverterProvider converterProvider() {
    return converterProvider != null ? converterProvider : new DefaultConverterProvider();
  }
  ...
  private void writeObject(ObjectOutputStream oos) throws IOException {
    ...
    oos.writeObject(
        interpreterConnectionProvider instanceof Serializable
            ? interpreterConnectionProvider
            : null);
    oos.writeObject(
        systemConnectionProvider instanceof Serializable ? systemConnectionProvider : null);
    oos.writeObject(metaProvider instanceof Serializable ? metaProvider : null);
    oos.writeObject(commitProvider instanceof Serializable ? commitProvider : null);
