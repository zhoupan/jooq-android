...
/**
 * A wrapped DML query ({@link Insert}, {@link Update}, {@link Delete}) that works like a {@link
 * ResultQuery}.
 *
 * @author Lukas Eder
 */
final class DMLQueryAsResultQuery<R extends Record, Q extends AbstractDMLQuery<R>>
  ...
  public final Field<?>[] getFields() {
    if (coerceFields != null && !coerceFields.isEmpty()) return coerceFields.toArray(EMPTY_FIELD);
    else return delegate.returningResolvedAsterisks.toArray(EMPTY_FIELD);
  }
  ...
  public final Class<? extends R> getRecordType() {
    ...
    else if (returningResult) return (Class<? extends R>) delegate.getRecordType();
