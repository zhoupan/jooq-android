...
final class CovarPop extends DefaultAggregateFunction<BigDecimal> {

  CovarPop(Field<? extends Number> y, Field<? extends Number> x) {
    super(false, N_COVAR_POP, NUMERIC, nullSafeNotNull(y, INTEGER), nullSafeNotNull(x, INTEGER));
  }
