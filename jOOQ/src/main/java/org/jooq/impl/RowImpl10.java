...
final class RowImpl10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
    extends AbstractRow<Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>
    implements Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
  ...
  public final Condition compare(
      Comparator comparator, Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> row) {
    return new RowCondition(this, row, comparator);
  }

  @Override
  public final Condition compare(
      Comparator comparator, Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> record) {
  ...
  @Override
  public final BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> between(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10) {
    return between(
        row(
            Tools.field(t1, (DataType) dataType(0)),
  ...
  public final Condition between(
      Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> minValue,
  ...
  @Override
  public final Condition between(
      Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> minValue,
      Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> maxValue) {
    return between(minValue).and(maxValue);
  }

  @Override
  public final BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> betweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10) {
  ...
  @Override
  public final BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> notBetween(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10) {
    return notBetween(
        row(
            Tools.field(t1, (DataType) dataType(0)),
  ...
  @Override
  public final BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> notBetweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10) {
  ...
  public final Condition in(
      Collection<? extends Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> rows) {
    return new RowInCondition(this, new QueryPartList<Row>(rows), false);
  }

  @Override
  public final Condition in(
      Result<? extends Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> result) {
