...
/**
 * A {@link CompletionStage} that defaults to an {@link ExecutorProvider} for all async methods that
 * do not have an explicit {@link Executor}.
 *
 * <p>In jOOQ, the {@link ExecutorProvider} SPI is used for all types of asynchronous tasks. It
 * overrides standard {@link CompletableFuture} behaviour in case users prefer not to use the {@link
...
final class ExecutorProviderCompletionStage<T> implements CompletionStage<T> {
  ...
  static final <T> ExecutorProviderCompletionStage<T> of(
      CompletionStage<T> delegate, ExecutorProvider provider) {
  ...
  @Override
  public final <U> CompletionStage<U> thenApplyAsync(
  ...
  @Override
  public final CompletionStage<Void> runAfterEitherAsync(
  ...
  @Override
  public final <U> CompletionStage<U> thenCompose(
      Function<? super T, ? extends CompletionStage<U>> fn) {
    return of(delegate.thenCompose(fn), provider);
  }

  @Override
  public final <U> CompletionStage<U> thenComposeAsync(
      Function<? super T, ? extends CompletionStage<U>> fn) {
  ...
  @Override
  public final <U> CompletionStage<U> handleAsync(
