 ...
 *
 * <p>This implementation just wraps a JDBC {@link Connection} and provides jOOQ with the same
 * connection for every query. jOOQ will not call any transaction-related methods on the supplied
 * connection. Instead, jOOQ provides you with convenient access to those methods, wrapping any
 * checked {@link SQLException} into an unchecked {@link DataAccessException}
 *
