...
final class AlterSequenceImpl<T extends Number> extends AbstractDDLQuery
  ...
  AlterSequenceImpl(
      Configuration configuration, Sequence<T> sequence, boolean alterSequenceIfExists) {
    this(
        configuration,
        sequence,
