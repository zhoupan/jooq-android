...
final class RowImpl3<T1, T2, T3> extends AbstractRow<Record3<T1, T2, T3>>
    implements Row3<T1, T2, T3> {
  ...
  public final Condition compare(
      Comparator comparator, Select<? extends Record3<T1, T2, T3>> select) {
    return new RowSubqueryCondition(this, select, comparator);
  }

  @Override
  public final Condition compare(
      Comparator comparator, QuantifiedSelect<? extends Record3<T1, T2, T3>> select) {
    return new RowSubqueryCondition(this, select, comparator);
  }
  ...
  @Override
  public final BetweenAndStep3<T1, T2, T3> betweenSymmetric(
      Field<T1> t1, Field<T2> t2, Field<T3> t3) {
  ...
  public final Condition betweenSymmetric(
      Record3<T1, T2, T3> minValue, Record3<T1, T2, T3> maxValue) {
    return betweenSymmetric(minValue).and(maxValue);
  }
  ...
  @Override
  public final BetweenAndStep3<T1, T2, T3> notBetweenSymmetric(
      Field<T1> t1, Field<T2> t2, Field<T3> t3) {
