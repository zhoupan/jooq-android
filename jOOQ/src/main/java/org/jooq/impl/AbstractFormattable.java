...
/**
 * A common base implementation for {@link Formattable}, implementing all the various convenience
 * overloads.
 *
 * @author Lukas Eder
 */
abstract class AbstractFormattable implements Formattable, Serializable {
  ...
  @Override
  public final void formatCSV(
      OutputStream stream, boolean header, char delimiter, String nullString) {
