 ...
 * as the more specific, type-safe {@link Record9} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends AbstractRecord
    implements InternalRecord, Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> {
  ...
  @Override
  public final Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> values(
  ...
  @Override
  public <T, U> Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> with(
