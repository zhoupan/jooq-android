...
public final class CallbackVisitListener implements VisitListener {
  ...
  public final void clauseStart(VisitContext context) {
    if (onClauseStart != null) onClauseStart.accept(context);
  }

  @Override
  public final void clauseEnd(VisitContext context) {
    if (onClauseEnd != null) onClauseEnd.accept(context);
  }

  @Override
  public final void visitStart(VisitContext context) {
    if (onVisitStart != null) onVisitStart.accept(context);
  }

  @Override
  public final void visitEnd(VisitContext context) {
    if (onVisitEnd != null) onVisitEnd.accept(context);
  }

  public final CallbackVisitListener onClauseStart(
      Consumer<? super VisitContext> newOnClauseStart) {
    return new CallbackVisitListener(newOnClauseStart, onClauseEnd, onVisitStart, onVisitEnd);
  }

  public final CallbackVisitListener onClauseEnd(Consumer<? super VisitContext> newOnClauseEnd) {
    return new CallbackVisitListener(onClauseStart, newOnClauseEnd, onVisitStart, onVisitEnd);
  }

  public final CallbackVisitListener onVisitStart(Consumer<? super VisitContext> newOnVisitStart) {
    return new CallbackVisitListener(onClauseStart, onClauseEnd, newOnVisitStart, onVisitEnd);
  }

  public final CallbackVisitListener onVisitEnd(Consumer<? super VisitContext> newOnVisitEnd) {
    return new CallbackVisitListener(onClauseStart, onClauseEnd, onVisitStart, newOnVisitEnd);
  }
}
