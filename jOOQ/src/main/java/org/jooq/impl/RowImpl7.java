...
final class RowImpl7<T1, T2, T3, T4, T5, T6, T7>
    extends AbstractRow<Record7<T1, T2, T3, T4, T5, T6, T7>>
    implements Row7<T1, T2, T3, T4, T5, T6, T7> {
  ...
  public final Condition compare(
      Comparator comparator, Record7<T1, T2, T3, T4, T5, T6, T7> record) {
    return new RowCondition(this, record.valuesRow(), comparator);
  }

  @Override
  public final Condition compare(
      Comparator comparator, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
    return compare(
        comparator,
        row(
  ...
  // ------------------------------------------------------------------------
  @Override
  public final BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> between(
  ...
  @Override
  public final BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> betweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
  ...
  @Override
  public final BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> notBetween(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
    return notBetween(
        row(
            Tools.field(t1, (DataType) dataType(0)),
  ...
  @Override
  public final BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> notBetweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7) {
