  ...
  private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
    ...
    if (log.isWarnEnabled()
      ...
      log.warn(
          ...
          "A QueryPart of type "
              + getClass()
              + " has been deserialised. Serialization support is deprecated in jOOQ. Please contact https://github.com/jOOQ/jOOQ/issues/11506 and state your use-case to see if it can be implemented otherwise.");
  }
  ...
  private void writeObject(ObjectOutputStream oos) throws IOException {
    ...
    if (log.isWarnEnabled()
      ...
      log.warn(
          ...
          "A QueryPart of type "
              + getClass()
              + " has been serialised. Serialization support is deprecated in jOOQ. Please contact https://github.com/jOOQ/jOOQ/issues/11506 and state your use-case to see if it can be implemented otherwise.");
  }
}
