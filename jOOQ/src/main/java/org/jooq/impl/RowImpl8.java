...
final class RowImpl8<T1, T2, T3, T4, T5, T6, T7, T8>
    extends AbstractRow<Record8<T1, T2, T3, T4, T5, T6, T7, T8>>
    implements Row8<T1, T2, T3, T4, T5, T6, T7, T8> {
  ...
  public final Condition compare(
      Comparator comparator, Record8<T1, T2, T3, T4, T5, T6, T7, T8> record) {
    return new RowCondition(this, record.valuesRow(), comparator);
  }

  @Override
  public final Condition compare(
      Comparator comparator, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
    return compare(
        comparator,
        row(
  ...
  @Override
  public final BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> between(
  ...
  @Override
  public final BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> betweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
  ...
  @Override
  public final BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> notBetween(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
    return notBetween(
        row(
            Tools.field(t1, (DataType) dataType(0)),
  ...
  @Override
  public final BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> notBetweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8) {
