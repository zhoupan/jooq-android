 ...
 * @author Lukas Eder
 */
class QueryPartCollectionView<T extends QueryPart> extends AbstractQueryPart
  ...
  public boolean rendersSeparator() {
    ...
    else return isRendersSeparator(last(wrapped));
  }
  ...
  final void addAll(Iterable<? extends T> c) {
    if (c != null) for (T t : c) if (t != null) add(t);
  }
