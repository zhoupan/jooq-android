 ...
 * as the more specific, type-safe {@link Record8} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl8<T1, T2, T3, T4, T5, T6, T7, T8> extends AbstractRecord
    implements InternalRecord, Record8<T1, T2, T3, T4, T5, T6, T7, T8> {
  ...
  @Override
  public final Record8<T1, T2, T3, T4, T5, T6, T7, T8> values(
  ...
  @Override
  public <T, U> Record8<T1, T2, T3, T4, T5, T6, T7, T8> with(
