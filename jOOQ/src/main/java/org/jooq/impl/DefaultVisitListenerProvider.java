 ...
 *
 * <p>This implementation just wraps an instance of {@link VisitListener}, always providing the
 * same.
 *
 * @author Lukas Eder
 */
public class DefaultVisitListenerProvider implements VisitListenerProvider, Serializable {
  ...
  /**
   * Convenience method to construct an array of <code>DefaultVisitListenerProvider</code> from an
   * array of <code>VisitListener</code> instances.
   */
