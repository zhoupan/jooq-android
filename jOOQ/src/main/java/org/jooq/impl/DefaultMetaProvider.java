...
/**
 * A default implementation of the {@link MetaProvider} SPI, which provides meta data information
 * based on the JDBC {@link DatabaseMetaData} API.
 *
 * @author Lukas Eder
 */
public class DefaultMetaProvider implements MetaProvider {
  ...
  static Meta meta(Configuration configuration) {
    ...
    if (meta instanceof MetaImpl
      ...
      log.debug(
          "No MetaProvider configured. For best results when looking up meta data, configure a MetaProvider, or connect to a database");
