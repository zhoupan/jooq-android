...
final class RowImpl5<T1, T2, T3, T4, T5> extends AbstractRow<Record5<T1, T2, T3, T4, T5>>
    implements Row5<T1, T2, T3, T4, T5> {
  ...
  @Override
  public final Condition compare(
      Comparator comparator, Select<? extends Record5<T1, T2, T3, T4, T5>> select) {
  ...
  public final Condition equal(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4, Field<T5> t5) {
    return compare(Comparator.EQUALS, t1, t2, t3, t4, t5);
  }
  ...
  @Override
  public final BetweenAndStep5<T1, T2, T3, T4, T5> between(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4, Field<T5> t5) {
  ...
  @Override
  public final BetweenAndStep5<T1, T2, T3, T4, T5> betweenSymmetric(
  ...
  @Override
  public final BetweenAndStep5<T1, T2, T3, T4, T5> notBetween(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4, Field<T5> t5) {
  ...
  @Override
  public final BetweenAndStep5<T1, T2, T3, T4, T5> notBetweenSymmetric(
      T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) {
