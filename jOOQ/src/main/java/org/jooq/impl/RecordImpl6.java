 ...
 * as the more specific, type-safe {@link Record6} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl6<T1, T2, T3, T4, T5, T6> extends AbstractRecord
    implements InternalRecord, Record6<T1, T2, T3, T4, T5, T6> {
  ...
  @Override
  public <T, U> Record6<T1, T2, T3, T4, T5, T6> with(
