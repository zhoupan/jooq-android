...
final class RowImpl4<T1, T2, T3, T4> extends AbstractRow<Record4<T1, T2, T3, T4>>
    implements Row4<T1, T2, T3, T4> {
  ...
  public final Condition compare(
      Comparator comparator, Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4) {
    return compare(comparator, row(t1, t2, t3, t4));
  }

  @Override
  public final Condition compare(
      Comparator comparator, Select<? extends Record4<T1, T2, T3, T4>> select) {
  ...
  @Override
  public final BetweenAndStep4<T1, T2, T3, T4> between(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4) {
  ...
  public final Condition between(
      Record4<T1, T2, T3, T4> minValue, Record4<T1, T2, T3, T4> maxValue) {
    return between(minValue).and(maxValue);
  }
  ...
  @Override
  public final BetweenAndStep4<T1, T2, T3, T4> betweenSymmetric(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4) {
  ...
  public final Condition betweenSymmetric(
      Row4<T1, T2, T3, T4> minValue, Row4<T1, T2, T3, T4> maxValue) {
  ...
  @Override
  public final BetweenAndStep4<T1, T2, T3, T4> notBetween(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4) {
  ...
  @Override
  public final BetweenAndStep4<T1, T2, T3, T4> notBetweenSymmetric(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4) {
