 ...
 * as the more specific, type-safe {@link Record11} interfaces
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"unchecked"})
final class RecordImpl11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> extends AbstractRecord
    implements InternalRecord, Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
  ...
  @Override
  public final Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> values(
  ...
  @Override
  public <T, U> Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> with(
