...
final class MigrationImpl extends AbstractScope implements Migration {
    ...
    run(
        new ContextTransactionalRunnable() {
          ...
          private final void log(
              StopWatch watch, JooqMigrationsChangelogRecord record, Status status) {
  ...
  static class JooqMigrationsChangelog extends TableImpl<JooqMigrationsChangelogRecord> {
    ...
    public static final JooqMigrationsChangelog JOOQ_MIGRATIONS_CHANGELOG =
        new JooqMigrationsChangelog();
    ...
    public final TableField<JooqMigrationsChangelogRecord, Long> ID =
        createField(
            DSL.name("ID"),
            org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true),
            this,
            "The database version ID.");

    /**
     * The column <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATED_FROM</code>. The previous database
     * version ID.
     */
    public final TableField<JooqMigrationsChangelogRecord, String> MIGRATED_FROM =
        createField(
            DSL.name("MIGRATED_FROM"),
    ...
    public final TableField<JooqMigrationsChangelogRecord, String> MIGRATED_TO =
        createField(
            DSL.name("MIGRATED_TO"),
            org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false),
            this,
            "");

    /**
     * The column <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATED_AT</code>. The date/time when the
     * database version was migrated to.
     */
    public final TableField<JooqMigrationsChangelogRecord, Timestamp> MIGRATED_AT =
        createField(
            DSL.name("MIGRATED_AT"),
            org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).nullable(false),
            this,
            "The date/time when the database version was migrated to.");

    /**
     * The column <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATION_TIME</code>. The time in milliseconds it
     * took to migrate to this database version.
     */
    public final TableField<JooqMigrationsChangelogRecord, Long> MIGRATION_TIME =
        createField(
            DSL.name("MIGRATION_TIME"),
            org.jooq.impl.SQLDataType.BIGINT,
            this,
            "The time in milliseconds it took to migrate to this database version.");

    /**
     * The column <code>JOOQ_MIGRATIONS_CHANGELOG.JOOQ_VERSION</code>. The jOOQ version used to
     * migrate to this database version.
     */
    public final TableField<JooqMigrationsChangelogRecord, String> JOOQ_VERSION =
        createField(
            DSL.name("JOOQ_VERSION"),
            org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false),
            this,
            "The jOOQ version used to migrate to this database version.");

    /**
     * The column <code>JOOQ_MIGRATIONS_CHANGELOG.SQL</code>. The jOOQ version used to migrate to
    ...
    /**
     * The column <code>JOOQ_MIGRATIONS_CHANGELOG.SQL_COUNT</code>. The number of SQL statements
    ...
    public final TableField<JooqMigrationsChangelogRecord, Status> STATUS =
        createField(
            ...
            org.jooq.impl.SQLDataType.VARCHAR(10)
                .nullable(false)
                .asConvertedDataType(new EnumConverter(String.class, Status.class)),
            this,
    ...
    private JooqMigrationsChangelog(
        Name alias, Table<JooqMigrationsChangelogRecord> aliased, Field<?>[] parameters) {
    ...
    public UniqueKey<JooqMigrationsChangelogRecord> getPrimaryKey() {
      return Internal.createUniqueKey(
          JOOQ_MIGRATIONS_CHANGELOG, "JOOQ_MIGRATIONS_CHANGELOG_PK", JOOQ_MIGRATIONS_CHANGELOG.ID);
    }
  }
  ...
  static class JooqMigrationsChangelogRecord
    ...
    /**
     * Setter for <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATED_FROM</code>. The previous database
     * version ID.
     */
    ...
    /**
     * Getter for <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATED_FROM</code>. The previous database
     * version ID.
     */
    ...
    /**
     * Setter for <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATED_AT</code>. The date/time when the
     * database version was migrated to.
     */
    ...
    /**
     * Getter for <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATED_AT</code>. The date/time when the
     * database version was migrated to.
     */
    ...
    /**
     * Setter for <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATION_TIME</code>. The time in milliseconds it
     * took to migrate to this database version.
     */
    ...
    /**
     * Getter for <code>JOOQ_MIGRATIONS_CHANGELOG.MIGRATION_TIME</code>. The time in milliseconds it
     * took to migrate to this database version.
     */
    ...
    /**
     * Setter for <code>JOOQ_MIGRATIONS_CHANGELOG.JOOQ_VERSION</code>. The jOOQ version used to
     * migrate to this database version.
     */
    ...
    /**
     * Getter for <code>JOOQ_MIGRATIONS_CHANGELOG.JOOQ_VERSION</code>. The jOOQ version used to
     * migrate to this database version.
     */
    ...
    /**
     * Setter for <code>JOOQ_MIGRATIONS_CHANGELOG.SQL</code>. The SQL statements that were run to
    ...
    /**
     * Getter for <code>JOOQ_MIGRATIONS_CHANGELOG.SQL</code>. The SQL statements that were run to
     * install this database version.
     */
    ...
    /**
     * Setter for <code>JOOQ_MIGRATIONS_CHANGELOG.SQL_COUNT</code>. The number of SQL statements
     * that were run to install this database version.
     */
    ...
    /**
     * Getter for <code>JOOQ_MIGRATIONS_CHANGELOG.SQL_COUNT</code>. The number of SQL statements
     * that were run to install this database version.
     */
    ...
    /**
     * Setter for <code>JOOQ_MIGRATIONS_CHANGELOG.STATUS</code>. The database version installation
     * status.
     */
    ...
    /**
     * Getter for <code>JOOQ_MIGRATIONS_CHANGELOG.STATUS</code>. The database version installation
     * status.
     */
