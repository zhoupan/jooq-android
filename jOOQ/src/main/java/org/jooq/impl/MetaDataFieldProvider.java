...
/**
 * A <code>FieldProvider</code> providing fields for a JDBC {@link ResultSetMetaData} object.
 *
 * <p>This can be used when a <code>Cursor</code> doesn't know its fields before actually fetching
 * data from the database. Use-cases for this are:
 *
 * <ul>
 *   <li>Plain SQL tables
 *   <li>CURSOR type OUT parameters from stored procedures
 *   <li>CURSOR type return values from stored functions
 * </ul>
 *
 * @author Lukas Eder
 */
