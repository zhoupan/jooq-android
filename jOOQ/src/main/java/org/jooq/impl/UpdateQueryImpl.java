...
/** @author Lukas Eder */
final class UpdateQueryImpl<R extends Record> extends AbstractStoreQuery<R>
    implements UpdateQuery<R> {
  ...
  private static final Set<SQLDialect> NO_SUPPORT_LIMIT =
      SQLDialect.supportedUntil(CUBRID, DERBY, FIREBIRD, H2, HSQLDB, POSTGRES, SQLITE);
  ...
  @Override
  public final <T1, T2, T3, T4> void addValues(
      Row4<T1, T2, T3, T4> row, Row4<T1, T2, T3, T4> value) {
    addValues0(row, value);
  }

  @Override
  public final <T1, T2, T3, T4, T5> void addValues(
      Row5<T1, T2, T3, T4, T5> row, Row5<T1, T2, T3, T4, T5> value) {
    addValues0(row, value);
  }

  @Override
  public final <T1, T2, T3, T4, T5, T6> void addValues(
      Row6<T1, T2, T3, T4, T5, T6> row, Row6<T1, T2, T3, T4, T5, T6> value) {
    addValues0(row, value);
  }

  @Override
  public final <T1, T2, T3, T4, T5, T6, T7> void addValues(
      Row7<T1, T2, T3, T4, T5, T6, T7> row, Row7<T1, T2, T3, T4, T5, T6, T7> value) {
    addValues0(row, value);
  }

  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8> void addValues(
      Row8<T1, T2, T3, T4, T5, T6, T7, T8> row, Row8<T1, T2, T3, T4, T5, T6, T7, T8> value) {
    addValues0(row, value);
  }

  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9> void addValues(
  ...
  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> void addValues(
  ...
  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> void addValues(
  ...
  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> void addValues(
  ...
  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> void addValues(
  ...
  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> void addValues(
  ...
  @Override
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> void addValues(
  ...
  @Override
  public final <T1, T2, T3> void addValues(
  ...
  public final <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> void addValues(
      Row15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> row,
      Select<? extends Record15<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>>
          select) {
    addValues0(row, select);
  }
  ...
  public final void addFrom(Collection<? extends TableLike<?>> f) {
    for (TableLike<?> provider : f) from.add(provider.asTable());
  }
