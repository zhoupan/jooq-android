...
/**
 * This type models an intermediary DSL construction step, which leads towards creating any of the
 * other 5 DML statement types.
 *
 * @author Lukas Eder
 */
@SuppressWarnings({"rawtypes", "unchecked"})
final class WithImpl extends AbstractQueryPart
    implements WithAsStep,
        WithAsStep1,
        WithAsStep2,
        WithAsStep3,
        WithAsStep4,
  ...
  @Override
  public final WithImpl with(
      String a, String fieldAlias1, String fieldAlias2, String fieldAlias3, String fieldAlias4) {
    return with(
        DSL.name(a),
        Tools.names(new String[] {fieldAlias1, fieldAlias2, fieldAlias3, fieldAlias4}));
  }
  ...
  public final WithImpl with(
    ...
    return with(
        DSL.name(a),
        Tools.names(
            new String[] {fieldAlias1, fieldAlias2, fieldAlias3, fieldAlias4, fieldAlias5}));
  }
  ...
  public final WithImpl with(
    ...
    return with(
        ...
        Tools.names(
            new String[] {
              fieldAlias1, fieldAlias2, fieldAlias3, fieldAlias4, fieldAlias5, fieldAlias6
            }));
  }
  ...
  @Override
  public final WithImpl with(
      Name a, Name fieldAlias1, Name fieldAlias2, Name fieldAlias3, Name fieldAlias4) {
  ...
  public final WithImpl with(
    ...
    return with(
        a,
        new Name[] {fieldAlias1, fieldAlias2, fieldAlias3, fieldAlias4, fieldAlias5, fieldAlias6});
  }
  ...
  public final WithImpl with(
    ...
    return with(
        a,
        new Name[] {
          fieldAlias1, fieldAlias2, fieldAlias3, fieldAlias4, fieldAlias5, fieldAlias6, fieldAlias7
        });
  }
  ...
  @Override
  public final <T1, T2> SelectSelectStep<Record2<T1, T2>> select(
      SelectField<T1> field1, SelectField<T2> field2) {
    return (SelectSelectStep) select(new SelectField[] {field1, field2});
  }

  @Override
  public final <T1, T2, T3> SelectSelectStep<Record3<T1, T2, T3>> select(
  ...
  @Override
  public final <T1, T2, T3, T4> SelectSelectStep<Record4<T1, T2, T3, T4>> select(
  ...
  @Override
  public final <T1, T2, T3, T4, T5> SelectSelectStep<Record5<T1, T2, T3, T4, T5>> select(
      SelectField<T1> field1,
      SelectField<T2> field2,
      SelectField<T3> field3,
      SelectField<T4> field4,
  ...
  @Override
  public final <T1, T2, T3, T4, T5, T6> SelectSelectStep<Record6<T1, T2, T3, T4, T5, T6>> select(
      SelectField<T1> field1,
      SelectField<T2> field2,
      SelectField<T3> field3,
      SelectField<T4> field4,
  ...
  @Override
  public final SelectSelectStep<Record> selectDistinct(
  ...
  @Override
  public final <T1, T2> SelectSelectStep<Record2<T1, T2>> selectDistinct(
      SelectField<T1> field1, SelectField<T2> field2) {
    return (SelectSelectStep) selectDistinct(new SelectField[] {field1, field2});
  }

  @Override
  public final <T1, T2, T3> SelectSelectStep<Record3<T1, T2, T3>> selectDistinct(
      SelectField<T1> field1, SelectField<T2> field2, SelectField<T3> field3) {
    return (SelectSelectStep) selectDistinct(new SelectField[] {field1, field2, field3});
  }

  @Override
  public final <T1, T2, T3, T4> SelectSelectStep<Record4<T1, T2, T3, T4>> selectDistinct(
      SelectField<T1> field1,
      SelectField<T2> field2,
      SelectField<T3> field3,
      SelectField<T4> field4) {
  ...
  @Override
  public final <T1, T2, T3, T4, T5> SelectSelectStep<Record5<T1, T2, T3, T4, T5>> selectDistinct(
      SelectField<T1> field1,
      SelectField<T2> field2,
      SelectField<T3> field3,
      SelectField<T4> field4,
  ...
  @Override
  public final <R extends Record, T1, T2, T3, T4, T5> InsertImpl insertInto(
      Table<R> into,
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
  ...
  @Override
  public final <R extends Record, T1, T2, T3, T4, T5, T6> InsertImpl insertInto(
      Table<R> into,
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
  ...
  @Override
  public final <R extends Record, T1, T2, T3, T4, T5, T6, T7> InsertImpl insertInto(
      Table<R> into,
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
  ...
  @Override
  public final <R extends Record, T1, T2, T3, T4, T5, T6, T7, T8> InsertImpl insertInto(
      Table<R> into,
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
      ...
      Field<T8> field8) {
    return insertInto(
        into, Arrays.asList(field1, field2, field3, field4, field5, field6, field7, field8));
  }

  @Override
  public final <R extends Record, T1, T2, T3, T4, T5, T6, T7, T8, T9> InsertImpl insertInto(
      Table<R> into,
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
  ...
  @Override
  public final <R extends Record, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> InsertImpl insertInto(
      Table<R> into,
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
  ...
  @Override
  public final <R extends Record, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
      InsertImpl insertInto(
          Table<R> into,
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
  ...
  @Override
  public final <R extends Record> InsertImpl insertInto(
  ...
  public final <R extends Record, T1, T2, T3, T4, T5, T6, T7, T8> MergeImpl mergeInto(
      ...
      Field<T8> field8) {
    return mergeInto(
        table, Arrays.asList(field1, field2, field3, field4, field5, field6, field7, field8));
  }
  ...
  @Override
  public final <R extends Record> MergeImpl mergeInto(
