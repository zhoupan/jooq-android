...
public class TableImpl<R extends Record> extends AbstractTable<R>
  ...
  public TableImpl(
      Name name, Schema schema, Table<R> aliased, Field<?>[] parameters, Comment comment) {
  ...
  public TableImpl(
    ...
    if (aliased != null) {
      ...
      if (existingAlias != null)
        this.alias =
            new Alias<>(
                existingAlias.wrapped,
                this,
                name,
                existingAlias.fieldAliases,
   ...
   *
   * <p>This method is used by generated code of table valued functions. Do not call this method
   * directly.
   */
  @org.jooq.Internal
   ...
   *
   * <p>This method is used by generated code of synthetic views. Do not call this method directly.
   */
  @org.jooq.Internal
          ...
          s != null
              ...
              : new DerivedTable<>(
                      ctx.dsl()
                          ...
                          .parseSelect(
                              getOptions().source(),
                              parameters == null ? EMPTY_OBJECT : parameters))
  ...
  public Table<R> as(Name as) {
    if (alias != null) return alias.wrapped().as(as);
    else return new TableAlias<>(this, as);
  }
  ...
  public Table<R> as(Name as, Name... fieldAliases) {
    if (alias != null) return alias.wrapped().as(as, fieldAliases);
    else return new TableAlias<>(this, as, fieldAliases);
  }
  ...
  /**
   * Subclasses must override this method if they use the generic type parameter <R> for other types
   * than {@link Record}
   *
   * <p>{@inheritDoc}
   */
