...
final class Limit extends AbstractQueryPart {
  ...
  /**
   * Whether this LIMIT clause is applicable. If <code>false</code>, then no LIMIT clause should be
   * rendered.
   */
  ...
  final Long getNumberOfRows() {
    return Convert.convert(
        (numberOfRows != null ? numberOfRows : numberOfRowsOrMax).getValue(), long.class);
  }
