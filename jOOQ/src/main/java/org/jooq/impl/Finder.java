...
/**
 * A {@link Context} that traverses an expression tree trying to find a specific {@link QueryPart}.
 *
 * <p>It is short circuiting the traversal once a result has been found, and offers an optional
 * predicate to decide whether to enter a subtree or not (e.g. to avoid traversing subqueries, etc.)
 *
 * <p>It comes with the full cost of traversal and SQL transformation, using the {@link Context}
 * API, but skips generating any SQL strings.
 *
 * @author Lukas Eder
 */
