...
final class SelectImpl<
  ...
  /**
   * This method must be able to return both incompatible types SelectSelectStep&lt;Record&gt; and
   * SelectSelectStep&lt;R&gt;
   */
  @Override
  ...
  @Override
  public final SelectSeekStep5 orderBy(
      OrderField t1, OrderField t2, OrderField t3, OrderField t4, OrderField t5) {
    return orderBy(new OrderField[] {t1, t2, t3, t4, t5});
  }

  @Override
  public final SelectSeekStep6 orderBy(
      OrderField t1, OrderField t2, OrderField t3, OrderField t4, OrderField t5, OrderField t6) {
    return orderBy(new OrderField[] {t1, t2, t3, t4, t5, t6});
  }

  @Override
  public final SelectSeekStep7 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep8 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep9 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep10 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep11 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep12 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep13 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep14 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep15 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
      ...
      OrderField t15) {
    return orderBy(
        new OrderField[] {t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15});
  }

  @Override
  public final SelectSeekStep16 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
      ...
      OrderField t16) {
    return orderBy(
        new OrderField[] {t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16});
  }

  @Override
  public final SelectSeekStep17 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep18 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep19 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep20 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep21 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekStep22 orderBy(
      OrderField t1,
      OrderField t2,
      OrderField t3,
      OrderField t4,
  ...
  @Override
  public final SelectSeekLimitStep<R> seekAfter(
      Object t1, Object t2, Object t3, Object t4, Object t5) {
    return seekAfter(new Object[] {t1, t2, t3, t4, t5});
  }

  @Override
  public final SelectSeekLimitStep<R> seek(
  ...
  public final SelectSeekLimitStep<R> seek(
      ...
      Object t16) {
    return seek(
        new Object[] {t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16});
  }
  ...
  public final SelectSeekLimitStep<R> seek(
      ...
      Object t17) {
    return seek(
        new Object[] {t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17});
  }
  ...
  public final SelectSeekLimitStep<R> seekBefore(
      ...
      Field t15) {
    return seekBefore(
        new Field[] {t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15});
  }
  ...
  public final SelectSeekLimitStep<R> seek(
      ...
      Field t16) {
    return seek(
        new Field[] {t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16});
  }
    ...
    if (getQuery() instanceof SelectQueryImpl)
      return Tools.fields(
          ...
          map(
              ...
              DataType[]::new));
    else return Tools.fields(values);
  }
  ...
  public final Condition compare(Comparator comparator, Select<? extends R> select) {
    if (Tools.degree(this) == 1) return DSL.field((Select) this).compare(comparator, select);
    else throw new UnsupportedOperationException("Not yet implemented");
  }
  ...
  public final Condition in(R... records) {
    if (Tools.degree(this) == 1) return DSL.field((Select) this).in(values(0, records));
    else throw new UnsupportedOperationException("Not yet implemented");
  }

  @Override
  public final Condition in(Select<? extends R> select) {
    if (Tools.degree(this) == 1) return DSL.field((Select) this).in(select);
    else throw new UnsupportedOperationException("Not yet implemented");
  }

  @Override
  public final Condition notIn(R... records) {
    if (Tools.degree(this) == 1) return DSL.field((Select) this).notIn(values(0, records));
    else throw new UnsupportedOperationException("Not yet implemented");
  }

  @Override
  public final Condition notIn(Select<? extends R> select) {
    if (Tools.degree(this) == 1) return DSL.field((Select) this).notIn(select);
    else throw new UnsupportedOperationException("Not yet implemented");
  }
  ...
  public final Condition betweenSymmetric(
      Select<? extends R> minValue, Select<? extends R> maxValue) {
    return null;
  }
   ...
   *
   * <p>This enumeration models the step that is currently receiving new conditions via the {@link
   * SelectImpl#and(Condition)}, {@link SelectImpl#or(Condition)}, etc methods
   *
   * @author Lukas Eder
   */
