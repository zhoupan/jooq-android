...
final class AlterIndexImpl extends AbstractDDLQuery
  ...
  AlterIndexImpl(Configuration configuration, Index index, boolean alterIndexIfExists) {
    this(configuration, index, alterIndexIfExists, null, null);
  }
