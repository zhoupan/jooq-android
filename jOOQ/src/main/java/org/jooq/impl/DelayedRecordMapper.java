...
/**
 * A {@link RecordMapper} implementation offering access to a delegate record mapper whose
 * initialisation is delayed until the first record, e.g. for {@link ResultQuery} implementations
 * whose {@link RecordType} is unknown prior to execution.
 *
 * @author Lukas Eder
 */
