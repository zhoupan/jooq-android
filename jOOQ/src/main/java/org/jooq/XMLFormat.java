...
public final class XMLFormat {
  ...
  public final XMLFormat format(boolean newFormat) {
    return new XMLFormat(
        xmlns, newFormat, newline, globalIndent, indent, null, header, recordFormat, quoteNested);
  }
  ...
  public final XMLFormat globalIndent(int newGlobalIndent) {
    return new XMLFormat(
        xmlns, format, newline, newGlobalIndent, indent, null, header, recordFormat, quoteNested);
  }
  ...
  public final XMLFormat indent(int newIndent) {
    return new XMLFormat(
        xmlns, format, newline, globalIndent, newIndent, null, header, recordFormat, quoteNested);
  }
  ...
  /**
   * The record format to be applied, defaulting to {@link
   * RecordFormat#VALUE_ELEMENTS_WITH_FIELD_ATTRIBUTE}.
   */
  ...
  /**
   * Whether nested {@link XML} content should be quoted like a string, or nested into XML formatted
   * output.
   */
