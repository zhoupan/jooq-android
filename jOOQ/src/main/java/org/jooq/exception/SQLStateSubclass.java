...
public enum SQLStateSubclass {
  ...
  C0W001_MODIFY_TABLE_MODIFIED_BY_DATA_CHANGE_DELTA_TABLE(
      C0W_PROHIBITED_STATEMENT_ENCOUNTERED_DURING_TRIGGER_EXECUTION, "001"),
  ...
  C27001_MODIFY_TABLE_MODIFIED_BY_DATA_CHANGE_DELTA_TABLE(
      C27_TRIGGERED_DATA_CHANGE_VIOLATION, "001"),
