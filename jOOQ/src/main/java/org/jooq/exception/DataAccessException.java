...
/**
 * The <code>DataAccessException</code> is a generic {@link RuntimeException} indicating that
 * something went wrong while executing a SQL statement from jOOQ. The idea behind this unchecked
 * exception is borrowed from Spring's JDBC's DataAccessException
 *
...
public class DataAccessException extends RuntimeException {
  ...
  /**
   * Retrieve the {@link SQLException#getSQLState()} or {@link R2dbcException#getSqlState()} from
   * {@link #getCause()}, if this <code>DataAccessException</code> was caused by a {@link
   * SQLException} or {@link R2dbcException}.
   */
  ...
  /**
   * Decode the {@link SQLException#getSQLState()} or {@link R2dbcException#getSqlState()} from
   * {@link #getCause()} into {@link SQLStateClass}, if this <code>DataAccessException</code> was
   * caused by a {@link SQLException} or {@link R2dbcException}.
   */
  public SQLStateClass sqlStateClass() {
    SQLException s = getCause(SQLException.class);
    if (s != null)
      if (s.getSQLState() != null) return SQLStateClass.fromCode(s.getSQLState());
  ...
  /**
   * Decode the {@link SQLException#getSQLState()} or {@link R2dbcException#getSqlState()} from
   * {@link #getCause()} into {@link SQLStateSubclass}, if this <code>DataAccessException</code> was
   * caused by a {@link SQLException} or {@link R2dbcException}.
   */
