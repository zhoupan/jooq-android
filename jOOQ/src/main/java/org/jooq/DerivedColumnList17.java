...
public interface DerivedColumnList17 extends QueryPart {
  ...
  <R extends Record17<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>>
      CommonTableExpression<R> as(ResultQuery<R> query);
  ...
  @Support({FIREBIRD, H2, HSQLDB, IGNITE, MARIADB, MYSQL, POSTGRES, SQLITE})
  <R extends Record17<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>>
      CommonTableExpression<R> asMaterialized(ResultQuery<R> query);
  ...
  @Support({FIREBIRD, H2, HSQLDB, IGNITE, MARIADB, MYSQL, POSTGRES, SQLITE})
  <R extends Record17<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>>
      CommonTableExpression<R> asNotMaterialized(ResultQuery<R> query);
}
