...
public interface Row4<T1, T2, T3, T4> extends Row, SelectField<Record4<T1, T2, T3, T4>> {
   ...
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function4)}, this method attempts to work
  ...
  @Support
  Condition compare(
      Comparator comparator, QuantifiedSelect<? extends Record4<T1, T2, T3, T4>> select);
  ...
  @NotNull
  @Support
  BetweenAndStep4<T1, T2, T3, T4> between(
      Field<T1> minValue1, Field<T2> minValue2, Field<T3> minValue3, Field<T4> minValue4);
  ...
  @NotNull
  @Support
  Condition between(Row4<T1, T2, T3, T4> minValue, Row4<T1, T2, T3, T4> maxValue);
  ...
  @NotNull
  @Support
  Condition between(Record4<T1, T2, T3, T4> minValue, Record4<T1, T2, T3, T4> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep4<T1, T2, T3, T4> betweenSymmetric(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4);
  ...
  @NotNull
  @Support
  Condition betweenSymmetric(Row4<T1, T2, T3, T4> minValue, Row4<T1, T2, T3, T4> maxValue);
  ...
  @NotNull
  @Support
  Condition betweenSymmetric(Record4<T1, T2, T3, T4> minValue, Record4<T1, T2, T3, T4> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep4<T1, T2, T3, T4> notBetween(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4);
  ...
  @NotNull
  @Support
  Condition notBetween(Row4<T1, T2, T3, T4> minValue, Row4<T1, T2, T3, T4> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetween(Record4<T1, T2, T3, T4> minValue, Record4<T1, T2, T3, T4> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep4<T1, T2, T3, T4> notBetweenSymmetric(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4);
  ...
  @NotNull
  @Support
  Condition notBetweenSymmetric(Row4<T1, T2, T3, T4> minValue, Row4<T1, T2, T3, T4> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetweenSymmetric(Record4<T1, T2, T3, T4> minValue, Record4<T1, T2, T3, T4> maxValue);
