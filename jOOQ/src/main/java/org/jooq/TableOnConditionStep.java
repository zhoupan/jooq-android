...
/**
 * An intermediate (optional) type for the construction of a <code>JOIN</code> clause, where the
 * join criteria is added using an <code>ON</code> clause (with a {@link Condition}. This type can
 * be used as a convenience type for connecting more conditions.
 *
 * <p>
 *
...
public interface TableOnConditionStep<R extends Record> extends Table<R> {
  ...
  /**
   * Combine the currently assembled conditions with another one using the {@link Operator#AND}
   * operator.
   */
  @NotNull
  @Support
  ...
  /**
   * Combine the currently assembled conditions with a negated other one using the {@link
  ...
  /**
   * Combine the currently assembled conditions with an <code>EXISTS</code> clause using the {@link
   * Operator#AND} operator.
   */
  @NotNull
  @Support
  ...
  /**
   * Combine the currently assembled conditions with a <code>NOT EXISTS</code> clause using the
  ...
  /**
   * Combine the currently assembled conditions with another one using the {@link Operator#OR}
   * operator.
   */
  @NotNull
  @Support
