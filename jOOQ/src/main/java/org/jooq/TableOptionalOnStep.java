...
/**
 * An intermediate type for the construction of a <code>JOIN</code> clause, where there may
 * optionally be a join criteria added using an <code>ON</code> clause (with a {@link Condition}),
 * or using a <code>USING</code> clause (with a list of {@link Field})
 *
 * <p>
 *
