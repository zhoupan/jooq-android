 ...
 * @author Lukas Eder
 */
public interface InsertValuesStep9<R extends Record, T1, T2, T3, T4, T5, T6, T7, T8, T9>
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> values(
      T1 value1,
      T2 value2,
      T3 value3,
      T4 value4,
  ...
  @Support
  InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> values(
      Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> values);
  ...
  @Support
  InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> values(
      Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> values);
  ...
  InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRows(
      Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9>... values);
  ...
  @Support
  InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRows(
      Collection<? extends Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> values);
  ...
  @Support
  @SuppressWarnings("unchecked")
  InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRecords(
      Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>... values);
  ...
  @Support
  InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRecords(
      Collection<? extends Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> values);
