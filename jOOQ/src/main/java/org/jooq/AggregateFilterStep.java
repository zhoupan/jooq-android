...
/**
 * The step in the specification of aggregate functions where the SQL:2003 standard <code>
 * FILTER clause</code> can be added.
 *
 * <p>
 *
...
public interface AggregateFilterStep<T> extends WindowBeforeOverStep<T> {
  ...
  /**
   * Add a <code>FILTER clause</code> to the aggregate function, connecting conditions with each
