 ...
 *
 * <p>jOOQ provides built in data types through {@link SQLDataType}. Users can define their own data
 * types programmatically by calling {@link #asConvertedDataType(Converter)} or {@link
 * #asConvertedDataType(Binding)}, for example. Custom data types can also be defined on generated
 * code using the <code>&lt;forcedType/&gt;</code> configuration, see <a href=
...
public interface DataType<T> extends Named {
  ...
  /** Get the defining DOMAIN type or <code>NULL</code> if there is no such type. */
  @Nullable
  Domain<T> getDomain();

  /**
   * Get the nested record's {@link Row} definition, if this is a {@link #isRecord()}, or a {@link
   * #isMultiset()}, or <code>NULL</code> otherwise.
   */
  @Nullable
  Row getRow();

  /**
   * Get the nested record's record type definition, if this is a {@link #isRecord()}, or a {@link
   * #isMultiset()}, or <code>NULL</code> otherwise.
   */
  @Nullable
  ...
  /** Retrieve the Java component type if this is an ARRAY type, or <code>null</code>, otherwise. */
  @Nullable
  Class<?> getArrayComponentType();

  /**
   * Retrieve the Java component data type if this is an ARRAY type, or <code>null</code>,
   * otherwise.
   */
  @Nullable
  ...
  /**
   * Convenience method for converting this type using {@link Converter#of(Class, Class, Function,
   * Function)}.
   */
  @NotNull
  ...
  /**
   * Convenience method for converting this type to a read-only type using {@link
   * Converter#from(Class, Class, Function)}.
   */
  @NotNull
  default <U> DataType<U> asConvertedDataTypeFrom(
      Class<U> toType, Function<? super T, ? extends U> from) {
   ...
   * Converter#from(Class, Class, Function)}.
   *
   * <p>EXPERIMENTAL. Unlike {@link #asConvertedDataTypeFrom(Class, Function)}, this method attempts
   * to work without an explicit {@link Class} reference for the underlying {@link
   * Converter#toType()}. There may be some edge cases where this doesn't work. Please report any
   * bugs here: <a href=
  ...
  /**
   * Convenience method for converting this type to a write-only type using {@link
   * Converter#to(Class, Class, Function)}.
   */
  @NotNull
  default <U> DataType<U> asConvertedDataTypeTo(
      Class<U> toType, Function<? super U, ? extends T> to) {
   ...
   * Converter#to(Class, Class, Function)}.
   *
   * <p>EXPERIMENTAL. Unlike {@link #asConvertedDataTypeTo(Class, Function)}, this method attempts
   * to work without an explicit {@link Class} reference for the underlying {@link
   * Converter#toType()}. There may be some edge cases where this doesn't work. Please report any
   * bugs here: <a href=
   * "https://github.com/jOOQ/jOOQ/issues/new/choose">https://github.com/jOOQ/jOOQ/issues/new/choose</a>
   ...
   *
   * <p>This is useful for some dialects that have specialised type names for cast expressions.
   ...
   *
   * <p>See {@link Convert#convert(Object, Class)} for details about conversion rules. Notice this
   * does not pass through any {@link Configuration#converterProvider()}.
   *
   ...
   *
   * <p>[#5709] A <code>nullable</code> column cannot have an {@link #identity()}.
   *
   ...
   * Return a new data type like this, with a new nullability.
   *
   * <p>This is the same as calling {@link #nullability(Nullability)} with any of {@link
   * Nullability#NULL} or {@link Nullability#NOT_NULL} as an argument.
   *
   * <p>[#5709] A <code>nullable</code> column cannot have an {@link #identity()}.
   *
   ...
   * Get the nullability of this data type.
   *
   * <p>This returns <code>true</code> by default, i.e. if {@link #nullability()} is {@link
   * Nullability#DEFAULT}.
   *
   * @return The nullability
   */
  ...
  /** Synonym for {@link #nullable(boolean)}, passing <code>true</code> as an argument. */
  @NotNull
  @Support
  DataType<T> null_();

  /** Synonym for {@link #nullable(boolean)}, passing <code>false</code> as an argument. */
  @NotNull
  @Support
  DataType<T> notNull();
  ...
  /**
   * Get the collation of this data type, or <code>null</code> if there is no collation, or if the
   * default collation applies.
   */
  @Nullable
  Collation collation();
  ...
  /**
   * Get the character set of this data type, or <code>null</code> if there is no character set, or
   * if the default character set applies.
   */
  @Nullable
   ...
   *
   * <p>[#5709] The IDENTITY flag imposes a NOT NULL constraint, and removes all DEFAULT values.
   *
  ...
  /**
   * Specify an expression to be applied as the <code>DEFAULT</code> value for this data type.
   *
   * <p>[#5709] A <code>defaulted</code> column cannot have an {@link #identity()}.
   *
   * <p>This is an alias for {@link #default_(Object)}.
   *
   ...
   * Specify an expression to be applied as the <code>DEFAULT</code> value for this data type.
   *
   * <p>A default value of a data type applies to DDL statements, such as
   *
   * <ul>
   *   <li><code>CREATE TABLE</code>
   *   <li><code>ALTER TABLE</code>
   * </ul>
   *
   * <p>The distinct types of possible <code>DEFAULT</code> expressions is defined by the underlying
   * database. Please refer to your database manual to learn what expressions are possible.
   *
   * <p>This is an alias for {@link #default_(Field)}.
   */
  @NotNull
  @Support
  ...
  /**
   * The expression to be applied as the <code>DEFAULT</code> value for this data type.
   *
   * <p>This is an alias for {@link #default_()}.
   *
   * @return The default value if present, or <code>null</code> if no default value is specified for
   *     this data type.
   * @see #defaultValue(Field)
   */
  @Nullable
   ...
   *
   * <p>This will have no effect if {@link #hasPrecision()} is <code>false</code>
   *
   * <p>This is the same as calling {@link #precision(int, int)} with <code>scale == 0</code>
   *
   ...
   *
   * <p>This will have no effect if {@link #hasPrecision()} is <code>false</code> , or if <code>
   * scale &gt; 0</code> and {@link #hasScale()} is <code>false</code>
   *
   * @param precision The new precision value
   ...
   *
   * <p>The default precision is <code>0</code> for all data types. If a data type does not have a
   * precision (see {@link #hasPrecision()}), or if it was initialised without precision (e.g.
   * {@link SQLDataType#TIMESTAMP}), then the precision is not defined.
   */
   ...
   *
   * <p>This will have no effect if {@link #hasScale()} is <code>false</code>
   *
   * @param scale The new scale value
   * @return The new data type
   */
   ...
   *
   * <p>The default scale is <code>0</code> for all data types. If a data type does not have a scale
   * (see {@link #hasScale()}), or if it was initialised without scale (e.g. {@link
   * SQLDataType#TIMESTAMP}), then the scale is not defined.
   */
   ...
   *
   * <p>This will have no effect if {@link #hasLength()} is <code>false</code>
   *
   ...
   *
   * <p>The default length is <code>0</code> for all data types. If a data type does not have a
   * length (see {@link #hasLength()}), or if it was initialised without length (e.g. {@link
   * SQLDataType#TIMESTAMP}), then the length is not defined.
   */
   ...
   *
   * <p>This applies to any of these types:
   *
   * <ul>
   *   <li>{@link SQLDataType#TINYINT}
   *   <li>{@link SQLDataType#SMALLINT}
   *   <li>{@link SQLDataType#INTEGER}
   *   <li>{@link SQLDataType#BIGINT}
   *   <li>{@link SQLDataType#FLOAT}
   *   <li>{@link SQLDataType#DOUBLE}
   *   <li>{@link SQLDataType#REAL}
   *   <li>{@link SQLDataType#DECIMAL}
   *   <li>{@link SQLDataType#DECIMAL_INTEGER}
   *   <li>{@link SQLDataType#NUMERIC}
   * </ul>
   *
   * @see #isNumeric()
   */
   ...
   *
   * <ul>
   *   <li>{@link SQLDataType#CHAR}
   *   <li>{@link SQLDataType#CLOB}
   *   <li>{@link SQLDataType#LONGNVARCHAR}
   *   <li>{@link SQLDataType#LONGVARCHAR}
   *   <li>{@link SQLDataType#NCHAR}
   *   <li>{@link SQLDataType#NCLOB}
   *   <li>{@link SQLDataType#NVARCHAR}
   *   <li>{@link SQLDataType#VARCHAR}
   * </ul>
   */
  boolean isString();
   ...
   *
   * <ul>
   *   <li>{@link SQLDataType#DATE}
   *   <li>{@link SQLDataType#TIME}
   *   <li>{@link SQLDataType#TIMESTAMP}
   *   <li>{@link SQLDataType#LOCALDATE}
   *   <li>{@link SQLDataType#LOCALTIME}
   *   <li>{@link SQLDataType#LOCALDATETIME}
   *   <li>{@link SQLDataType#OFFSETTIME}
   *   <li>{@link SQLDataType#OFFSETDATETIME}
   *   <li>{@link SQLDataType#INSTANT}
   * </ul>
   *
   * @see #isDate()
   */
   ...
   *   <li>{@link SQLDataType#OFFSETTIME}
   *   <li>{@link SQLDataType#OFFSETDATETIME}
   *   <li>{@link YearToSecond}
   *   <li>{@link YearToMonth}
   *   <li>{@link DayToSecond}
   * </ul>
   *
   * <p>This is a combination of {@link #isDateTime()} or {@link #isInterval()}
   */
  boolean isTemporal();
   ...
   *
   * <ul>
   *   <li>{@link SQLDataType#BINARY}
   *   <li>{@link SQLDataType#BLOB}
   *   <li>{@link SQLDataType#LONGVARBINARY}
   *   <li>{@link SQLDataType#VARBINARY}
   * </ul>
   */
  boolean isBinary();
   ...
   *
   * <p>This is true for anonymous, structural nested record types constructed with {@link
   * DSL#row(SelectField...)} or for nominal nested record types, such as {@link #isUDT()} or {@link
   * #isEmbeddable()}.
   */
  boolean isRecord();
   ...
   *
   * <p>This is true for anonymous, structural nested collection types constructed with {@link
   * DSL#multiset(Select)} or {@link DSL#multisetAgg(Field...)}.
   */
  boolean isMultiset();
