...
public interface Row5<T1, T2, T3, T4, T5> extends Row, SelectField<Record5<T1, T2, T3, T4, T5>> {
  ...
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record5} to custom type {@link RecordMapper} that
   * can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING</code>
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function5)}, this method attempts to work
   ...
   *
   * @see #equal(Record5)
   * @see #notEqual(Record5)
   * @see #lessThan(Record5)
   * @see #lessOrEqual(Record5)
  ...
  @Support
  Condition compare(
      Comparator comparator, Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4, Field<T5> t5);
  ...
  @Support
  Condition compare(
      Comparator comparator, QuantifiedSelect<? extends Record5<T1, T2, T3, T4, T5>> select);
  ...
  @NotNull
  @Support
  BetweenAndStep5<T1, T2, T3, T4, T5> between(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5);
  ...
  @NotNull
  @Support
  Condition between(Row5<T1, T2, T3, T4, T5> minValue, Row5<T1, T2, T3, T4, T5> maxValue);
  ...
  @NotNull
  @Support
  Condition between(Record5<T1, T2, T3, T4, T5> minValue, Record5<T1, T2, T3, T4, T5> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep5<T1, T2, T3, T4, T5> betweenSymmetric(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5);
  ...
  @NotNull
  @Support
  Condition betweenSymmetric(Row5<T1, T2, T3, T4, T5> minValue, Row5<T1, T2, T3, T4, T5> maxValue);
  ...
  Condition betweenSymmetric(
      Record5<T1, T2, T3, T4, T5> minValue, Record5<T1, T2, T3, T4, T5> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep5<T1, T2, T3, T4, T5> notBetween(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5);
  ...
  @NotNull
  @Support
  Condition notBetween(Row5<T1, T2, T3, T4, T5> minValue, Row5<T1, T2, T3, T4, T5> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetween(Record5<T1, T2, T3, T4, T5> minValue, Record5<T1, T2, T3, T4, T5> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep5<T1, T2, T3, T4, T5> notBetweenSymmetric(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5);
  ...
  Condition notBetweenSymmetric(
      Row5<T1, T2, T3, T4, T5> minValue, Row5<T1, T2, T3, T4, T5> maxValue);
