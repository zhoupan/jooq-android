 ...
 * @author Lukas Eder
 */
public interface Row13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
    extends Row, SelectField<Record13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> {

  // ------------------------------------------------------------------------
  // Mapping convenience methods
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record13} to custom type {@link RecordMapper}
   * that can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING
   * </code> clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function13)}, this method attempts to work
  ...
  @NotNull
  @Support
  Condition isDistinctFrom(Row13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> row);

  /** Compare this row value expression with another row value expression for distinctness. */
  @NotNull
  @Support
  Condition isDistinctFrom(Record13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> record);
  ...
  @NotNull
  @Support
  Condition isNotDistinctFrom(Row13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> row);
  ...
  @NotNull
  @Support
  BetweenAndStep13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> betweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> notBetween(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep13<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> notBetweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
