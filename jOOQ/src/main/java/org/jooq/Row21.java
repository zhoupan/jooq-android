...
public interface Row21<
   ...
   * </code> clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function21)}, this method attempts to work
   ...
   *
   * @see #equal(Record21)
   * @see #notEqual(Record21)
   * @see #lessThan(Record21)
   * @see #lessOrEqual(Record21)
   * @see #greaterThan(Record21)
   * @see #greaterOrEqual(Record21)
   */
  @NotNull
  @Support
  Condition compare(
