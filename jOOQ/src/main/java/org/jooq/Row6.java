 ...
 * @author Lukas Eder
 */
public interface Row6<T1, T2, T3, T4, T5, T6>
    extends Row, SelectField<Record6<T1, T2, T3, T4, T5, T6>> {

  // ------------------------------------------------------------------------
  // Mapping convenience methods
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record6} to custom type {@link RecordMapper} that
   * can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING</code>
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function6)}, this method attempts to work
  ...
  <U> SelectField<U> mapping(
      Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends U>
          function);
  ...
  @Support
  Condition compare(
      Comparator comparator, Select<? extends Record6<T1, T2, T3, T4, T5, T6>> select);
  ...
  @Support
  Condition compare(
      Comparator comparator, QuantifiedSelect<? extends Record6<T1, T2, T3, T4, T5, T6>> select);
  ...
  @Support
  Condition equal(
      Field<T1> t1, Field<T2> t2, Field<T3> t3, Field<T4> t4, Field<T5> t5, Field<T6> t6);
  ...
  @NotNull
  @Support
  BetweenAndStep6<T1, T2, T3, T4, T5, T6> between(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5, T6 minValue6);
  ...
  @NotNull
  @Support
  Condition between(Row6<T1, T2, T3, T4, T5, T6> minValue, Row6<T1, T2, T3, T4, T5, T6> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep6<T1, T2, T3, T4, T5, T6> betweenSymmetric(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5, T6 minValue6);
  ...
  @Support
  BetweenAndStep6<T1, T2, T3, T4, T5, T6> betweenSymmetric(
      Record6<T1, T2, T3, T4, T5, T6> minValue);
  ...
  @NotNull
  @Support
  BetweenAndStep6<T1, T2, T3, T4, T5, T6> notBetween(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5, T6 minValue6);
  ...
  @NotNull
  @Support
  BetweenAndStep6<T1, T2, T3, T4, T5, T6> notBetweenSymmetric(
      T1 minValue1, T2 minValue2, T3 minValue3, T4 minValue4, T5 minValue5, T6 minValue6);
  ...
  @Support
  BetweenAndStep6<T1, T2, T3, T4, T5, T6> notBetweenSymmetric(
      Row6<T1, T2, T3, T4, T5, T6> minValue);
