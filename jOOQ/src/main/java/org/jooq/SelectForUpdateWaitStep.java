...
public interface SelectForUpdateWaitStep<R extends Record> extends SelectForStep<R> {
  ...
  /**
   * Add a <code>WAIT</code> clause to the <code>FOR &lt;lock_mode&gt;</code> clause at the end of
   * the query.
   *
   * <p>Be careful not to confuse this with {@link Object#wait(long)} !
   *
  ...
  /**
   * Add a <code>NOWAIT</code> clause to the <code>FOR &lt;lock_mode&gt;</code> clause at the end of
   * the query.
   *
