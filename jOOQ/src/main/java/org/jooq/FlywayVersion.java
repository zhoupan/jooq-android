 ...
 *
 * <p>[#8939] Minor adaptations have been made to use this class in jOOQ directly.
 *
...
final class FlywayVersion implements Comparable<FlywayVersion> {
   ...
   *
   * @param version The version String. The value {@code current} will be interpreted as
   *     FlywayVersion.CURRENT, a marker for the latest version that has been applied to the
   *     database.
