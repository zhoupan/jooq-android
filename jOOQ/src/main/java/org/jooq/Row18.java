...
public interface Row18<
  ...
  /**
   * A convenience method to define a local {@link Record18} to custom type {@link RecordMapper}
   * that can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING
   * </code> clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function18)}, this method attempts to work
