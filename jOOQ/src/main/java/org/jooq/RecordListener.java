 ...
 *
 * <p>Users may want to centrally inject custom behaviour when manipulating their {@link
 * UpdatableRecord} objects, performing CRUD. This service provider allows to hook in callback
 * method implementations for before or after any of these methods:
 *
 * <ul>
 *   <li>{@link UpdatableRecord#store()}
 *   <li>{@link UpdatableRecord#insert()}
 *   <li>{@link UpdatableRecord#update()}
 *   <li>{@link UpdatableRecord#delete()}
 *   <li>{@link UpdatableRecord#refresh()}
 * </ul>
 *
 * <p>A <code>RecordListener</code> does not act as a client-side trigger. As such, it does not
 * affect any bulk DML statements (e.g. a {@link DSLContext#update(Table)}), whose affected records
 * are not available to clients. For those purposes, use a server-side trigger {@link
 * DSLContext#createTrigger(Name)} if records should be changed, or a {@link VisitListener} if the
 * SQL query should be changed, independently of data.
 *
 * @author Lukas Eder
 */
public interface RecordListener extends EventListener {
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} prior to storing. Note
   * that modifying the record's primary key value may influence whether storing results in an
   * <code>INSERT</code> or <code>UPDATE</code> statement.
   *
   * <p>A store event will generate a nested {@link #insertStart(RecordContext)} or {@link
   * #updateStart(RecordContext)} event.
   *
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} after storing. Note
   * that modifying the record's primary key value may influence whether storing results in an
   * <code>INSERT</code> or <code>UPDATE</code> statement.
   *
   * <p>A store event will generate a nested {@link #insertEnd(RecordContext)} or {@link
   * #updateEnd(RecordContext)} event.
   *
   * @see UpdatableRecord#store()
   */
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} prior to inserting.
   *
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} after inserting.
   *
   * @see UpdatableRecord#insert()
   */
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} prior to updating.
   *
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} after updating.
   *
   * @see UpdatableRecord#update()
   */
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} prior to merging.
   *
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} after merging.
   *
   * @see UpdatableRecord#merge()
   */
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} prior to deleting.
   *
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} after deleting.
   *
   * @see UpdatableRecord#delete()
   */
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} prior to loading.
   */
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} after loading.
   */
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} prior to refreshing.
   *
   ...
   *
   * <p>Implementations are allowed to modify {@link RecordContext#record()} after refreshing.
   *
   * @see UpdatableRecord#refresh()
   */
  ...
  /** Create a {@link RecordListener} with a {@link #onStoreStart(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onStoreEnd(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onInsertStart(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onInsertEnd(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onUpdateStart(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onUpdateEnd(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onMergeStart(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onMergeEnd(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onDeleteStart(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onDeleteEnd(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onLoadStart(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onLoadEnd(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onRefreshStart(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onRefreshEnd(Consumer)} implementation. */
  ...
  /** Create a {@link RecordListener} with a {@link #onException(Consumer)} implementation. */
