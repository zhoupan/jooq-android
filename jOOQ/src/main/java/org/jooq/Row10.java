 ...
 * @author Lukas Eder
 */
public interface Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
    extends Row, SelectField<Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> {
   ...
   * </code> clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function10)}, this method attempts to work
  ...
  @NotNull
  @Support
  BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> between(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> betweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> notBetween(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> notBetweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
