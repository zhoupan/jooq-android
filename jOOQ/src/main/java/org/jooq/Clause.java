 ...
 * <h3>Disclaimer</h3>
 *
 * This SPI is still <strong>experimental</strong>! Some SPI elements and/or behavioural elements
 * may change in future minor releases.
 *
 * <p>
 *
 * @deprecated - 3.11.0 - [#7258] - This part of the {@link VisitListener} SPI is deprecated. There
 *     are currently no plans of replacing it. Please get in touch if you think this functionality
...
public enum Clause {
   ...
   * A table expression.
   *
   * <p>This clause surrounds an actual table expression as it can be encountered in
   *
   * <ul>
   *   <li>{@link #SELECT_FROM}
   *   <li>{@link #INSERT_INSERT_INTO}
   *   <li>{@link #UPDATE_UPDATE}
   *   <li>{@link #DELETE_DELETE}
   *   <li>{@link #MERGE_MERGE_INTO}
   *   <li>{@link #TRUNCATE_TRUNCATE}
   * </ul>
   */
  TABLE,
   ...
   *
   * <p>This clause surrounds a table alias declaration, for instance within the {@link
   * #SELECT_FROM} clause, or within a {@link #TABLE_JOIN} clause, wrapping another {@link #TABLE}.
   *
   ...
   *
   * <p>This is a terminal clause used to reference physical or aliased tables.
   */
  TABLE_REFERENCE,
  TABLE_JOIN,
  TABLE_JOIN_INNER,
   ...
   *
   * <p>This clause surrounds a
   *
   * <ul>
   *   <li>a <code>VALUES</code> keyword
   ...
   * A field expression.
   *
   * <p>This clause surrounds an actual field expression as it can be encountered in various other
   ...
   *
   * <p>This clause surrounds a field alias declaration, for instance within the {@link
   * #SELECT_SELECT} clause, wrapping another {@link #FIELD}.
   *
   ...
   *
   * <p>This clause surrounds a complete <code>SELECT</code> statement, a subselect, or a set
   * operation, such as
   *
   * <ul>
   *   <li>{@link #SELECT_UNION}
   *   <li>{@link #SELECT_UNION_ALL}
   *   <li>{@link #SELECT_INTERSECT}
   *   <li>{@link #SELECT_EXCEPT}
   * </ul>
   */
  SELECT,
   ...
   *
   * <p>This clause surrounds two or more subselects (see {@link #SELECT}) concatenating them using
   * a <code>UNION</code> set operation.
   */
  SELECT_UNION,
   ...
   *
   * <p>This clause surrounds
   *
   * <ul>
   *   <li>the <code>SELECT</code> keyword
   *   <li>Oracle style hints
   *   <li>the T-SQL style <code>TOP .. START AT</code> clause
   *   <li>the select field list
   * </ul>
   */
  SELECT_SELECT,
   ...
   *
   * <ul>
   *   <li>the <code>INTO</code> keyword
   *   <li>the table reference
   * </ul>
   *
   ...
   *
   * <ul>
   *   <li>the <code>FROM</code> keyword
   *   <li>the table reference list
   * </ul>
   *
   * <p>See {@link #TABLE} and related clauses for possible table references.
   *
   ...
   *
   * <ul>
   *   <li>the <code>WHERE</code> keyword
   *   <li>a {@link #CONDITION}
   * </ul>
   *
   * <p>See {@link #CONDITION} and related clauses for possible conditions
   *
   * @see #CONDITION
   */
  SELECT_WHERE,
   ...
   *
   * <ul>
   *   <li>the <code>START WITH</code> keywords
   *   <li>a {@link #CONDITION}
   * </ul>
   *
   * <p>See {@link #CONDITION} and related clauses for possible conditions
   ...
   *
   * <ul>
   *   <li>the <code>CONNECT BY</code> keywords
   *   <li>a {@link #CONDITION}
   * </ul>
   *
   * <p>See {@link #CONDITION} and related clauses for possible conditions
   ...
   *
   * <ul>
   *   <li>the <code>HAVING</code> keyword
   *   <li>a {@link #CONDITION}
   * </ul>
   *
   * <p>See {@link #CONDITION} and related clauses for possible conditions
   ...
   *
   * <ul>
   *   <li>the <code>INSERT INTO</code> keywords
   *   <li>the table that is being inserted
   * </ul>
   */
  INSERT_INSERT_INTO,
   ...
   *
   * <ul>
   *   <li>the <code>VALUES</code> keyword
   *   <li>several {@link #FIELD_ROW} clauses
   * </ul>
   */
  INSERT_VALUES,
   ...
   *
   * <p>This clause surrounds several {@link #INSERT_ON_DUPLICATE_KEY_UPDATE_ASSIGNMENT} clauses.
   *
   * <ul>
   *   <li>the <code>ON DUPLICATE KEY UPDATE</code> keywords
   *   <li>several {@link #INSERT_ON_DUPLICATE_KEY_UPDATE_ASSIGNMENT} clauses
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>RETURNING</code> keyword
   *   <li>several {@link #FIELD} clauses
   * </ul>
   */
  INSERT_RETURNING,
   ...
   *
   * <ul>
   *   <li>the <code>UPDATE</code> keyword
   *   <li>the table that is being updated
   * </ul>
   */
  UPDATE_UPDATE,
   ...
   *
   * <ul>
   *   <li>the <code>SET</code> keyword
   *   <li>one or several assignments: {@link #UPDATE_SET_ASSIGNMENT}
   * </ul>
   */
  UPDATE_SET,
   ...
   *
   * <ul>
   *   <li>a {@link #FIELD} receiving the assignment
   *   <li>an assigment operator
   *   <li>a {@link #FIELD} being assigned
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>DELETE FROM</code> keywords
   *   <li>the table that is being deleted
   * </ul>
   */
  DELETE_DELETE,
   ...
   *
   * <ul>
   *   <li>the <code>MERGE INTO</code> keywords
   *   <li>the table that is being merged
   * </ul>
   */
  MERGE_MERGE_INTO,
   ...
   *
   * <ul>
   *   <li>the <code>USING</code> keyword
   *   <li>a {@link #TABLE}
   * </ul>
   */
  MERGE_USING,
   ...
   *
   * <ul>
   *   <li>the <code>WHEN MATCHED THEN UPDATE</code> keywords
   *   <li>a {@link #MERGE_SET} clause
   *   <li>a {@link #MERGE_WHERE} clause
   *   <li>a {@link #MERGE_DELETE_WHERE} clause
   * </ul>
   */
   ...
   * <ul>
   *   <li>the <code>SET</code> keyword
   *   <li>several {@link #MERGE_SET_ASSIGNMENT} clauses
   * </ul>
   */
  MERGE_SET,
   ...
   *
   * <ul>
   *   <li>the <code>DELETE WHERE</code> keyword
   *   <li>a {@link #CONDITION}
   * </ul>
   */
  MERGE_DELETE_WHERE,
   ...
   *
   * <ul>
   *   <li>the <code>WHEN NOT MATCHED THEN INSERT</code> keywords
   *   <li>several {@link #FIELD} clauses
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>TRUNCATE TABLE</code> keywords
   *   <li>the table that is being truncated
   * </ul>
   */
  TRUNCATE_TRUNCATE,
   ...
   *
   * <ul>
   *   <li>the <code>CREATE SEQUENCE</code> keywords
   *   <li>the sequence that is being created
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>ALTER SEQUENCE</code> keywords
   *   <li>the sequence that is being altered
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>RESTART</code> keyword
   *   <li>the <code>WITH</code> keyword and the new sequence value, if applicable.
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>RENAME TO</code> keywords
   *   <li>the new sequence name
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>ALTER TABLE</code> keywords
   *   <li>the table that is being altered
   * </ul>
   */
  ALTER_TABLE_TABLE,
   ...
   *
   * <ul>
   *   <li>the <code>RENAME COLUMN</code> keywords
   *   <li>the old column name
   *   <li>the <code>TO</code> keyword
   *   <li>the new column name
   * </ul>
   */
   ...
   * <ul>
   *   <li>the <code>RENAME TO</code> keywords
   *   <li>the old index name
   *   <li>the <code>TO</code> keyword
   *   <li>the new index name
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>RENAME CONSTRAINT</code> keywords
   *   <li>the old constraint name
   *   <li>the <code>TO</code> keyword
   *   <li>the new constraint name
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>ADD</code> keywords
   *   <li>the column that is being added
   * </ul>
   */
  ALTER_TABLE_ADD,
   ...
   *
   * <ul>
   *   <li>the <code>ALTER</code> keywords
   *   <li>the column that is being altered
   * </ul>
   */
  ALTER_TABLE_ALTER,
   ...
   *
   * <ul>
   *   <li>the default expression that is being altered
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the nullability clause being altered
   * </ul>
   */
   ...
   *
   * <ul>
   *   <li>the <code>DROP</code> keywords
   *   <li>the column that is being dropped
   * </ul>
   */
  ALTER_TABLE_DROP,
   ...
   *
   * <ul>
   *   <li>the <code>ALTER SCHEMA</code> keywords
   *   <li>the schema that is being altered
   * </ul>
   */
  ALTER_SCHEMA_SCHEMA,
   ...
   *
   * <ul>
   *   <li>the <code>ALTER VIEW</code> keywords
   *   <li>the view that is being altered
   * </ul>
   */
  ALTER_VIEW_VIEW,
   ...
   *
   * <ul>
   *   <li>the <code>ALTER INDEX</code> keywords
   *   <li>the index that is being altered
   * </ul>
   */
  ALTER_INDEX_INDEX,
   ...
   *
   * <ul>
   *   <li>the <code>DROP SCHEMA</code> keywords
   *   <li>the schema that is being dropped
   * </ul>
   */
  DROP_SCHEMA_SCHEMA,
   ...
   *
   * <ul>
   *   <li>the <code>DROP VIEW</code> keywords
   *   <li>the view that is being dropped
   * </ul>
   */
  DROP_VIEW_TABLE,
   ...
   *
   * <ul>
   *   <li>the <code>DROP TABLE</code> keywords
   *   <li>the table that is being dropped
   * </ul>
   */
  DROP_TABLE_TABLE,
   ...
   *
   * <ul>
   *   <li>the <code>DROP SEQUENCE</code> keywords
   *   <li>the sequence that is being dropped
   * </ul>
   */
