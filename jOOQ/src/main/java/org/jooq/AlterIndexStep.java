...
public interface AlterIndexStep {
   ...
   *
   * <p>Note that in some databases, including MySQL and SQL Server, the index namespace is tied to
   * a table, not a schema. In those databases, it is recommended to call {@link
