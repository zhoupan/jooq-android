...
/**
 * A configuration type for use with the various {@link Meta#migrateTo(Meta)} methods.
 *
...
public final class MigrationConfiguration {
  ...
  /**
   * Whether <code>ALTER TABLE</code> statements should add multiple columns and constraints in a
   * single statement where supported.
   */
  ...
  /**
   * Whether <code>ALTER TABLE</code> statements should drop multiple columns and constraints in a
   * single statement where supported.
   */
  ...
  /**
   * Whether <code>DROP SCHEMA</code> statements should have a <code>CASCADE</code> clause where
   * supported.
   */
  ...
  /**
   * Whether <code>DROP TABLE</code> statements should have a <code>CASCADE [ CONSTRAINTS ]</code>
  ...
  /**
   * Whether <code>ALTER TABLE .. DROP</code> statements should have a <code>CASCADE [ CONSTRAINTS ]
   * </code> clause where supported.
   */
