...
public interface SelectWindowStep<R extends Record> extends SelectQualifyStep<R> {
   ...
   *
   * <p>Use the <code>WINDOW</code> clause to specify window definitions for reuse among several
   * window functions.
   *
   ...
   *   <li>{@link SQLDialect#SQLITE} (however, with some limitations. See <a href=
   *       "https://github.com/jOOQ/jOOQ/issues/8279">https://github.com/jOOQ/jOOQ/issues/8279</a>.
   *       Hence, jOOQ emulates the <code>WINDOW</code> clause for SQLite
   *   <li>{@link SQLDialect#SYBASE}
   * </ul>
   *
   * <p>If you are using any other dialect, you can still use this clause. jOOQ will inline window
   * definitions where they are referenced.
   */
  @NotNull
  @CheckReturnValue
