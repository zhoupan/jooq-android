 ...
 *
 * <p>The step in constructing the {@link Loader} object where you can set the mandatory CSV loader
 * options.
 *
 * <p>
 *
...
public interface LoaderCSVStep<R extends Record> {
   ...
   *
   * <p>The CSV column at index <code>i</code> is inserted into the table field at index <code>i
   * </code>. If <code>fields[i] == null</code> or <code>fields.length &lt;= i</code>, then the CSV
   * column is skipped.
   */
  @NotNull
  @CheckReturnValue
   ...
   * new ArrayList(fields).size() &lt;= i</code>, then the CSV column is skipped.
   */
  @NotNull
  @CheckReturnValue
  @Support
   ...
   *
   * <p>The input field obtained from {@link LoaderFieldContext#field()} wraps the CSV header column
   * name if any, or an unspecified field enumeration is used. The {@link
   * LoaderFieldContext#index()} property corresponds to the CSV column index.
   */
  @NotNull
  @CheckReturnValue
  @Support
