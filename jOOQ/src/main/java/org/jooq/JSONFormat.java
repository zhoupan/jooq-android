 ...
 *
 * <p>The default format is the following, using {@link #header()} equal to <code>true</code> and
 * applying {@link RecordFormat#ARRAY}: <code><pre>
 ...
 *
 * <p>If {@link #header()} is set to <code>false</code>, then the result is simply the records
 * array, either using {@link RecordFormat#ARRAY}: <code><pre>
 * [[value-1-1,value-1-2,...,value-1-n],
 *  [value-2-1,value-2-2,...,value-2-n]]</pre></code>
 *
 * <p>or, using {@link RecordFormat#OBJECT}: <code><pre>
 * [{"field-1": value-1-1, "field-2": value-1-2,..., "field-n": value-1-n},
 *  {"field-1": value-2-1, "field-2": value-2-2,..., "field-n": value-2-n}]</pre></code>
 *
 * <p>The type is immutable, meaning calls to setters like {@link #header(boolean)} do not modify
...
public final class JSONFormat {
  ...
  public JSONFormat() {
    this(false, "\n", 0, 2, null, true, RecordFormat.ARRAY, true, false);
  }
  ...
  /** The record format to be applied, defaulting to {@link RecordFormat#ARRAY}. */
  ...
  /**
   * Whether nested {@link JSON} or {@link JSONB} content should be quoted like a string, or nested
   * into JSON formatted output.
   */
  ...
  public enum RecordFormat {
     ...
     *
     * <p>This format allows for accessing columns by index, saving space by avoiding repetitive
     * column names in large result sets. Use this preferrably with {@link JSONFormat#header()}
