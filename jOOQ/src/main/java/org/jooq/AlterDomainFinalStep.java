 ...
 *     client code, or assign them to local variables. When writing dynamic SQL, creating a
 *     statement's components dynamically, and passing them to the DSL API statically is usually a
 *     better choice. See the manual's section about dynamic SQL for details: <a href=
