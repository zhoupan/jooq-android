...
public interface DropIndexOnStep extends DropIndexCascadeStep {
   ...
   * table-scoped index names, not schema-scoped names. This means that in these databases, the ON
   * clause is mandatory in order to unambiguously identify an index. In all other databases, the ON
