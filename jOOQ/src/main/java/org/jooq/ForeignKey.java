...
/**
 * A <code>ForeignKey</code> is an object referencing a {@link UniqueKey}. It represents a <code>
 * FOREIGN KEY</code> relationship between two tables.
 *
...
public interface ForeignKey<R extends Record, O extends Record> extends Key<R> {
   ...
   *
   * <p>This returns the order in which the fields of {@link #getKey()} are referenced, which is
   * usually the same as the fields of {@link UniqueKey#getFields()}, but not necessarily so.
   */
  @NotNull
   ...
   *
   * <p>This returns the order in which the fields of {@link #getKey()} are referenced, which is
   * usually the same as the fields of {@link UniqueKey#getFieldsArray()}, but not necessarily so.
   *
   * @see #getKeyFields()
   */
  @NotNull
   ...
   *
   * <p>This returns a parent record referenced by a given record through this foreign key, as if
   * fetching from {@link #parent(Record)}. If no parent record was found, this returns <code>null
   * </code>
   *
   ...
   *
   * <p>This returns parent records referenced by any record in a given set of records through this
   * foreign key, as if fetching from {@link #parents(Record...)}.
   *
   * @throws DataAccessException if something went wrong executing the query
   * @see TableRecord#fetchParent(ForeignKey)
   */
   ...
   *
   * <p>This returns parent records referenced by any record in a given set of records through this
   * foreign key, as if fetching from {@link #parents(Collection)}.
   *
   * @throws DataAccessException if something went wrong executing the query
   * @see TableRecord#fetchParent(ForeignKey)
   */
   ...
   *
   * <p>This returns childs record referencing a given record through this foreign key, as if
   * fetching from {@link #children(Record)}.
   *
   * @throws DataAccessException if something went wrong executing the query
   ...
   *
   * <p>This returns childs record referencing any record in a given set of records through this
   ...
   *
   * <p>This returns childs record referencing any record in a given set of records through this
   * foreign key, as if fetching from {@link #children(Collection)}.
   *
   * @throws DataAccessException if something went wrong executing the query
   * @see UpdatableRecord#fetchChild(ForeignKey)
   * @see UpdatableRecord#fetchChildren(ForeignKey)
