...
/**
 * An intermediate type for the construction of a partitioned {@link SQLDialect#ORACLE} <code>
 * OUTER JOIN</code> clause.
 *
 * <p>This step allows for adding Oracle-specific <code>PARTITION BY</code> clauses to the right of
 * an <code>OUTER JOIN</code> keyword. See the Oracle documentation for more details here: <a href=
