 ...
 * @author Lukas Eder
 * @see <a
 *     href="http://www.h2database.com/html/datatypes.html">http://www.h2database.com/html/datatypes.html</a>
...
public class H2DataType {
  ...
  public static final DataType<Byte> TINYINT =
      new DefaultDataType<>(FAMILY, SQLDataType.TINYINT, "tinyint");
  ...
  public static final DataType<Integer> MEDIUMINT =
      new DefaultDataType<>(FAMILY, SQLDataType.INTEGER, "mediumint");
  ...
  public static final DataType<Integer> SIGNED =
      new DefaultDataType<>(FAMILY, SQLDataType.INTEGER, "signed");
  ...
  public static final DataType<BigDecimal> DEC =
      new DefaultDataType<>(FAMILY, SQLDataType.DECIMAL, "dec(p, s)");
  public static final DataType<BigDecimal> NUMBER =
      new DefaultDataType<>(FAMILY, SQLDataType.NUMERIC, "number(p, s)");
  ...
  public static final DataType<Double> FLOAT =
      new DefaultDataType<>(FAMILY, SQLDataType.FLOAT, "float");
  public static final DataType<Double> FLOAT4 =
      new DefaultDataType<>(FAMILY, SQLDataType.FLOAT, "float4");
  ...
  public static final DataType<Timestamp> DATETIME =
      new DefaultDataType<>(FAMILY, SQLDataType.TIMESTAMP, "datetime(p)");
  ...
  public static final DataType<byte[]> BINARY =
      new DefaultDataType<>(FAMILY, SQLDataType.BINARY, "binary(l)");
  public static final DataType<byte[]> VARBINARY =
      new DefaultDataType<>(FAMILY, SQLDataType.VARBINARY, "varbinary(l)");
  public static final DataType<byte[]> LONGVARBINARY =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGVARBINARY, "longvarbinary(l)");
  public static final DataType<byte[]> BLOB =
      new DefaultDataType<>(FAMILY, SQLDataType.BLOB, "blob");
  public static final DataType<Object> OTHER =
      new DefaultDataType<>(FAMILY, SQLDataType.OTHER, "other");
  ...
  public static final DataType<String> VARCHAR2 =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "varchar2(l)");
  ...
  public static final DataType<String> LONGVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGVARCHAR, "longvarchar(l)");
  public static final DataType<String> CLOB =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "clob");
  public static final DataType<String> NVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.NVARCHAR, "nvarchar(l)");
  public static final DataType<String> NVARCHAR2 =
      new DefaultDataType<>(FAMILY, SQLDataType.NVARCHAR, "nvarchar2(l)");
  public static final DataType<String> NCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.NCHAR, "nchar(l)");
  public static final DataType<String> NCLOB =
      new DefaultDataType<>(FAMILY, SQLDataType.NCLOB, "nclob");
  ...
  public static final DataType<JSONB> JSONB =
      new DefaultDataType<>(FAMILY, SQLDataType.JSONB, "json");
  ...
  protected static final DataType<String> __LONGNVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGNVARCHAR, "longvarchar(l)");
  protected static final DataType<Result<Record>> __RESULT =
      new DefaultDataType<>(FAMILY, SQLDataType.RESULT, "result_set");
  ...
  protected static final DataType<ULong> __BIGINTUNSIGNED =
      new DefaultDataType<>(FAMILY, SQLDataType.BIGINTUNSIGNED, "number(p, s)");
  ...
  public static final DataType<Short> YEAR =
      new DefaultDataType<>(FAMILY, SQLDataType.SMALLINT, "year");
  public static final DataType<Long> IDENTITY =
      new DefaultDataType<>(FAMILY, SQLDataType.BIGINT, "identity");
  public static final DataType<Timestamp> SMALLDATETIME =
      new DefaultDataType<>(FAMILY, SQLDataType.TIMESTAMP, "smalldatetime");
  ...
  public static final DataType<byte[]> TINYBLOB =
      new DefaultDataType<>(FAMILY, SQLDataType.BLOB, "tinyblob");
  ...
  public static final DataType<byte[]> LONGBLOB =
      new DefaultDataType<>(FAMILY, SQLDataType.BLOB, "longblob");
  public static final DataType<byte[]> IMAGE =
      new DefaultDataType<>(FAMILY, SQLDataType.BLOB, "image");
  ...
  public static final DataType<String> VARCHAR_CASESENSITIVE =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "varchar_casesensitive(l)");
  public static final DataType<String> VARCHAR_IGNORECASE =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "varchar_ignorecase(l)");
  ...
  public static final DataType<String> TINYTEXT =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "tinytext");
  ...
  public static final DataType<String> MEDIUMTEXT =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "mediumtext");
  public static final DataType<String> LONGTEXT =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "longtext");
  public static final DataType<String> NTEXT =
      new DefaultDataType<>(FAMILY, SQLDataType.NCLOB, "ntext");
}
