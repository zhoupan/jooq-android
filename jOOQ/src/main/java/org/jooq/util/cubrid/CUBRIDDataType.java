...
public class CUBRIDDataType {
  ...
  public static final DataType<Short> SHORT =
      new DefaultDataType<>(FAMILY, SQLDataType.SMALLINT, "short");
  ...
  public static final DataType<BigDecimal> NUMERIC =
      new DefaultDataType<>(FAMILY, SQLDataType.DECIMAL, "numeric");
  ...
  public static final DataType<String> VARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "varchar");
  public static final DataType<String> CHARVARYING =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "char varying");
  public static final DataType<String> CHARACTERVARYING =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "character varying");
  public static final DataType<String> CHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.CHAR, "char", "varchar");
  public static final DataType<String> CHARACTER =
      new DefaultDataType<>(FAMILY, SQLDataType.CHAR, "character", "varchar");
  public static final DataType<String> STRING =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "string");
  public static final DataType<String> NCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.NCHAR, "nchar");
  ...
  public static final DataType<Timestamp> DATETIME =
      new DefaultDataType<>(FAMILY, SQLDataType.TIMESTAMP, "datetime");
  ...
  public static final DataType<byte[]> BITVARYING =
      new DefaultDataType<>(FAMILY, SQLDataType.VARBINARY, "bit varying");
  public static final DataType<byte[]> VARBIT =
      new DefaultDataType<>(FAMILY, SQLDataType.VARBINARY, "varbit");
  public static final DataType<byte[]> BIT =
      new DefaultDataType<>(FAMILY, SQLDataType.BINARY, "bit");
  ...
  protected static final DataType<Boolean> __BOOL =
      new DefaultDataType<>(FAMILY, SQLDataType.BOOLEAN, "bit", "bit(1)");
  protected static final DataType<Boolean> __BIT =
      new DefaultDataType<>(FAMILY, SQLDataType.BIT, "bit", "bit(1)");
  protected static final DataType<String> __LONGNVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGNVARCHAR, "varchar");
  ...
  protected static final DataType<String> __NVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.NVARCHAR, "varchar");
  protected static final DataType<String> __LONGVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGVARCHAR, "varchar");
  ...
  protected static final DataType<BigDecimal> __NUMERIC =
      new DefaultDataType<>(FAMILY, SQLDataType.NUMERIC, "decimal");
  ...
  protected static final DataType<ULong> __BIGINTUNSIGNED =
      new DefaultDataType<>(FAMILY, SQLDataType.BIGINTUNSIGNED, "decimal");
  ...
  protected static final DataType<UUID> __UUID =
      new DefaultDataType<>(FAMILY, SQLDataType.UUID, "varchar");
  ...
  public static final DataType<Double> MONETARY =
      new DefaultDataType<>(FAMILY, SQLDataType.DOUBLE, "monetary");
  public static final DataType<String> ENUM =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "enum", "varchar");
  ...
  public static final DataType<Object> OID =
      new DefaultDataType<>(FAMILY, SQLDataType.OTHER, "oid");
  public static final DataType<Object> ELO =
      new DefaultDataType<>(FAMILY, SQLDataType.OTHER, "elo");
  public static final DataType<Object> MULTISET =
      new DefaultDataType<>(FAMILY, SQLDataType.OTHER, "multiset");
  public static final DataType<Object> SEQUENCE =
      new DefaultDataType<>(FAMILY, SQLDataType.OTHER, "sequence");
  public static final DataType<Object> SET =
      new DefaultDataType<>(FAMILY, SQLDataType.OTHER, "set");
}
