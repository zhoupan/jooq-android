...
public class FirebirdDataType {
  ...
  public static final DataType<Double> D_FLOAT =
      new DefaultDataType<>(FAMILY, SQLDataType.DOUBLE, "d_float");
  ...
  public static final DataType<String> VARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "varchar", "varchar(4000)");

  public static final DataType<String> CHARACTERVARYING =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "character varying", "varchar(4000)");

  public static final DataType<String> CHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.CHAR, "char");

  public static final DataType<String> CHARACTER =
      new DefaultDataType<>(FAMILY, SQLDataType.CHAR, "character");

  public static final DataType<String> CLOB =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "blob sub_type text");
  ...
  protected static final DataType<Double> __FLOAT =
      new DefaultDataType<>(FAMILY, SQLDataType.FLOAT, "double precision");

  protected static final DataType<String> __LONGNVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGNVARCHAR, "blob sub_type text");
  ...
  protected static final DataType<String> __LONGVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGVARCHAR, "varchar", "varchar(4000)");

  protected static final DataType<String> __NCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.NCHAR, "char");
  ...
  protected static final DataType<String> __NVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.NVARCHAR, "varchar", "varchar(4000)");
  ...
  protected static final DataType<ULong> __BIGINTUNSIGNED =
      new DefaultDataType<>(FAMILY, SQLDataType.BIGINTUNSIGNED, "decimal", "varchar(20)");

  protected static final DataType<JSON> __JSON =
      new DefaultDataType<>(FAMILY, SQLDataType.JSON, "blob sub_type text");
  ...
  protected static final DataType<BigInteger> __BIGINTEGER =
      new DefaultDataType<>(FAMILY, SQLDataType.DECIMAL_INTEGER, "decimal");
  ...
  // -------------------------------------------------------------------------
  protected static final DataType<byte[]> BLOBSUBTYPEBINARY =
      new DefaultDataType<>(FAMILY, SQLDataType.BLOB, "blob sub_type binary");

  protected static final DataType<byte[]> BLOBSUBTYPE0 =
      new DefaultDataType<>(FAMILY, SQLDataType.BLOB, "blob sub_type 0");

  protected static final DataType<String> BLOBSUBTYPETEXT =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "blob sub_type text");

  protected static final DataType<String> BLOBSUBTYPE1 =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "blob sub_type 1");
}
