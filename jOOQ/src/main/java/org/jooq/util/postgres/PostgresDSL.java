...
public class PostgresDSL extends DSL {
  ...
  @NotNull
  @Support({POSTGRES})
  public static <T> Field<T[]> arrayFill(
      T value, Field<Integer[]> dimensions, Field<Integer[]> bounds) {
  ...
  @Support({POSTGRES})
  public static <T> Field<T[]> arrayFill(
      Field<T> value, Field<Integer[]> dimensions, Field<Integer[]> bounds) {
    return function(
        "array_fill", nullSafeDataType(value).getArrayDataType(), value, dimensions, bounds);
  }

  /**
   * The PostgreSQL <code>array_length(anyarray, int)</code> function.
   *
   * <p>jOOQ currently doesn't support multi-dimensional arrays, so the dimension will always be
   * <code>1</code>.
   *
   * <p>Example: <code><pre>
  ...
  @NotNull
  @Support({POSTGRES})
  public static Field<String> arrayToString(
      Field<? extends Object[]> array, Field<String> delimiter) {
  ...
  public static Field<String[]> stringToArray(String string, String delimiter, String nullString) {
    return stringToArray(
        val(string, String.class), val(delimiter, String.class), val(nullString, String.class));
  }
  ...
  @NotNull
  @Support({POSTGRES})
  public static Field<String[]> stringToArray(
      String string, Field<String> delimiter, Field<String> nullString) {
  ...
  @Support({POSTGRES})
  public static Field<String[]> stringToArray(
      Field<String> string, String delimiter, String nullString) {
  ...
  @Support({POSTGRES})
  public static Field<String[]> stringToArray(
      Field<String> string, Field<String> delimiter, Field<String> nullString) {
    return function(
        "string_to_array", SQLDataType.VARCHAR.getArrayDataType(), string, delimiter, nullString);
  }
