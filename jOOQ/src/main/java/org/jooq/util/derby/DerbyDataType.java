 ...
 * @author Lukas Eder
 * @see <a
 *     href="http://db.apache.org/derby/docs/10.7/ref/crefsqlj31068.html">http://db.apache.org/derby/docs/10.7/ref/crefsqlj31068.html</a>
...
public class DerbyDataType {
  ...
  public static final DataType<BigDecimal> DEC =
      new DefaultDataType<>(FAMILY, SQLDataType.DECIMAL, "dec");
  public static final DataType<BigDecimal> NUMERIC =
      new DefaultDataType<>(FAMILY, SQLDataType.NUMERIC, "numeric");
  public static final DataType<String> VARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "varchar", "varchar(32672)");
  public static final DataType<String> LONGVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGVARCHAR, "long varchar");
  public static final DataType<String> CHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.CHAR, "char", "char(1)");
  public static final DataType<String> CHARACTER =
      new DefaultDataType<>(FAMILY, SQLDataType.CHAR, "character", "character(1)");
  ...
  public static final DataType<String> CHARACTERLARGEOBJECT =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "character large object");
  public static final DataType<String> CHARVARYING =
      new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "char varying", "char varying(32672)");
  public static final DataType<String> CHARACTERVARYING =
      new DefaultDataType<>(
          FAMILY, SQLDataType.VARCHAR, "character varying", "character varying(32672)");
  ...
  public static final DataType<byte[]> BINARYLARGEOBJECT =
      new DefaultDataType<>(FAMILY, SQLDataType.BLOB, "binary large object");
  ...
  protected static final DataType<byte[]> __BINARY =
      new DefaultDataType<>(FAMILY, SQLDataType.BINARY, "blob");
  ...
  protected static final DataType<byte[]> __LONGVARBINARY =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGVARBINARY, "blob");
  ...
  protected static final DataType<String> __LONGNVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.LONGNVARCHAR, "long varchar");
  protected static final DataType<String> __NVARCHAR =
      new DefaultDataType<>(FAMILY, SQLDataType.NVARCHAR, "varchar", "varchar(32672)");
  ...
  protected static final DataType<byte[]> __VARBINARY =
      new DefaultDataType<>(FAMILY, SQLDataType.VARBINARY, "blob");
  ...
  protected static final DataType<ULong> __BIGINTUNSIGNED =
      new DefaultDataType<>(FAMILY, SQLDataType.BIGINTUNSIGNED, "decimal", "decimal(20)");
  ...
  protected static final DataType<BigInteger> __BIGINTEGER =
      new DefaultDataType<>(FAMILY, SQLDataType.DECIMAL_INTEGER, "decimal", "decimal(31)");
  protected static final DataType<UUID> __UUID =
      new DefaultDataType<>(FAMILY, SQLDataType.UUID, "varchar", "varchar(36)");
  ...
  public static final DataType<String> JAVAIOSERIALIZABLE =
      new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "java.io.Serializable");
}
