...
public class MySQLDSL extends DSL {
   ...
   *
   * <p>Don't mix this up with the various {@link DSL#decode()} methods!
   *
  ...
  // -------------------------------------------------------------------------
  /**
   * Get the MySQL-specific <code>VALUES()</code> function for use with <code>
   * INSERT .. ON DUPLICATE KEY UPDATE</code> statements.
   *
   * @see <a href=
   *     "http://dev.mysql.com/doc/refman/5.7/en/miscellaneous-functions.html#function_values">
   *     http://dev.mysql.com/doc/refman/5.7/en/miscellaneous-functions.html# function_values</a>
   * @deprecated - 3.15.0 - [#12099] - MySQL 8.0.20 has deprecated this clause and replaced it by
   *     something new, which we'll support soon, see <a href=
   ...
   *
   * <p>If your MySQL enum type contains these three values: <code>A, B, C</code> , then this will
   * be the mapping of indexes to values:
   *
   * <table border="1">
   * <tr>
   ...
   * </table>
   *
   * <p>See <a href="dev.mysql.com/doc/refman/5.5/en/enum.html">dev.mysql.com/doc/
   * refman/5.5/en/enum.html</a> for more details about MySQL enum types
   */
  public static <E extends java.lang.Enum<E> & org.jooq.EnumType> E enumType(
      Class<E> type, int index) {
    if (index <= 0) {
      return null;
    }
