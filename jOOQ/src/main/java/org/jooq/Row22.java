...
public interface Row22<
  ...
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record22} to custom type {@link RecordMapper}
   * that can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING
   * </code> clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function22)}, this method attempts to work
