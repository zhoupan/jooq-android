 ...
 * @author Lukas Eder
 */
public interface InsertValuesStep10<R extends Record, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> values(
      T1 value1,
      T2 value2,
      T3 value3,
      T4 value4,
  ...
  @Support
  InsertValuesStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> values(
      Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> values);
  ...
  InsertValuesStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> valuesOfRows(
      Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>... values);
  ...
  @Support
  InsertValuesStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> valuesOfRows(
      Collection<? extends Row10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> values);
  ...
  @Support
  @SuppressWarnings("unchecked")
  InsertValuesStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> valuesOfRecords(
      Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>... values);
  ...
  @Support
  InsertValuesStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> valuesOfRecords(
      Collection<? extends Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>> values);
