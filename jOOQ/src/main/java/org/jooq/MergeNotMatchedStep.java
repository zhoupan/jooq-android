...
public interface MergeNotMatchedStep<R extends Record> extends MergeFinalStep<R> {
   ...
   *
   * <p>Unlike the {@link #whenNotMatchedThenInsert(Field...)} and {@link
   * #whenNotMatchedThenInsert(Collection)} methods, this will give access to a MySQL-like API
   * allowing for <code>INSERT SET a = x, b = y</code> syntax.
   */
  @NotNull
  @CheckReturnValue
  ...
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB})
  <T1, T2> MergeNotMatchedValuesStep2<R, T1, T2> whenNotMatchedThenInsert(
  ...
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB})
  <T1, T2, T3> MergeNotMatchedValuesStep3<R, T1, T2, T3> whenNotMatchedThenInsert(
  ...
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB})
  <T1, T2, T3, T4> MergeNotMatchedValuesStep4<R, T1, T2, T3, T4> whenNotMatchedThenInsert(
  ...
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB})
  <T1, T2, T3, T4, T5> MergeNotMatchedValuesStep5<R, T1, T2, T3, T4, T5> whenNotMatchedThenInsert(
  ...
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB})
  <T1, T2, T3, T4, T5, T6>
      MergeNotMatchedValuesStep6<R, T1, T2, T3, T4, T5, T6> whenNotMatchedThenInsert(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7>
      MergeNotMatchedValuesStep7<R, T1, T2, T3, T4, T5, T6, T7> whenNotMatchedThenInsert(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8>
      MergeNotMatchedValuesStep8<R, T1, T2, T3, T4, T5, T6, T7, T8> whenNotMatchedThenInsert(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9>
      MergeNotMatchedValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> whenNotMatchedThenInsert(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
