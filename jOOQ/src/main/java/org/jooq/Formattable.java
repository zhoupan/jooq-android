 ...
 *
 * <p>This type provides a common interface for {@link Result} and {@link Cursor} formatting
 * functionality, which includes formatting results to:
 *
 * <ul>
 *   <li>Charts
 *   <li>CSV
 *   <li>HTML
 *   <li>INSERT statements
 *   <li>JSON
 *   <li>Text
 *   <li>XML
 * </ul>
 *
 * <p>Calling formatting methods on a {@link Result} is repeatable as the {@link Result} has been
 * previously materialised in memory and the database resource is closed. Calling these methods on a
 * {@link Cursor} is not repeatable as the {@link Cursor} (and the underlying JDBC {@link
 * ResultSet}) is consumed entirely, and closed eagerly after consumption.
 *
 * @author Lukas Eder
 */
public interface Formattable {
   ...
   *
   * <p>This is the same as calling {@link #format(int)} with <code>maxRows = Integer.MAX_VALUE
   * </code>
   *
   ...
   * Get a simple formatted representation of this result.
   *
   * @param maxRecords The maximum number of records to include in the formatted result
   * @return The formatted result
   */
  @NotNull
   ...
   *
   * <p>The HTML code is formatted as follows: <code><pre>
   * &lt;table&gt;
   *   &lt;thead&gt;
   *     &lt;tr&gt;
   *       &lt;th&gt;field-1&lt;/th&gt;
   ...
   *
   * <p>This is the same as calling <code>formatCSV(true, ',', "")</code>
   *
   * @return The formatted result
   */
  @NotNull
   ...
   * Get a simple formatted representation of this result as CSV.
   *
   * <p>This is the same as calling <code>formatCSV(true, delimiter, "")</code>
   *
   ...
   * Get a simple formatted representation of this result as CSV.
   *
   * <p>This is the same as calling <code>formatCSV(true, delimiter, nullString)</code>
   *
   * @param delimiter The delimiter to use between records
   ...
   * Get a simple formatted representation of this result as CSV.
   *
   * <p>This is the same as calling <code>formatCSV(',', "")</code>
   *
   ...
   * Get a simple formatted representation of this result as CSV.
   *
   * <p>This is the same as calling <code>formatCSV(delimiter, "")</code>
   *
   * @param header Whether to emit a CSV header line
   * @param delimiter The delimiter to use between records
   * @return The formatted result
   ...
   *
   * <p>The format is the following: <code><pre>
  ...
  /**
   * Get a simple formatted representation of this result as a JSON data structure, according to the
   * format.
   *
   * @return The formatted result
   * @see JSONFormat
   ...
   * Get this result as an ASCII chart.
   *
   * <p>When running a query like this: <code><pre>
   * String chart =
   * create.select(
   ...
   * </pre>
   *
   * It is possible to specify a variety of {@link ChartFormat} formatting specifications, such as
   * the width, height, display type (default, stacked, 100% stacked), the column index of the
   * category and value columns, etc.
   *
   * @see #formatChart(ChartFormat)
   */
  @NotNull
   ...
   *
   * <p>This uses the the first record's {@link TableRecord#getTable()}, if the first record is a
   * {@link TableRecord}. Otherwise, this generates <code>INSERT</code> statements into an <code>
   * "UNKNOWN_TABLE"</code>. In both cases, the {@link Result#fields()} are used for column names.
   */
  @NotNull
  String formatInsert();
   ...
   * Get this result as a set of <code>INSERT</code> statements.
   *
   * <p>This explicitly specifies the table (and optionally the fields) to insert into. If the
   * <code>fields</code> argument is left empty, the {@link Result#fields()} are used, instead.
   */
  @NotNull
   ...
   *
   * @throws IOException - an unchecked wrapper for {@link java.io.IOException}, if anything goes
   *     wrong.
   */
  ...
  /**
   * Like {@link #formatCSV(boolean, char, String)}, but the data is output onto an {@link
   * OutputStream}.
   *
   * @throws IOException - an unchecked wrapper for {@link java.io.IOException}, if anything goes
   *     wrong.
   */
  void formatCSV(OutputStream stream, boolean header, char delimiter, String nullString)
      throws IOException;
  ...
  /**
   * Like {@link #formatInsert(Table, Field...)}, but the data is output onto an {@link
   * OutputStream}.
   *
   * @throws IOException - an unchecked wrapper for {@link java.io.IOException}, if anything goes
   *     wrong.
   ...
   *     wrong.
   */
  void formatCSV(Writer writer, boolean header, char delimiter, String nullString)
      throws IOException;
