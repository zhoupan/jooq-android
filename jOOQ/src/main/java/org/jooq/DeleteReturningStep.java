 ...
 *   <li>DB2 allows to execute <code>SELECT .. FROM FINAL TABLE (DELETE ...)</code>
 * </ul>
 *
 * <p>
 *
...
public interface DeleteReturningStep<R extends Record> extends DeleteFinalStep<R> {
   ...
   *
   * <p>This will return the data <em>before</em> deletion.
   *
  ...
  /**
   * Configure the <code>DELETE</code> statement to return a list of fields in <code>R</code>.
   *
   * <p>This will return the data <em>before</em> deletion.
   *
  ...
  @CheckReturnValue
  @Support({FIREBIRD, MARIADB, POSTGRES})
  <T1, T2> DeleteResultStep<Record2<T1, T2>> returningResult(
  ...
  @CheckReturnValue
  @Support({FIREBIRD, MARIADB, POSTGRES})
  <T1, T2, T3> DeleteResultStep<Record3<T1, T2, T3>> returningResult(
  ...
  @CheckReturnValue
  @Support({FIREBIRD, MARIADB, POSTGRES})
  <T1, T2, T3, T4> DeleteResultStep<Record4<T1, T2, T3, T4>> returningResult(
  ...
  @CheckReturnValue
  @Support({FIREBIRD, MARIADB, POSTGRES})
  <T1, T2, T3, T4, T5> DeleteResultStep<Record5<T1, T2, T3, T4, T5>> returningResult(
      SelectField<T1> field1,
      SelectField<T2> field2,
      SelectField<T3> field3,
      SelectField<T4> field4,
  ...
  @CheckReturnValue
  @Support({FIREBIRD, MARIADB, POSTGRES})
  <T1, T2, T3, T4, T5, T6> DeleteResultStep<Record6<T1, T2, T3, T4, T5, T6>> returningResult(
      SelectField<T1> field1,
      SelectField<T2> field2,
      SelectField<T3> field3,
      SelectField<T4> field4,
