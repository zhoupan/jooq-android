...
/**
 * The step in the <code>ALTER TABLE</code> statement where the action can be decided.
 *
 * <p>
 *
...
public interface AlterTableStep {
  ...
  /**
   * Add an <code>ALTER CONSTRAINT</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #alterConstraint(Constraint)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({MYSQL})
   ...
   *
   * <p>This is an alias for {@link #alterColumn(Field)}.
   */
  @NotNull
  @CheckReturnValue
   ...
   * Add an <code>ALTER COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #alterColumn(Name)}
   */
  @NotNull
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB, MARIADB, MYSQL, POSTGRES})
   ...
   * Add an <code>ALTER COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #alterColumn(String)}
   */
  @NotNull
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB, MARIADB, MYSQL, POSTGRES})
   ...
   *
   * <p>This is an alias for {@link #addColumn(Field)}.
   */
  @NotNull
  @CheckReturnValue
  @Support
  ...
  /**
   * Add an <code>ADD</code> clause with multiple columns or constraints to the <code>ALTER TABLE
   * </code> statement.
   */
  @NotNull
  @CheckReturnValue
   ...
   * Add an <code>ADD COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #addColumn(Field, DataType)}.
   */
  @NotNull
  @CheckReturnValue
  @Support
   ...
   * Add an <code>ADD COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #addColumn(Name, DataType)}.
   */
  @NotNull
  @CheckReturnValue
  @Support
   ...
   * Add an <code>ADD COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #addColumn(String, DataType)}.
   */
  @NotNull
  @CheckReturnValue
  @Support
   ...
   *
   * <p>This is an alias for {@link #addColumnIfNotExists(Field)}.
   */
  @NotNull
  @CheckReturnValue
   ...
   * Add an <code>ADD COLUMN IF NOT EXISTS</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #addColumnIfNotExists(Field, DataType)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({H2, IGNITE, MARIADB, POSTGRES})
   ...
   * Add an <code>ADD COLUMN IF NOT EXISTS</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #addColumnIfNotExists(Name, DataType)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({H2, IGNITE, MARIADB, POSTGRES})
   ...
   * Add an <code>ADD COLUMN IF NOT EXISTS</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #addColumnIfNotExists(String, DataType)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({H2, IGNITE, MARIADB, POSTGRES})
   ...
   *
   * <p>This is an alias for {@link #dropColumn(Field)}.
   */
  @NotNull
  @CheckReturnValue
   ...
   * Add an <code>DROP COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #dropColumn(Name)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB, IGNITE, MARIADB, MYSQL, POSTGRES})
   ...
   * Add an <code>DROP COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #dropColumn(String)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB, IGNITE, MARIADB, MYSQL, POSTGRES})
   ...
   *
   * <p>This is an alias for {@link #dropColumnIfExists(Field)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({H2, IGNITE, MARIADB, POSTGRES})
   ...
   * Add an <code>DROP COLUMN IF EXISTS</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #dropColumnIfExists(Name)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({H2, IGNITE, MARIADB, POSTGRES})
   ...
   * Add an <code>DROP COLUMN IF EXISTS</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #dropColumnIfExists(String)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({H2, IGNITE, MARIADB, POSTGRES})
   ...
   * Add an <code>DROP COLUMN</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>This is an alias for {@link #dropColumns(Collection)}.
   */
  @NotNull
  @CheckReturnValue
  @Support({FIREBIRD, H2, IGNITE, MARIADB, MYSQL, POSTGRES})
   ...
   * Add a <code>DROP PRIMARY KEY</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>Dialect families derived from MySQL do not know named constraints, in case of which this
   * clause simply generates <code>DROP PRIMARY KEY</code> as in {@link #dropPrimaryKey()}. In other
   * dialect families, this produces a <code>DROP CONSTRAINT [name]</code> clause, as in {@link
  ...
  /**
   * Add a <code>DROP UNIQUE</code> clause to the <code>ALTER TABLE</code> statement.
   *
   * <p>Some dialects (e.g. {@link SQLDialect#COCKROACHDB}) may not be able to drop constraints by
   * name. If users specify the constraint type <em>and</em> the name, however, then the syntax can
   * be emulated, e.g. using <code>DROP INDEX .. CASCADE</code>.
   */
  @NotNull
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB, MARIADB, MYSQL, POSTGRES})
