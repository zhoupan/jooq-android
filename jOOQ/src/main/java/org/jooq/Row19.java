...
public interface Row19<
  ...
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record19} to custom type {@link RecordMapper}
   * that can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING
   * </code> clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function19)}, this method attempts to work
   ...
   *
   * @see #equal(Record19)
   * @see #notEqual(Record19)
   * @see #lessThan(Record19)
   * @see #lessOrEqual(Record19)
   * @see #greaterThan(Record19)
   * @see #greaterOrEqual(Record19)
   */
  @NotNull
  @Support
  Condition compare(
