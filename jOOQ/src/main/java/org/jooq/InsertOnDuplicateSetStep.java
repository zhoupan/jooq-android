...
public interface InsertOnDuplicateSetStep<R extends Record> {
  ...
  /**
   * Set values for <code>UPDATE</code> in the <code>INSERT</code> statement's <code>
   * ON DUPLICATE KEY UPDATE</code> or <code>ON CONFLICT ... DO UPDATE</code> clause.
   */
  @NotNull
  @CheckReturnValue
  ...
  /**
   * Set a <code>null</code> value for <code>UPDATE</code> in the <code>INSERT</code> statement's
  ...
  /**
   * Set multiple values for <code>UPDATE</code> in the <code>INSERT</code> statement's <code>
   * ON DUPLICATE KEY UPDATE</code> or <code>ON CONFLICT ... DO UPDATE</code> clause.
   *
