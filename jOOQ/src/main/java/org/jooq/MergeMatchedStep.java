...
public interface MergeMatchedStep<R extends Record> extends MergeNotMatchedStep<R> {
  ...
  /** Add the <code>WHEN MATCHED THEN DELETE</code> clause to the <code>MERGE</code> statement. */
  @NotNull
  @CheckReturnValue
  @Support({DERBY, FIREBIRD, H2, HSQLDB})
  MergeMatchedStep<R> whenMatchedThenDelete();

  /** Add the <code>WHEN MATCHED AND</code> clause to the <code>MERGE</code> statement. */
  @NotNull
  @CheckReturnValue
  @Support({DERBY, FIREBIRD, H2, HSQLDB})
