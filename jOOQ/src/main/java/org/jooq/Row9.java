 ...
 * @author Lukas Eder
 */
public interface Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9>
    extends Row, SelectField<Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {

  // ------------------------------------------------------------------------
  // Mapping convenience methods
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record9} to custom type {@link RecordMapper} that
   * can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING</code>
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function9)}, this method attempts to work
  ...
  @Support
  Condition compare(
      Comparator comparator, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9);
  ...
  @Support
  Condition compare(
      Comparator comparator, Select<? extends Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> select);
  ...
  @NotNull
  @Support
  Condition isDistinctFrom(Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> row);

  /** Compare this row value expression with another row value expression for distinctness. */
  @NotNull
  @Support
  Condition isDistinctFrom(Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> record);
  ...
  @NotNull
  @Support
  Condition isNotDistinctFrom(Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> row);

  /** Compare this row value expression with another row value expression for distinctness. */
  @NotNull
  @Support
  Condition isNotDistinctFrom(Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> record);
  ...
  @NotNull
  @Support
  BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> between(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @Support
  BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> between(
      Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> minValue);
  ...
  @Support
  BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> between(
      Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> minValue);
  ...
  @NotNull
  @Support
  BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> betweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> notBetween(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep9<T1, T2, T3, T4, T5, T6, T7, T8, T9> notBetweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
