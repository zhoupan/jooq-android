...
public class MappedCatalog extends SettingsBase implements Serializable, Cloneable, XMLAppendable {
  ...
  /**
   * A regular expression matching the input catalog name as defined in {@link
   * org.jooq.Catalog#getName()}
   *
   * <p>Either &lt;input/&gt; or &lt;inputExpression/&gt; must be provided
   */
   ...
   *
   * <ul>
   *   <li>When this is omitted, you can still apply schema and table mapping.
