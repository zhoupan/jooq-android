...
public class MappedSchema extends SettingsBase implements Serializable, Cloneable, XMLAppendable {
  ...
  /**
   * A regular expression matching the input schema name as defined in {@link
   * org.jooq.Schema#getName()}
   *
   * <p>Either &lt;input/&gt; or &lt;inputExpression/&gt; must be provided
   */
   ...
   *
   * <ul>
   *   <li>When this is omitted, you can still apply table mapping.
