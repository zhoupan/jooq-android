 ...
 *
 * <p>The type is immutable, meaning calls to setters like {@link #delimiter(char)} do not modify
 * the original reference, but return a new one instead.
 *
 * @author Lukas Eder
 */
public final class CSVFormat {
  ...
  /**
   * The delimiter to be used between CSV cells, defaulting to <code>","</code>.
   *
   * <p>
   *
   * <table border="1">
  ...
  public CSVFormat delimiter(String newDelimiter) {
    return new CSVFormat(
        newDelimiter, nullString, emptyString, newline, quoteString, quote, header);
  }
  ...
  public CSVFormat nullString(String newNullString) {
    return new CSVFormat(
        delimiter, newNullString, emptyString, newline, quoteString, quote, header);
  }
  ...
  /**
   * The string to be used for <code>""</code> values, defaulting to the empty string.
   *
   * <p>
   *
   * <table border="1">
  ...
  public CSVFormat emptyString(String newEmptyString) {
    return new CSVFormat(
        delimiter, nullString, newEmptyString, newline, quoteString, quote, header);
  }
  ...
  public CSVFormat newline(String newNewline) {
    return new CSVFormat(
        delimiter, nullString, emptyString, newNewline, quoteString, quote, header);
  }
  ...
  public CSVFormat quoteString(String newQuoteString) {
    return new CSVFormat(
        delimiter, nullString, emptyString, newline, newQuoteString, quote, header);
  }
  ...
  public CSVFormat quote(Quote newQuote) {
    return new CSVFormat(
        delimiter, nullString, emptyString, newline, quoteString, newQuote, header);
  }
  ...
  public CSVFormat header(boolean newHeader) {
    return new CSVFormat(
        delimiter, nullString, emptyString, newline, quoteString, quote, newHeader);
  }
  ...
  public enum Quote {
     ...
     *
     * <p>Special characters consist of:
     *
     * <ul>
     *   <li><code>,</code>: The comma
     *   <li><code>;</code>: The semi colon
     *   <li><code>"</code>: The double quote
     *   <li><code>'</code>: The apostrophe
     *   <li><code>\</code>: The backslash
     *   <li><code>\t</code>: The tab character
     *   <li><code>\n</code>: The line feed character
     *   <li><code>\r</code>: The carriage return character
     * </ul>
     */
    SPECIAL_CHARACTERS,
