...
public interface ParseContext extends Scope {
   ...
   *
   * <p>The argument keyword should be in UPPER CASE and is allowed to contain spaces. Spaces
   * separating keyword parts are interpreted as any arbitrary amount of whitespace. For example,
   * when parsing <code>"ORDER BY"</code>, then <code>"order    by"</code> will be parsed as well.
   *
   * @return Always returns true.
   ...
   *
   * @return The identifier if it could be parsed, or <code>null</code> if the current token is not
   *     an identifier.
   */
  @Nullable
   ...
   *
   * @return The name if it could be parsed, or <code>null</code> if the current token is not a
   *     name.
   */
  @Nullable
  Name parseNameIf();
   ...
   *
   * @return The string literal if it could be parsed, or <code>null</code> if the current token is
  ...
  /**
   * Parse an unsigned integer literal or fail if the current token is not an unsigned integer
   * literal.
   *
   ...
   *
   * @return The unsigned integer literal if it could be parsed, or <code>null</code> if the current
   *     token is not an unsigned integer literal.
   */
  @Nullable
   ...
   *
   * @return The signed integer literal if it could be parsed, or <code>null</code> if the current
   *     token is not an signed integer literal.
   */
  @Nullable
  Long parseSignedIntegerLiteralIf();

  /**
   * Parse a {@link DataType} expression or fail if the current expression is not a data type.
   *
  ...
  /**
   * Parse a {@link Field} expression or fail if the current expression is not a field.
   *
  ...
  /**
   * Parse a {@link SortField} expression or fail if the current expression is not a sort field.
   *
  ...
  /**
   * Parse a {@link Condition} expression or fail if the current expression is not a condition.
   *
  ...
  /**
   * Parse a {@link Table} expression or fail if the current expression is not a table.
   *
