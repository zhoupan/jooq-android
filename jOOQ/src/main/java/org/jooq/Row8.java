 ...
 * @author Lukas Eder
 */
public interface Row8<T1, T2, T3, T4, T5, T6, T7, T8>
    extends Row, SelectField<Record8<T1, T2, T3, T4, T5, T6, T7, T8>> {

  // ------------------------------------------------------------------------
  // Mapping convenience methods
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record8} to custom type {@link RecordMapper} that
   * can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING</code>
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function8)}, this method attempts to work
  ...
  @Support
  Condition compare(
      Comparator comparator, Select<? extends Record8<T1, T2, T3, T4, T5, T6, T7, T8>> select);
  ...
  @NotNull
  @Support
  BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> between(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @Support
  BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> between(
      Row8<T1, T2, T3, T4, T5, T6, T7, T8> minValue);
  ...
  @Support
  BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> between(
      Record8<T1, T2, T3, T4, T5, T6, T7, T8> minValue);
  ...
  @Support
  Condition between(
      Row8<T1, T2, T3, T4, T5, T6, T7, T8> minValue, Row8<T1, T2, T3, T4, T5, T6, T7, T8> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> betweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> notBetween(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep8<T1, T2, T3, T4, T5, T6, T7, T8> notBetweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
