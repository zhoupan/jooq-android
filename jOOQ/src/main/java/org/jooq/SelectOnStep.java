...
public interface SelectOnStep<R extends Record> {
  ...
  /**
   * Join the previous table on a non-ambiguous foreign key relationship between the two joined
   * tables.
   *
   * <p>See {@link TableOnStep#onKey(ForeignKey)} for examples.
   *
  ...
  /**
   * Join the previous table with the <code>USING(column [, column...])</code> syntax.
   *
