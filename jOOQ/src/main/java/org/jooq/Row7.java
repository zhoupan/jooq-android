 ...
 * @author Lukas Eder
 */
public interface Row7<T1, T2, T3, T4, T5, T6, T7>
    extends Row, SelectField<Record7<T1, T2, T3, T4, T5, T6, T7>> {

  // ------------------------------------------------------------------------
  // Mapping convenience methods
  // ------------------------------------------------------------------------
  /**
   * A convenience method to define a local {@link Record7} to custom type {@link RecordMapper} that
   * can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING</code>
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function7)}, this method attempts to work
  ...
  @Support
  Condition compare(
      Comparator comparator, Select<? extends Record7<T1, T2, T3, T4, T5, T6, T7>> select);
  ...
  @NotNull
  @Support
  BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> between(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @Support
  Condition between(
      Row7<T1, T2, T3, T4, T5, T6, T7> minValue, Row7<T1, T2, T3, T4, T5, T6, T7> maxValue);
  ...
  @Support
  Condition between(
      Record7<T1, T2, T3, T4, T5, T6, T7> minValue, Record7<T1, T2, T3, T4, T5, T6, T7> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> betweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @Support
  BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> betweenSymmetric(
      Row7<T1, T2, T3, T4, T5, T6, T7> minValue);
  ...
  @Support
  BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> betweenSymmetric(
      Record7<T1, T2, T3, T4, T5, T6, T7> minValue);
  ...
  @NotNull
  @Support
  BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> notBetween(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep7<T1, T2, T3, T4, T5, T6, T7> notBetweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
