 ...
 * @author Lukas Eder
 */
public interface InsertValuesStep11<R extends Record, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep11<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> values(
      T1 value1,
      T2 value2,
      T3 value3,
      T4 value4,
  ...
  InsertValuesStep11<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> valuesOfRows(
      Row11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>... values);
  ...
  @Support
  InsertValuesStep11<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> valuesOfRows(
      Collection<? extends Row11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> values);
  ...
  @Support
  @SuppressWarnings("unchecked")
  InsertValuesStep11<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> valuesOfRecords(
      Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>... values);
  ...
  @Support
  InsertValuesStep11<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> valuesOfRecords(
      Collection<? extends Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> values);
  ...
  @CheckReturnValue
  @Support
  InsertOnDuplicateStep<R> select(
