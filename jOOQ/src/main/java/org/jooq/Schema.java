 ...
 * schema is an object that groups a set of objects, where objects can be {@link Table}, {@link
 * Sequence}, {@link Routine} and many other types of objects.
 *
 * <p>If your RDBMS supports schemas, and jOOQ supports using schemas with your RDBMS, then
 * generated schemas references can be used to qualify objects
 *
 ...
 *
 * <p>Database products like {@link SQLDialect#MYSQL} and related dialects, such as {@link
 * SQLDialect#MARIADB} use catalogs ("databases") instead of schemas, and lack schema support. For
 * historic reasons, jOOQ treats MySQL catalogs as schemas and does not support any catalog
 * qualifier in MySQL.
 *
 * <p>Instances can be created using {@link DSL#schema(Name)} and overloads.
 *
 * @author Lukas Eder
 */
public interface Schema extends Named {
  ...
  /**
   * Get a table by its name (case-sensitive) in this schema, or <code>null</code> if no such table
   * exists.
   */
  @Nullable
  ...
  /**
   * Get a table by its qualified or unqualified name in this schema, or <code>null</code> if no
   * such table exists.
   */
  @Nullable
  ...
  /**
   * Get a UDT by its name (case-sensitive) in this schema, or <code>null</code> if no such UDT
   * exists.
   */
  @Nullable
  ...
  /**
   * Get a UDT by its qualified or unqualified name in this schema, or <code>null</code> if no such
   * UDT exists.
   */
  @Nullable
  ...
  /**
   * Get a domain by its name (case-sensitive) in this schema, or <code>null</code> if no such
   * domain exists.
   */
  @Nullable
  ...
  /**
   * Get a domain by its qualified or unqualified name in this schema, or <code>null</code> if no
   * such domain exists.
   */
  @Nullable
  ...
  /**
   * Get a sequence by its name (case-sensitive) in this schema, or <code>null</code> if no such
   * sequence exists.
   */
  @Nullable
  ...
  /**
   * Get a sequence by its qualified or unqualified name in this schema, or <code>null</code> if no
