...
/**
 * The step in the <code>ALTER TABLE</code> DSL used to <code>DROP</code> columns or constraints.
 *
 * <p>
 *
...
public interface AlterTableDropStep extends AlterTableFinalStep {
  ...
  /** Add a <code>CASCADE</code> clause to the <code>ALTER TABLE .. DROP</code> statement. */
  @NotNull
  @CheckReturnValue
  @Support({DERBY, H2, HSQLDB, POSTGRES})
  AlterTableFinalStep cascade();

  /** Add a <code>RESTRICT</code> clause to the <code>ALTER TABLE .. DROP</code> statement. */
  @NotNull
  @CheckReturnValue
