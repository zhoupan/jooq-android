 ...
 * @author Lukas Eder
 */
public interface InsertValuesStep12<
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep12<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> values(
      T1 value1,
      T2 value2,
      T3 value3,
      T4 value4,
  ...
  InsertValuesStep12<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> valuesOfRows(
      Row12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>... values);
  ...
  @Support
  InsertValuesStep12<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> valuesOfRows(
      Collection<? extends Row12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> values);
  ...
  @Support
  @SuppressWarnings("unchecked")
  InsertValuesStep12<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> valuesOfRecords(
      Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>... values);
  ...
  @Support
  InsertValuesStep12<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> valuesOfRecords(
      Collection<? extends Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> values);
