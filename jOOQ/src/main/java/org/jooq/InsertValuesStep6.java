 ...
 * @author Lukas Eder
 */
public interface InsertValuesStep6<R extends Record, T1, T2, T3, T4, T5, T6>
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep6<R, T1, T2, T3, T4, T5, T6> values(
  ...
  @CheckReturnValue
  @Support
  InsertValuesStep6<R, T1, T2, T3, T4, T5, T6> valuesOfRows(
      Collection<? extends Row6<T1, T2, T3, T4, T5, T6>> values);
  ...
  @Support
  @SuppressWarnings("unchecked")
  InsertValuesStep6<R, T1, T2, T3, T4, T5, T6> valuesOfRecords(
      Record6<T1, T2, T3, T4, T5, T6>... values);
  ...
  @Support
  InsertValuesStep6<R, T1, T2, T3, T4, T5, T6> valuesOfRecords(
      Collection<? extends Record6<T1, T2, T3, T4, T5, T6>> values);
