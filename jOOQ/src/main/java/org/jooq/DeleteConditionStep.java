...
public interface DeleteConditionStep<R extends Record> extends DeleteOrderByStep<R> {
  ...
  /**
   * Combine the currently assembled conditions with an EXISTS clause using the {@link Operator#AND}
   * operator
   */
  @NotNull
  @CheckReturnValue
  ...
  /**
   * Combine the currently assembled conditions with a NOT EXISTS clause using the {@link
   * Operator#AND} operator
   */
  @NotNull
  @CheckReturnValue
  ...
  /**
   * Combine the currently assembled conditions with an EXISTS clause using the {@link Operator#OR}
   * operator
   */
  @NotNull
  @CheckReturnValue
