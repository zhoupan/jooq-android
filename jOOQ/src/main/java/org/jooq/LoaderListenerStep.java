 ...
 *
 * <p>The step in constructing the {@link Loader} object where you can add listeners to the loader.
 *
 * <p>
 *
...
public interface LoaderListenerStep<R extends Record> extends LoaderLoadStep<R> {
   ...
   *
   * @deprecated - 3.14.0 - [#4941] - Use {@link #onRowEnd(LoaderRowListener)} instead.
   */
