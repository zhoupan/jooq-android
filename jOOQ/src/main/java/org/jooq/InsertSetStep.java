...
public interface InsertSetStep<R extends Record> {
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3> InsertValuesStep3<R, T1, T2, T3> columns(
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4> InsertValuesStep4<R, T1, T2, T3, T4> columns(
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5> InsertValuesStep5<R, T1, T2, T3, T4, T5> columns(
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5, T6> InsertValuesStep6<R, T1, T2, T3, T4, T5, T6> columns(
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
      Field<T4> field4,
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5, T6, T7> InsertValuesStep7<R, T1, T2, T3, T4, T5, T6, T7> columns(
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
      Field<T4> field4,
  ...
  @CheckReturnValue
  @Support
  <T1, T2, T3, T4, T5, T6, T7, T8> InsertValuesStep8<R, T1, T2, T3, T4, T5, T6, T7, T8> columns(
      Field<T1> field1,
      Field<T2> field2,
      Field<T3> field3,
      Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9>
      InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> columns(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
      InsertValuesStep10<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> columns(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
      InsertValuesStep11<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> columns(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
      InsertValuesStep12<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> columns(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
      InsertValuesStep13<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> columns(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
      InsertValuesStep14<R, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> columns(
          Field<T1> field1,
          Field<T2> field2,
          Field<T3> field3,
          Field<T4> field4,
  ...
  /**
   * Set a <code>null</code> value for a field in the <code>INSERT</code> statement.
   *
   * <p>This method is convenience for calling {@link #set(Field, Object)}, without the necessity of
   * casting the Java <code>null</code> literal to <code>(T)</code>.
   */
  @NotNull
  @CheckReturnValue
  @Support
   ...
   * Set values in the <code>INSERT</code> statement.
   *
   * <p>This is the same as calling {@link #set(Map)} with the argument record treated as a <code>
   * Map&lt;Field&lt;?&gt;, Object&gt;</code>, except that the {@link Record#changed()} flags are
   * taken into consideration in order to update only changed values.
   *
   * @see #set(Map)
   */
  @NotNull
   ...
   * statement.
   *
   * <p>This variant of the <code>INSERT .. SELECT</code> statement does not allow for specifying a
   * subset of the fields inserted into. It will insert into all fields of the table specified in
   * the <code>INTO</code> clause. Use {@link DSLContext#insertInto(Table, Field...)} or {@link
   * DSLContext#insertInto(Table, Collection)} instead, to define a field set for insertion.
   */
  @NotNull
  @CheckReturnValue
  @Support
