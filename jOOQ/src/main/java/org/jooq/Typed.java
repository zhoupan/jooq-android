 ...
 *
 * <p>While there is no requirement for implementations to also implement {@link Named}, a lot of
 * implementations do.
 *
 * @author Lukas Eder
 */
public interface Typed<T> extends QueryPart {
   ...
   *
   * <p>By default, all typed objects reference an identity-converter <code>Converter&lt;T, T&gt;
   * </code>. If an implementation is generated, custom data types may be obtained by a custom
   * {@link Converter} placed on the generated object.
   */
  @NotNull
