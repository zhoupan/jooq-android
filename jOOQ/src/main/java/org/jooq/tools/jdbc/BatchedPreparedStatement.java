 ...
 * A batched statement.
 *
 * <p>This statement doesn't execute immediately, but buffers all bind variables in batch, delaying
 * execution until a new SQL string is encountered. See {@link BatchedConnection} for details.
 *
 * @author Lukas Eder
...
public class BatchedPreparedStatement extends DefaultPreparedStatement {
  ...
  public ResultSet executeQuery() throws SQLException {
    ...
    } else throw new UnsupportedOperationException("Cannot batch result queries");
  }
