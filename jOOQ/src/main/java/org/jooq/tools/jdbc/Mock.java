...
public final class Mock {
  ...
  /** Create a new {@link MockDataProvider} that always returns a single record for all queries. */
  ...
  /** Create a new {@link MockDataProvider} that always returns the same result for all queries. */
  public static final MockDataProvider of(Result<?> result) {
    return of(new MockResult(result.size(), result));
  }

  /**
   * Create a new {@link MockDataProvider} that always returns the same mock results for all
   * queries.
   */
  ...
  /**
   * Create a new {@link MockDataProvider} that always throws the same exception for all queries.
   */
