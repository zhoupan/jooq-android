...
/**
 * A default JDBC CallableStatement implementation delegating all JDBC 4.0 calls to an internal
 * delegate.
 *
 * @author Lukas Eder
 */
public class DefaultCallableStatement extends DefaultPreparedStatement
