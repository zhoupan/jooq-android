 ...
 *
 * <p>This context is passed to {@link MockDataProvider#execute(MockExecuteContext)}, as a context
 * object containing all relevant information about a given query execution.
 *
 * @author Lukas Eder
...
public class MockExecuteContext {
   ...
   * @param sql The SQL statement(s)
   * @param bindings The bind variable(s)
   * @param autoGeneratedKeys The corresponding value from <code>MockStatement</code>
   */
   ...
   * @param sql The SQL statement(s)
   * @param bindings The bind variable(s)
   * @param columnIndexes The corresponding value from <code>MockStatement</code>
   */
   ...
   * @param sql The SQL statement(s)
   * @param bindings The bind variable(s)
   * @param columnNames The corresponding value from <code>MockStatement</code>
   */
   ...
   *
   * @return Whether this execution context is from a "single batch" statement.
   ...
   *
   * @return All batch SQL statements of a "multi batch" statement, or an array of length <code>1
   *     </code> with the single statement.
   */
   ...
   *
   * @return All bind variables of a "single batch" statment, or an array of length <code>1</code>
