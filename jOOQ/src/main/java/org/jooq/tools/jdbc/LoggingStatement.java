...
public class LoggingStatement extends DefaultStatement {
  ...
  public boolean execute(String sql) throws SQLException {
    if (log.isDebugEnabled()) log.debug("execute", sql);
  ...
  public ResultSet executeQuery(String sql) throws SQLException {
    if (log.isDebugEnabled()) log.debug("executeQuery", sql);
  ...
  public int executeUpdate(String sql) throws SQLException {
    if (log.isDebugEnabled()) log.debug("executeUpdate", sql);
  ...
  public void addBatch(String sql) throws SQLException {
    if (log.isDebugEnabled()) log.debug("addBatch", sql);
  ...
  public long executeLargeUpdate(String sql) throws SQLException {
    if (log.isDebugEnabled()) log.debug("executeLargeUpdate", sql);
