 ...
 * A mock statement.
 *
 * <p>This statement can be used to mock any of these:
 *
 * <ul>
 *   <li>{@link Statement}
 *   <li>{@link PreparedStatement}
 *   <li>{@link CallableStatement}
 * </ul>
 *
 * @author Lukas Eder
 * @see MockConnection
...
public class MockStatement extends JDBC41Statement implements CallableStatement {
  ...
  private void ensureBindingsCapacity(int index) {
    ...
    if (b.size() < index) b.addAll(nCopies(index - b.size(), null));
  }
  ...
  private void checkNotClosed() throws SQLException {
    if (isClosed) throw new SQLException("Connection is already closed");
  }

  private boolean checkException() throws SQLException {
    if (result[resultIndex].exception != null) throw result[resultIndex].exception;
    else return true;
  }
  ...
  private boolean execute0(
    ...
    // [#10720] MockConnection must not produce first ResultSet when calling stored procedures with
    // OUT parameters
    if (!outParameterTypes.isEmpty()) resultIndex++;
    ...
    return result != null
        ...
        && (resultIndex > 0 || localAutoGeneratedKeys == NO_GENERATED_KEYS);
  }
  ...
  public int getUpdateCount() throws SQLException {
    ...
    return result != null
            ...
            && (result[resultIndex].data == null
                ...
                // [#8113] The first result may be the generated keys
                || resultIndex == 0 && context.autoGeneratedKeys() == RETURN_GENERATED_KEYS)
  ...
  public void clearParameters() throws SQLException {
    ...
    for (int i = 0; i < b.size(); i++) b.set(i, null);
  }
  ...
  private Record outParameters() throws SQLException {
    if (result == null
        || result.length == 0
        || result[0].data == null
        || result[0].data.size() == 0) throw new SQLException("No OUT Parameters available");
  ...
  public <T> T unwrap(Class<T> iface) throws SQLException {
    ...
    else throw new SQLException("MockStatement does not implement " + iface);
  }
