...
public final class StopWatch {
  ...
  public void splitTrace(String message) {
    if (log.isTraceEnabled()) log.trace(message, splitMessage(0));
  }

  /**
   * Split the time and trace log a message if the split time exceeds a certain threshold and if
  ...
  public void splitDebug(String message) {
    if (log.isDebugEnabled()) log.debug(message, splitMessage(0));
  }

  /**
   * Split the time and debug log a message if the split time exceeds a certain threshold and if
   * trace logging is enabled
   */
  ...
  public void splitInfo(String message) {
    if (log.isInfoEnabled()) log.info(message, splitMessage(0));
  }

  /**
   * Split the time and info log a message if the split time exceeds a certain threshold and if
   * trace logging is enabled
   */
  ...
  /**
   * Split the time and warn log a message if the split time exceeds a certain threshold and if
   * trace logging is enabled
   */
