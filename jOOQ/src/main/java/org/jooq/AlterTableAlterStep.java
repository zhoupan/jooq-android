...
/**
 * The step in the <code>ALTER TABLE</code> DSL used to <code>ALTER</code> columns.
 *
 * <p>
 *
...
public interface AlterTableAlterStep<T> {
   ...
   *
   * <p>This adds or removes <code>NOT NULL</code> constraints on the column if {@link
   * DataType#nullable()} is specified explicitly (not all databases support this).
   */
  @NotNull
  @CheckReturnValue
  @Support({CUBRID, DERBY, FIREBIRD, H2, HSQLDB, MARIADB, MYSQL, POSTGRES})
