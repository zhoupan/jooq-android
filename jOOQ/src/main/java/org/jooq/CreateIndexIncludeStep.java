...
public interface CreateIndexIncludeStep extends CreateIndexWhereStep {
   ...
   *
   * <p>If this is not supported by any given database, then the included columns will simply be put
   * in the index as ordinary columns, making the index a composite index.
   */
  @Support
  @NotNull
  @CheckReturnValue
