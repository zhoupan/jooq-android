...
public interface MergeNotMatchedSetStep<R extends Record> {
  ...
  /**
   * Set values for <code>INSERT</code> in the <code>MERGE</code> statement's <code>WHEN NOT MATCHED
   * </code> clause.
   */
  @NotNull
  @CheckReturnValue
  ...
  /**
   * Set multiple values for <code>INSERT</code> in the <code>MERGE</code> statement's <code>
   * WHEN NOT MATCHED</code> clause.
   *
