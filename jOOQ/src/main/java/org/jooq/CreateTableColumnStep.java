 ...
 * @author Lukas Eder
 */
public interface CreateTableColumnStep
    extends CreateTableAsStep<Record>, CreateTableConstraintStep {

  /**
   * Add a column to the column list of the <code>CREATE TABLE</code> statement.
   *
   * <p>This is the same as calling {@link #column(Field, DataType)} with {@link
  ...
  /**
   * Add several columns to the column list of the <code>CREATE TABLE</code> statement.
   *
   * <p>This is the same as calling {@link #column(Field, DataType)} for each column, with {@link
   * Field#getDataType()} as the argument data type.
   */
  @NotNull
  @CheckReturnValue
   ...
   * Add several columns to the column list of the <code>CREATE TABLE</code> statement.
   *
   * <p>This is the same as calling {@link #column(Field, DataType)} for each column. Lacking an
   * explicit data type, this makes sense only for a <code>CREATE TABLE AS SELECT...</code>
   * statement.
   */
  @NotNull
  @CheckReturnValue
