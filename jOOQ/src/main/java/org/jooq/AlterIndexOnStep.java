...
public interface AlterIndexOnStep extends AlterIndexStep {
   ...
   *
   * <p>{@link SQLDialect#MYSQL}, {@link SQLDialect#MARIADB}, and {@link SQLDialect#SQLSERVER} use
   * table-scoped index names, not schema-scoped names. This means that in these databases, the
   * <code>ON</code> clause is mandatory in order to unambiguously identify an index. In all other
   * databases, the <code>ON</code> clause will simply be ignored for compatibility reasons.
   */
