 ...
 *
 * <p>It essentially contains factory methods for unsigned number wrappers. In future versions, it
 * will also contain some arithmetic methods, handling regular arithmetic and bitwise operations
 *
 * @author Lukas Eder
 */
