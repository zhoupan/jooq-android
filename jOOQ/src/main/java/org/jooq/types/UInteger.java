...
public final class UInteger extends UNumber implements Comparable<UInteger> {
  ...
  /**
   * Unchecked internal constructor. This serves two purposes: first it allows {@link
   * #UInteger(long)} to stay deprecated without warnings and second constructor without unnecessary
   * value checks.
   *
