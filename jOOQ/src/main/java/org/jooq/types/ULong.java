...
public final class ULong extends UNumber implements Comparable<ULong> {
  ...
  private ULong(BigInteger value) throws NumberFormatException {
    ...
    else this.value = value.longValue();
  }
  ...
  public float floatValue() {
    if (value < 0) return ((float) (value & Long.MAX_VALUE)) + Long.MAX_VALUE;
    else return value;
  }

  @Override
  public double doubleValue() {
    if (value < 0) return ((double) (value & Long.MAX_VALUE)) + Long.MAX_VALUE;
    else return value;
  }
  ...
  public String toString() {
    ...
    else return BigInteger.valueOf(value & Long.MAX_VALUE).add(MAX_VALUE_LONG).toString();
  }
