...
/**
 * An implementation for the SQL standard <code>INTERVAL YEAR TO MONTH</code> data type.
 *
 * <p><code>YearToMonth</code> is a {@link Number} whose {@link Number#intValue()} represents the
...
public final class YearToMonth extends Number implements Interval, Comparable<YearToMonth> {
  ...
  public final int hashCode() {
    final int prime = 31;
    int result = 0;
    if (months != 0) result = prime * result + months;
    if (years != 0) result = prime * result + years;
    return result;
  }
  ...
  public final boolean equals(Object obj) {
    ...
    if (getClass() == obj.getClass()) {
      ...
      if (negative != other.negative && intValue() != 0) return false;
      return true;
