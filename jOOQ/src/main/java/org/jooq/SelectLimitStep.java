...
public interface SelectLimitStep<R extends Record> extends SelectForUpdateStep<R> {
   ...
   * statements.
   *
   * <p>This is the same as calling {@link #limit(int, int)} with offset = 0, or calling <code>
   * .limit(numberOfRows).offset(0)</code>
   */
  @NotNull
  @CheckReturnValue
  @Support
  ...
  @CheckReturnValue
  @Support
  SelectLimitPercentAfterOffsetStep<R> limit(
      Param<? extends Number> offset, Param<? extends Number> numberOfRows);
