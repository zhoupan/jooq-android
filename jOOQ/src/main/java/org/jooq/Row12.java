 ...
 * @author Lukas Eder
 */
public interface Row12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
    extends Row, SelectField<Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> {
  ...
  /**
   * A convenience method to define a local {@link Record12} to custom type {@link RecordMapper}
   * that can be used when projecting {@link Row} types in <code>SELECT</code> or <code>RETURNING
   * </code> clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function12)}, this method attempts to work
  ...
  @Support
  Condition compare(
      Comparator comparator, Row12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> row);
   ...
   *
   * @see #equal(Record12)
   * @see #notEqual(Record12)
   * @see #lessThan(Record12)
   * @see #lessOrEqual(Record12)
  ...
  @Support
  Condition compare(
      Comparator comparator, Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> record);
  ...
  Condition compare(
      Comparator comparator,
      QuantifiedSelect<? extends Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>
          select);
  ...
  @NotNull
  @Support
  BetweenAndStep12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> between(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @Support
  BetweenAndStep12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> between(
      Row12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> minValue);
  ...
  @Support
  BetweenAndStep12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> between(
      Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> minValue);
  ...
  @NotNull
  @Support
  BetweenAndStep12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> betweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> notBetween(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @NotNull
  @Support
  BetweenAndStep12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> notBetweenSymmetric(
      T1 minValue1,
      T2 minValue2,
      T3 minValue3,
      T4 minValue4,
  ...
  @Support
  Condition in(
      Result<? extends Record12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> result);
  ...
  @Support
  Condition notIn(
      Collection<? extends Row12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>> rows);
