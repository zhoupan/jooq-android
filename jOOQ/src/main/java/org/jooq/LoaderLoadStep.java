 ...
 *
 * <p>The step in constructing the {@link Loader} object where you can execute the load.
 *
 * <p>
 *
...
public interface LoaderLoadStep<R extends Record> {
  ...
  /**
   * Execute the load. All exceptions are caught and wrapped in the resulting <code>Loader</code>
   * object. They can be accessed using {@link Loader#errors()}
   */
  @NotNull
  @CheckReturnValue
  @Support
