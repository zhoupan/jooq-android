...
public interface Row3<T1, T2, T3> extends Row, SelectField<Record3<T1, T2, T3>> {
   ...
   * clauses.
   *
   * <p>EXPERIMENTAL. Unlike {@link #mapping(Class, Function3)}, this method attempts to work
  ...
  <U> SelectField<U> mapping(
      Class<U> uType, Function3<? super T1, ? super T2, ? super T3, ? extends U> function);
  ...
  @NotNull
  @Support
  BetweenAndStep3<T1, T2, T3> between(
      Field<T1> minValue1, Field<T2> minValue2, Field<T3> minValue3);
  ...
  @NotNull
  @Support
  Condition between(Row3<T1, T2, T3> minValue, Row3<T1, T2, T3> maxValue);
  ...
  @NotNull
  @Support
  Condition between(Record3<T1, T2, T3> minValue, Record3<T1, T2, T3> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep3<T1, T2, T3> betweenSymmetric(
      Field<T1> minValue1, Field<T2> minValue2, Field<T3> minValue3);
  ...
  @NotNull
  @Support
  Condition betweenSymmetric(Row3<T1, T2, T3> minValue, Row3<T1, T2, T3> maxValue);
  ...
  @NotNull
  @Support
  Condition betweenSymmetric(Record3<T1, T2, T3> minValue, Record3<T1, T2, T3> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep3<T1, T2, T3> notBetween(
      Field<T1> minValue1, Field<T2> minValue2, Field<T3> minValue3);
  ...
  @NotNull
  @Support
  Condition notBetween(Row3<T1, T2, T3> minValue, Row3<T1, T2, T3> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetween(Record3<T1, T2, T3> minValue, Record3<T1, T2, T3> maxValue);
  ...
  @NotNull
  @Support
  BetweenAndStep3<T1, T2, T3> notBetweenSymmetric(
      Field<T1> minValue1, Field<T2> minValue2, Field<T3> minValue3);
  ...
  @NotNull
  @Support
  Condition notBetweenSymmetric(Row3<T1, T2, T3> minValue, Row3<T1, T2, T3> maxValue);
  ...
  @NotNull
  @Support
  Condition notBetweenSymmetric(Record3<T1, T2, T3> minValue, Record3<T1, T2, T3> maxValue);
