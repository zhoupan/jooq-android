 ...
 *
 * <p>The wrapper represents JSON {@link #data()} in serialised string form. A <code>
 * CAST(NULL AS JSON)</code> value is represented by a <code>null</code> reference of type {@link
 * JSON}, not as <code>data() == null</code>. This is consistent with jOOQ's general way of
...
public final class JSON implements Serializable {
  ...
  /**
   * Create a new {@link JSON} instance from string data input, or <code>null</code> if the input is
   * <code>null</code>.
   */
  @Nullable
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof JSON) return data.equals(((JSON) obj).data);
    return false;
  }
