...
public class Converters<T, U> extends AbstractConverter<T, U> {
  ...
  @NotNull
  public static <T, X1, U> Converter<T, U> of(
      Converter<T, ? extends X1> c1, Converter<? super X1, U> c2) {
    return new Converters(c1, c2);
  }

  /** Chain three converters. */
  @NotNull
  public static <T, X1, X2, U> Converter<T, U> of(
      Converter<T, ? extends X1> c1,
  ...
  @NotNull
  public static <T, X1, X2, X3, U> Converter<T, U> of(
      Converter<T, ? extends X1> c1,
      Converter<? super X1, ? extends X2> c2,
  ...
  static final <T, U> Function<T, U> nullable(Function<? super T, ? extends U> f) {
    return f instanceof Serializable
        ? (Function<T, U> & Serializable) t -> t == null ? null : f.apply(t)
        : t -> t == null ? null : f.apply(t);
  }
  ...
  /**
   * An unknown type that is used when users do not provide any explicit user type {@link Class}
   * reference e.g. in {@link DataType#asConvertedDataTypeFrom(Function)} or {@link
   * DataType#asConvertedDataTypeTo(Function)}
   */
  @Internal
