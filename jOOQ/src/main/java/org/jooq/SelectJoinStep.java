...
public interface SelectJoinStep<R extends Record> extends SelectWhereStep<R> {
  ...
  /**
   * Convenience method to join a table to the last table added to the <code>FROM</code> clause
   * using {@link Table#join(TableLike, JoinType)}
   *
   * <p>Depending on the <code>JoinType</code>, a subsequent {@link SelectOnStep#on(Condition)} or
   * {@link SelectOnStep#using(Field...)} clause is required. If it is required but omitted, the
   * JOIN clause will be ignored
   */
  @NotNull
  @CheckReturnValue
  @Support
  ...
  /**
   * Convenience method to <code>INNER JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#join(TableLike)}.
   *
  ...
  /**
   * Convenience method to <code>INNER JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#join(String)}.
   *
  ...
  /**
   * Convenience method to <code>INNER JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#join(String, Object...)}.
   *
  ...
  /**
   * Convenience method to <code>INNER JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#join(String, QueryPart...)}.
   *
  ...
  /**
   * Convenience method to <code>INNER JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#join(Name)}.
   *
  ...
  /**
   * Convenience method to <code>CROSS JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#crossJoin(TableLike)}
   *
  ...
  /**
   * Convenience method to <code>CROSS JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#crossJoin(String)}
   *
   * <p>If this syntax is unavailable, it is emulated with a regular <code>INNER JOIN</code>. The
   * following two constructs are equivalent: <code><pre>
   * A cross join B
  ...
  /**
   * Convenience method to <code>CROSS JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#crossJoin(String, Object...)}
   *
   * <p>If this syntax is unavailable, it is emulated with a regular <code>INNER JOIN</code>. The
   * following two constructs are equivalent: <code><pre>
   * A cross join B
  ...
  /**
   * Convenience method to <code>CROSS JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#crossJoin(String, QueryPart...)}
   *
   * <p>If this syntax is unavailable, it is emulated with a regular <code>INNER JOIN</code>. The
   * following two constructs are equivalent: <code><pre>
   * A cross join B
  ...
  /**
   * Convenience method to <code>CROSS JOIN</code> a table to the last table added to the <code>FROM
   * </code> clause using {@link Table#crossJoin(Name)}
   *
   * <p>If this syntax is unavailable, it is emulated with a regular <code>INNER JOIN</code>. The
   * following two constructs are equivalent: <code><pre>
   * A cross join B
  ...
  /**
   * Convenience method to <code>LEFT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#leftOuterJoin(TableLike)}.
   *
  ...
  /**
   * Convenience method to <code>LEFT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#leftOuterJoin(String)}.
   *
  ...
  /**
   * Convenience method to <code>LEFT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#leftOuterJoin(String, Object...)}.
   *
  ...
  /**
   * Convenience method to <code>LEFT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#leftOuterJoin(String, QueryPart...)}.
   *
  ...
  /**
   * Convenience method to <code>LEFT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#leftOuterJoin(Name)}.
   *
  ...
  /**
   * Convenience method to <code>RIGHT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#rightOuterJoin(TableLike)}.
   *
  ...
  /**
   * Convenience method to <code>RIGHT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#rightOuterJoin(String)}.
   *
  ...
  /**
   * Convenience method to <code>RIGHT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#rightOuterJoin(String, Object...)}.
   *
  ...
  /**
   * Convenience method to <code>RIGHT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#rightOuterJoin(String, QueryPart...)}.
   *
  ...
  /**
   * Convenience method to <code>RIGHT OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#rightOuterJoin(Name)}.
   *
  ...
  /**
   * Convenience method to <code>FULL OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#fullOuterJoin(TableLike)}.
   *
  ...
  /**
   * Convenience method to <code>FULL OUTER JOIN</code> a table to the last table added to the
   * <code>FROM</code> clause using {@link Table#fullOuterJoin(String)}.
   *
  ...
  /**
   * Convenience method to <code>FULL OUTER JOIN</code> a tableto the last table added to the <code>
   * FROM</code> clause using {@link Table#fullOuterJoin(String, Object...)}.
   *
  ...
  /**
   * Convenience method to <code>FULL OUTER JOIN</code> a tableto the last table added to the <code>
   * FROM</code> clause using {@link Table#fullOuterJoin(String, QueryPart...)}.
   *
  ...
  /**
   * Convenience method to <code>FULL OUTER JOIN</code> a tableto the last table added to the <code>
   * FROM</code> clause using {@link Table#fullOuterJoin(Name)}.
   *
  ...
  /**
   * Convenience method to <code>NATURAL JOIN</code> a table to the last table added to the <code>
   * FROM</code> clause using {@link Table#naturalJoin(TableLike)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL JOIN</code> a table to the last table added to the <code>
   * FROM</code> clause using {@link Table#naturalJoin(String)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL JOIN</code> a table to the last table added to the <code>
   * FROM</code> clause using {@link Table#naturalJoin(String, Object...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL JOIN</code> a table to the last table added to the <code>
   * FROM</code> clause using {@link Table#naturalJoin(String, QueryPart...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL JOIN</code> a table to the last table added to the <code>
   * FROM</code> clause using {@link Table#naturalJoin(Name)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL LEFT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalLeftOuterJoin(TableLike)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL LEFT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalLeftOuterJoin(String)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL LEFT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalLeftOuterJoin(String, Object...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL LEFT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalLeftOuterJoin(String, QueryPart...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL LEFT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalLeftOuterJoin(Name)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL RIGHT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalRightOuterJoin(TableLike)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL RIGHT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalRightOuterJoin(String)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL RIGHT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalRightOuterJoin(String, Object...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL RIGHT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalRightOuterJoin(String, QueryPart...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL RIGHT OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalRightOuterJoin(Name)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL FULL OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalFullOuterJoin(TableLike)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL FULL OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalFullOuterJoin(String)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL FULL OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalFullOuterJoin(String, Object...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL FULL OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalFullOuterJoin(String, QueryPart...)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
  ...
  /**
   * Convenience method to <code>NATURAL FULL OUTER JOIN</code> a table to the last table added to
   * the <code>FROM</code> clause using {@link Table#naturalFullOuterJoin(Name)}
   *
   * <p>Natural joins are supported by most RDBMS. If they aren't supported, they are emulated if
   * jOOQ has enough information.
   *
