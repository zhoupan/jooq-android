...
/**
 * Represents the metadata for {@code OUT} parameters of the results returned from a stored
 * procedure. Metadata for parameters can be either retrieved by specifying a out parameter name or
 * the out parameter index. Parameter indexes are {@code 0}-based.
 */
public interface OutParametersMetadata {
   ...
   *     {@code getParameterMetadatas().size()})
   */
