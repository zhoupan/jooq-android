...
abstract class Assert {
  ...
  /**
   * Checks that a specified {@link String} is not empty and throws a customized {@link
   * IllegalArgumentException} if it is.
   *
   * @param s the {@link String} to check for emptiness
   * @param message the detail message to be used in the event that an {@link
  ...
  /**
   * Checks that a specified object reference is not {@code null} and throws a customized {@link
   * IllegalArgumentException} if it is.
   *
