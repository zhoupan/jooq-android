...
public final class Parameters {
  ...
  /**
   * Create a {@code NULL IN} parameter using type inference and the given {@link Class type} hint.
   * The actual {@link Type} is inferred during statement execution.
   *
  ...
  /**
   * Create a {@code IN} parameter using the given {@code value}. The actual {@link Type} is
   * inferred during statement execution.
   *
  ...
  /**
   * Create a {@code OUT} parameter using type inference and the given {@link Class type} hint. The
   * actual {@link Type} is inferred during statement execution.
   *
   * @param type the type to be used for type inference.
   * @return the out parameter.
   * @throws IllegalArgumentException if {@code type} is {@code null}.
  ...
  /**
   * Create a {@code NULL IN/OUT} parameter using type inference and the given {@link Class type}
   * hint. The actual {@link Type} is inferred during statement execution.
   *
   * @param type the type to be used for type inference.
   * @return the in/out parameter.
   * @throws IllegalArgumentException if {@code type} is {@code null}.
  ...
  /**
   * Create a {@code IN/OUT} parameter using the given {@code value}. The actual {@link Type} is
   * inferred during statement execution.^
   *
   * @param value the value to be used for type inference.
   * @return the in/out parameter.
  ...
  private static class InOutParameter extends DefaultParameter
      implements Parameter.In, Parameter.Out {
