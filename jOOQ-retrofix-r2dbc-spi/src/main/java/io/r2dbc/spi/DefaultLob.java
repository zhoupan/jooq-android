...
class DefaultLob<T> {
  ...
  private static final AtomicIntegerFieldUpdater<DefaultLob<?>> ATOMIC_DISCARD =
      (AtomicIntegerFieldUpdater)
          AtomicIntegerFieldUpdater.newUpdater(DefaultLob.class, "discarded");

  @SuppressWarnings("unchecked")
  private static final AtomicIntegerFieldUpdater<DefaultLob<?>> ATOMIC_CONSUMED =
      (AtomicIntegerFieldUpdater)
          AtomicIntegerFieldUpdater.newUpdater(DefaultLob.class, "consumed");
