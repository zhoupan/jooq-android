...
/**
 * Base exception thrown when a previously failed operation might be able to succeed if the
 * operation is retried without any intervention by an application-level functionality.
 *
...
public abstract class R2dbcTransientException extends R2dbcException {
   ...
   * Creates a new {@link R2dbcTransientException}.
   *
   * @param reason the reason for the error. Set as the exception's message and retrieved with
   *     {@link #getMessage()}.
   */
   ...
   * @param reason the reason for the error. Set as the exception's message and retrieved with
   *     {@link #getMessage()}.
   * @param sqlState the "SQLState" string, which follows either the XOPEN SQLState conventions or
   *     the SQL:2003 conventions
   */
   ...
   */
  public R2dbcTransientException(
      @Nullable String reason, @Nullable String sqlState, int errorCode) {
   ...
   */
  public R2dbcTransientException(
      @Nullable String reason, @Nullable String sqlState, int errorCode, @Nullable String sql) {
   ...
   */
  public R2dbcTransientException(
      @Nullable String reason, @Nullable String sqlState, @Nullable Throwable cause) {
