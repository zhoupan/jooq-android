...
public class Author extends TableImpl<AuthorRecord> {
  ...
  public final TableField<AuthorRecord, String> LAST_NAME =
      createField(DSL.name("LAST_NAME"), SQLDataType.VARCHAR(50).nullable(false), this, "");

  /** The column <code>FLYWAY_TEST.AUTHOR.DATE_OF_BIRTH</code>. */
  public final TableField<AuthorRecord, LocalDate> DATE_OF_BIRTH =
      createField(DSL.name("DATE_OF_BIRTH"), SQLDataType.LOCALDATE, this, "");

  /** The column <code>FLYWAY_TEST.AUTHOR.YEAR_OF_BIRTH</code>. */
  public final TableField<AuthorRecord, Integer> YEAR_OF_BIRTH =
      createField(DSL.name("YEAR_OF_BIRTH"), SQLDataType.INTEGER, this, "");
