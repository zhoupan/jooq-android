...
/**
 * A fully transactional service class offering various API methods for data manipulation.
 *
 * @author Lukas Eder
 */
@Transactional
public class Service {
   ...
   *
   * <p>All code wrapped by the <code>runnable</code> argument is automatically executed in a
   * transaction.
   */
