...
final class Setup {
                  ...
                  .set(
                      new DefaultExecuteListener() {
                        ...
                        public void start(ExecuteContext ctx) {
                          // Flush all changes from the EntityManager to the database for them to be
                          // visible in jOOQ
                          e.flush();
                          super.start(ctx);
                        }
  ...
  static void data(EntityManager em) {
    ...
    Film meerjungfrauen =
        new Film(Title.of("Meerjungfrauen ticken anders"), german, 89, Year.of(2017));
