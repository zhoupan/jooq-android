...
public class Film {
  ...
  @Column @Embedded public Title title;

  @Column public int length;

  // It is easy to reuse a JPA AttributeConverter by manually generating the relevant Converters in
  // jOOQ.
  // A future version of jOOQ may auto-discover all such JPA AttributeConverters and reuse them in
  // jOOQ as well.
