...
public class TestContainersTest {
  ...
  public static void init() throws SQLException {
    ...
    connection =
        new ContainerDatabaseDriver()
            .connect("jdbc:tc:postgresql:13:///sakila?TC_TMPFS=/testtmpfs:rw", properties);
    ...
    try (Statement s = connection.createStatement()) {
      ...
      s.execute(
          Source.of(TestContainersTest.class.getResourceAsStream("/postgres-sakila-schema.sql"))
              .readString());

      log.info("Inserting data to database");
      s.execute(
          Source.of(
                  TestContainersTest.class.getResourceAsStream("/postgres-sakila-insert-data.sql"))
              .readString());
  ...
  final /* record */ class Film {
    ...
    @Override
    public int hashCode() {
      return java.util.Objects.hash(this.title);
    }

    @Override
    public String toString() {
      return new StringBuilder("Film[").append("title=").append(this.title).append("]").toString();
    }
  }

  final /* record */ class Actor {
    ...
    public boolean equals(Object o) {
      ...
      Actor other = (Actor) o;
      if (!java.util.Objects.equals(this.firstName, other.firstName)) return false;
      if (!java.util.Objects.equals(this.lastName, other.lastName)) return false;
      return true;
    }
    ...
    @Override
    public String toString() {
      return new StringBuilder("Actor[")
          .append("firstName=")
                ...
                ctx.select(
                        ...
                        multiset(
                                select(
                                        ...
                                        multisetAgg(PAYMENT.PAYMENT_DATE, PAYMENT.AMOUNT)
                                            .as("payments"),
    ...
    System.out.println(
        result.formatXML(
            new XMLFormat()
                ...
                .format(true)
                .header(false)
                .recordFormat(COLUMN_NAME_ELEMENTS)));
    System.out.println(
        result.formatJSON(new JSONFormat().format(true).header(false).recordFormat(OBJECT)));
  }

  public static final <T> T println(T t) {
    if (t instanceof Object[]) System.out.println(Arrays.asList(t));
