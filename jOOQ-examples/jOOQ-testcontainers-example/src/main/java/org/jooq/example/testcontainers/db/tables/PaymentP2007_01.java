...
public class PaymentP2007_01 extends TableImpl<PaymentP2007_01Record> {
  ...
  public final TableField<PaymentP2007_01Record, Long> PAYMENT_ID =
      createField(
  ...
  public final TableField<PaymentP2007_01Record, Long> CUSTOMER_ID =
  ...
  public final TableField<PaymentP2007_01Record, Long> STAFF_ID =
  ...
  public final TableField<PaymentP2007_01Record, Long> RENTAL_ID =
      createField(DSL.name("rental_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.payment_p2007_01.amount</code>. */
  public final TableField<PaymentP2007_01Record, BigDecimal> AMOUNT =
  ...
  public final TableField<PaymentP2007_01Record, LocalDateTime> PAYMENT_DATE =
  ...
  public <O extends Record> PaymentP2007_01(
      Table<O> child, ForeignKey<O, PaymentP2007_01Record> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(
        Indexes.IDX_FK_PAYMENT_P2007_01_CUSTOMER_ID, Indexes.IDX_FK_PAYMENT_P2007_01_STAFF_ID);
  }
  ...
  public List<ForeignKey<PaymentP2007_01Record, ?>> getReferences() {
    return Arrays.asList(
        ...
        Keys.PAYMENT_P2007_01__PAYMENT_P2007_01_RENTAL_ID_FKEY);
  }
  ...
  public List<Check<PaymentP2007_01Record>> getChecks() {
    return Arrays.asList(
        Internal.createCheck(
            this,
            DSL.name("payment_p2007_01_payment_date_check"),
            "(((payment_date >= '2007-01-01 00:00:00'::timestamp without time zone) AND (payment_date < '2007-02-01 00:00:00'::timestamp without time zone)))",
            true));
  }
