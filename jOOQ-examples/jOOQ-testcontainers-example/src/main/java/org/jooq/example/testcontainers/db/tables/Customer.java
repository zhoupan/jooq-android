...
public class Customer extends TableImpl<CustomerRecord> {
  ...
  public final TableField<CustomerRecord, Long> CUSTOMER_ID =
      createField(
          DSL.name("customer_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>public.customer.store_id</code>. */
  public final TableField<CustomerRecord, Long> STORE_ID =
  ...
  public final TableField<CustomerRecord, LocalDate> CREATE_DATE =
      createField(
  ...
  public final TableField<CustomerRecord, LocalDateTime> LAST_UPDATE =
      createField(
  ...
  public final TableField<CustomerRecord, Integer> ACTIVE =
  ...
  public List<ForeignKey<CustomerRecord, ?>> getReferences() {
    return Arrays.asList(
        Keys.CUSTOMER__CUSTOMER_STORE_ID_FKEY, Keys.CUSTOMER__CUSTOMER_ADDRESS_ID_FKEY);
  }
  ...
  public Store store() {
    if (_store == null) _store = new Store(this, Keys.CUSTOMER__CUSTOMER_STORE_ID_FKEY);

    return _store;
  }

  public Address address() {
    if (_address == null) _address = new Address(this, Keys.CUSTOMER__CUSTOMER_ADDRESS_ID_FKEY);
