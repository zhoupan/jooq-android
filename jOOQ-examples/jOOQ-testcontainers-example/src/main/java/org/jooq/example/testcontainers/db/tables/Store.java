...
public class Store extends TableImpl<StoreRecord> {
  ...
  public final TableField<StoreRecord, Long> STORE_ID =
      createField(
          DSL.name("store_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>public.store.manager_staff_id</code>. */
  public final TableField<StoreRecord, Long> MANAGER_STAFF_ID =
      createField(DSL.name("manager_staff_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.store.address_id</code>. */
  public final TableField<StoreRecord, Long> ADDRESS_ID =
      createField(DSL.name("address_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.store.last_update</code>. */
  public final TableField<StoreRecord, LocalDateTime> LAST_UPDATE =
      createField(
  ...
  public List<ForeignKey<StoreRecord, ?>> getReferences() {
    return Arrays.asList(
        Keys.STORE__STORE_MANAGER_STAFF_ID_FKEY, Keys.STORE__STORE_ADDRESS_ID_FKEY);
  }
  ...
  public Staff staff() {
    if (_staff == null) _staff = new Staff(this, Keys.STORE__STORE_MANAGER_STAFF_ID_FKEY);

    return _staff;
  }

  public Address address() {
    if (_address == null) _address = new Address(this, Keys.STORE__STORE_ADDRESS_ID_FKEY);
