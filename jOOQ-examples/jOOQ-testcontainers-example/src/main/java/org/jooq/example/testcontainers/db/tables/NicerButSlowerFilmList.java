...
import org.jooq.example.testcontainers.db.tables.records.NicerButSlowerFilmListRecord;
...
public class NicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
  ...
  public final TableField<NicerButSlowerFilmListRecord, Long> FID =
      createField(DSL.name("fid"), SQLDataType.BIGINT, this, "");

  /** The column <code>public.nicer_but_slower_film_list.title</code>. */
  public final TableField<NicerButSlowerFilmListRecord, String> TITLE =
  ...
  public final TableField<NicerButSlowerFilmListRecord, String> DESCRIPTION =
      createField(DSL.name("description"), SQLDataType.CLOB, this, "");

  /** The column <code>public.nicer_but_slower_film_list.category</code>. */
  public final TableField<NicerButSlowerFilmListRecord, String> CATEGORY =
      createField(DSL.name("category"), SQLDataType.VARCHAR(25), this, "");

  /** The column <code>public.nicer_but_slower_film_list.price</code>. */
  public final TableField<NicerButSlowerFilmListRecord, BigDecimal> PRICE =
      createField(DSL.name("price"), SQLDataType.NUMERIC(4, 2), this, "");

  /** The column <code>public.nicer_but_slower_film_list.length</code>. */
  public final TableField<NicerButSlowerFilmListRecord, Short> LENGTH =
      createField(DSL.name("length"), SQLDataType.SMALLINT, this, "");

  /** The column <code>public.nicer_but_slower_film_list.rating</code>. */
  public final TableField<NicerButSlowerFilmListRecord, MpaaRating> RATING =
      createField(
          DSL.name("rating"),
          SQLDataType.VARCHAR.asEnumDataType(
              org.jooq.example.testcontainers.db.enums.MpaaRating.class),
          this,
          "");

  /** The column <code>public.nicer_but_slower_film_list.actors</code>. */
  public final TableField<NicerButSlowerFilmListRecord, String> ACTORS =
      createField(DSL.name("actors"), SQLDataType.CLOB, this, "");
  ...
  private NicerButSlowerFilmList(
      Name alias, Table<NicerButSlowerFilmListRecord> aliased, Field<?>[] parameters) {
    super(
        alias,
        null,
        aliased,
  ...
  public <O extends Record> NicerButSlowerFilmList(
      Table<O> child, ForeignKey<O, NicerButSlowerFilmListRecord> key) {
