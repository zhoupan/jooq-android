...
public class FilmActor extends TableImpl<FilmActorRecord> {
  ...
  public final TableField<FilmActorRecord, Long> ACTOR_ID =
      createField(DSL.name("actor_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.film_actor.film_id</code>. */
  public final TableField<FilmActorRecord, Long> FILM_ID =
      createField(DSL.name("film_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.film_actor.last_update</code>. */
  public final TableField<FilmActorRecord, LocalDateTime> LAST_UPDATE =
      createField(
  ...
  public List<ForeignKey<FilmActorRecord, ?>> getReferences() {
    return Arrays.asList(
        Keys.FILM_ACTOR__FILM_ACTOR_ACTOR_ID_FKEY, Keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY);
  }
  ...
  public Actor actor() {
    if (_actor == null) _actor = new Actor(this, Keys.FILM_ACTOR__FILM_ACTOR_ACTOR_ID_FKEY);

    return _actor;
  }

  public Film film() {
    if (_film == null) _film = new Film(this, Keys.FILM_ACTOR__FILM_ACTOR_FILM_ID_FKEY);
