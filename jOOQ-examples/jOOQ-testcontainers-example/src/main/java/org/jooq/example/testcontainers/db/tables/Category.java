...
public class Category extends TableImpl<CategoryRecord> {
  ...
  public final TableField<CategoryRecord, Long> CATEGORY_ID =
      createField(
          DSL.name("category_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

  /** The column <code>public.category.name</code>. */
  public final TableField<CategoryRecord, String> NAME =
      createField(DSL.name("name"), SQLDataType.VARCHAR(25).nullable(false), this, "");

  /** The column <code>public.category.last_update</code>. */
  public final TableField<CategoryRecord, LocalDateTime> LAST_UPDATE =
      createField(
