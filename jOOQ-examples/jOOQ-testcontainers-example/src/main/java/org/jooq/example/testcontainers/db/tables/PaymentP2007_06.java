...
public class PaymentP2007_06 extends TableImpl<PaymentP2007_06Record> {
  ...
  public final TableField<PaymentP2007_06Record, Long> PAYMENT_ID =
      createField(
  ...
  public final TableField<PaymentP2007_06Record, Long> CUSTOMER_ID =
  ...
  public final TableField<PaymentP2007_06Record, Long> STAFF_ID =
  ...
  public final TableField<PaymentP2007_06Record, Long> RENTAL_ID =
      createField(DSL.name("rental_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.payment_p2007_06.amount</code>. */
  public final TableField<PaymentP2007_06Record, BigDecimal> AMOUNT =
  ...
  public final TableField<PaymentP2007_06Record, LocalDateTime> PAYMENT_DATE =
  ...
  public <O extends Record> PaymentP2007_06(
      Table<O> child, ForeignKey<O, PaymentP2007_06Record> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(
        Indexes.IDX_FK_PAYMENT_P2007_06_CUSTOMER_ID, Indexes.IDX_FK_PAYMENT_P2007_06_STAFF_ID);
  }
  ...
  public List<ForeignKey<PaymentP2007_06Record, ?>> getReferences() {
    return Arrays.asList(
        Keys.PAYMENT_P2007_06__PAYMENT_P2007_06_CUSTOMER_ID_FKEY,
        Keys.PAYMENT_P2007_06__PAYMENT_P2007_06_STAFF_ID_FKEY,
        Keys.PAYMENT_P2007_06__PAYMENT_P2007_06_RENTAL_ID_FKEY);
  }
  ...
  public List<Check<PaymentP2007_06Record>> getChecks() {
    return Arrays.asList(
        Internal.createCheck(
            this,
            DSL.name("payment_p2007_06_payment_date_check"),
            "(((payment_date >= '2007-06-01 00:00:00'::timestamp without time zone) AND (payment_date < '2007-07-01 00:00:00'::timestamp without time zone)))",
            true));
  }
