...
public class Tables {
  ...
  public static FilmInStock FILM_IN_STOCK(Long pFilmId, Long pStoreId) {
    return org.jooq.example.testcontainers.db.tables.FilmInStock.FILM_IN_STOCK.call(
        pFilmId, pStoreId);
  }

  /** Get <code>public.film_in_stock</code> as a table. */
  public static FilmInStock FILM_IN_STOCK(Field<Long> pFilmId, Field<Long> pStoreId) {
    return org.jooq.example.testcontainers.db.tables.FilmInStock.FILM_IN_STOCK.call(
        pFilmId, pStoreId);
  }
  ...
  public static FilmNotInStock FILM_NOT_IN_STOCK(Long pFilmId, Long pStoreId) {
    return org.jooq.example.testcontainers.db.tables.FilmNotInStock.FILM_NOT_IN_STOCK.call(
        pFilmId, pStoreId);
  }

  /** Get <code>public.film_not_in_stock</code> as a table. */
  public static FilmNotInStock FILM_NOT_IN_STOCK(Field<Long> pFilmId, Field<Long> pStoreId) {
    return org.jooq.example.testcontainers.db.tables.FilmNotInStock.FILM_NOT_IN_STOCK.call(
        pFilmId, pStoreId);
  }
  ...
  public static final NicerButSlowerFilmList NICER_BUT_SLOWER_FILM_LIST =
  ...
  public static final SalesByFilmCategory SALES_BY_FILM_CATEGORY =
