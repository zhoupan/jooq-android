...
public class RewardsReport extends TableImpl<RewardsReportRecord> {
  ...
  public final TableField<RewardsReportRecord, Long> CUSTOMER_ID =
      createField(
          DSL.name("customer_id"),
          SQLDataType.BIGINT
              .nullable(false)
              .identity(true)
              .defaultValue(
                  DSL.field("nextval('customer_customer_id_seq'::regclass)", SQLDataType.BIGINT)),
          this,
          "");

  /** The column <code>public.rewards_report.store_id</code>. */
  public final TableField<RewardsReportRecord, Long> STORE_ID =
  ...
  public final TableField<RewardsReportRecord, String> FIRST_NAME =
  ...
  public final TableField<RewardsReportRecord, String> LAST_NAME =
  ...
  public final TableField<RewardsReportRecord, String> EMAIL =
      createField(DSL.name("email"), SQLDataType.VARCHAR(50), this, "");

  /** The column <code>public.rewards_report.address_id</code>. */
  public final TableField<RewardsReportRecord, Long> ADDRESS_ID =
  ...
  public final TableField<RewardsReportRecord, Boolean> ACTIVEBOOL =
      createField(
          DSL.name("activebool"),
  ...
  public final TableField<RewardsReportRecord, LocalDate> CREATE_DATE =
      createField(
          DSL.name("create_date"),
          SQLDataType.LOCALDATE
              .nullable(false)
              .defaultValue(DSL.field("('now'::text)::date", SQLDataType.LOCALDATE)),
          this,
          "");

  /** The column <code>public.rewards_report.last_update</code>. */
  public final TableField<RewardsReportRecord, LocalDateTime> LAST_UPDATE =
      createField(
          DSL.name("last_update"),
          SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)),
          this,
          "");

  /** The column <code>public.rewards_report.active</code>. */
  public final TableField<RewardsReportRecord, Integer> ACTIVE =
      createField(DSL.name("active"), SQLDataType.INTEGER, this, "");

  private RewardsReport(Name alias, Table<RewardsReportRecord> aliased) {
    this(
        alias,
        aliased,
        new Field[] {DSL.val(null, SQLDataType.INTEGER), DSL.val(null, SQLDataType.NUMERIC)});
  }
  ...
  @Override
  public Row10<Long, Long, String, String, String, Long, Boolean, LocalDate, LocalDateTime, Integer>
      fieldsRow() {
  ...
  public RewardsReport call(Integer minMonthlyPurchases, BigDecimal minDollarAmountPurchased) {
    RewardsReport result =
        new RewardsReport(
            DSL.name("rewards_report"),
            null,
            new Field[] {
  ...
  public RewardsReport call(
    ...
    RewardsReport result =
        new RewardsReport(
            DSL.name("rewards_report"),
            null,
            new Field[] {minMonthlyPurchases, minDollarAmountPurchased});
