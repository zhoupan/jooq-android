...
public class Rental extends TableImpl<RentalRecord> {
  ...
  public final TableField<RentalRecord, Long> RENTAL_ID =
      createField(
          DSL.name("rental_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
  ...
  public final TableField<RentalRecord, Long> INVENTORY_ID =
      createField(DSL.name("inventory_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.rental.customer_id</code>. */
  public final TableField<RentalRecord, Long> CUSTOMER_ID =
      createField(DSL.name("customer_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.rental.return_date</code>. */
  public final TableField<RentalRecord, LocalDateTime> RETURN_DATE =
      createField(DSL.name("return_date"), SQLDataType.LOCALDATETIME(6), this, "");

  /** The column <code>public.rental.staff_id</code>. */
  public final TableField<RentalRecord, Long> STAFF_ID =
      createField(DSL.name("staff_id"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.rental.last_update</code>. */
  public final TableField<RentalRecord, LocalDateTime> LAST_UPDATE =
      createField(
  ...
  public List<Index> getIndexes() {
    return Arrays.asList(
        Indexes.IDX_FK_INVENTORY_ID, Indexes.IDX_UNQ_RENTAL_RENTAL_DATE_INVENTORY_ID_CUSTOMER_ID);
  }
  ...
  public List<ForeignKey<RentalRecord, ?>> getReferences() {
    return Arrays.asList(
        ...
        Keys.RENTAL__RENTAL_CUSTOMER_ID_FKEY,
  ...
  public Inventory inventory() {
    if (_inventory == null) _inventory = new Inventory(this, Keys.RENTAL__RENTAL_INVENTORY_ID_FKEY);

    return _inventory;
  }

  public Customer customer() {
    if (_customer == null) _customer = new Customer(this, Keys.RENTAL__RENTAL_CUSTOMER_ID_FKEY);

    return _customer;
  }

  public Staff staff() {
    if (_staff == null) _staff = new Staff(this, Keys.RENTAL__RENTAL_STAFF_ID_FKEY);
