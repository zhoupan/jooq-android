...
public class FilmCategory extends TableImpl<FilmCategoryRecord> {
  ...
  public List<ForeignKey<FilmCategoryRecord, ?>> getReferences() {
    return Arrays.asList(
        Keys.FILM_CATEGORY__FILM_CATEGORY_FILM_ID_FKEY,
        Keys.FILM_CATEGORY__FILM_CATEGORY_CATEGORY_ID_FKEY);
  }
  ...
  public Film film() {
    if (_film == null) _film = new Film(this, Keys.FILM_CATEGORY__FILM_CATEGORY_FILM_ID_FKEY);
