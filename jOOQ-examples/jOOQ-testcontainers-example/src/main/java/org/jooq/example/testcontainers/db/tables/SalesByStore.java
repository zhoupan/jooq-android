...
public class SalesByStore extends TableImpl<SalesByStoreRecord> {
  ...
  public final TableField<SalesByStoreRecord, String> STORE =
      createField(DSL.name("store"), SQLDataType.CLOB, this, "");

  /** The column <code>public.sales_by_store.manager</code>. */
  public final TableField<SalesByStoreRecord, String> MANAGER =
      createField(DSL.name("manager"), SQLDataType.CLOB, this, "");

  /** The column <code>public.sales_by_store.total_sales</code>. */
  public final TableField<SalesByStoreRecord, BigDecimal> TOTAL_SALES =
