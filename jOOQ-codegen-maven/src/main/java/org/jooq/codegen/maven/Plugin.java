...
public class Plugin extends AbstractMojo {
  ...
  /**
   * An external configuration file that is appended to anything from the Maven configuration, using
   * Maven's <code>combine.children="append"</code> semantics.
   */
  @Parameter(property = "jooq.codegen.configurationFile")
  private String configurationFile;

  /**
   * An external set of configuration files that is appended to anything from the Maven
   * configuration, using Maven's <code>combine.children="append"</code> semantics.
   */
  ...
  /** The jdbc settings. */
  @Parameter private org.jooq.meta.jaxb.Jdbc jdbc;

  /** The generator settings */
  @Parameter private org.jooq.meta.jaxb.Generator generator;
  ...
  public void execute() throws MojoExecutionException {
    ...
    else if (configurationFile != null) read(configurationFile);
      ...
      getLog()
          .error(
              "\n"
                  ...
                  + "- Your pom.xml's <configuration> contains invalid XML according to "
                  + XSD_CODEGEN
                  + "\n"
    ...
    try {
      ...
      if (generator.getTarget() == null) generator.setTarget(new Target());
  ...
  private void read(String file) {
    ...
    if (!f.isAbsolute()) f = new File(project.getBasedir(), file);
