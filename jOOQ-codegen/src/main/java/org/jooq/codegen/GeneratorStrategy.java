...
public interface GeneratorStrategy {
  ...
  /**
   * This is applied to definitions that can result in reference static and instance members. For
   * instance, the reference instance of a {@link TableDefinition} is a java identifier
   *
  ...
  /**
   * This is applied to definitions that can result in setters of a container. For example, the
   * definition could be a {@link ColumnDefinition}, the container a {@link TableDefinition}. Then
   * this would apply to records and POJOs. Also, the definition could be an {@link
   * AttributeDefinition} and the container a {@link UDTDefinition}
   *
   * <p>This is the same as calling <code>getJavaSetterName(definition, Mode.DEFAULT)</code>
   *
   * @return The Java setter method name representing this object, e.g. [setMyTable]
   */
  ...
  /**
   * This is applied to definitions that can result in getters of a container. For example, the
   * definition could be a {@link ColumnDefinition}, the container a {@link TableDefinition}. Then
   * this would apply to records and POJOs. Also, the definition could be an {@link
   * AttributeDefinition} and the container a {@link UDTDefinition}
   *
   * <p>This is the same as calling <code>getJavaGetterName(definition, Mode.DEFAULT)</code>
   *
   * @return The Java getter method name representing this object, e.g. [getMyTable]
   */
  ...
  /**
   * This is applied to definitions that can result in methods. For example, the definition could be
   * a {@link RoutineDefinition}
   *
   * <p>This is the same as calling <code>getJavaMethodName(definition, Mode.DEFAULT)</code>
   *
  ...
  /**
   * @return The super class name of the global references class for a given definition type, e.g.
   *     [com.example.AbstractPojo]. If this returns <code>null</code> or an empty string, then no
   *     super class is extended.
   */
  String getGlobalReferencesJavaClassExtends(
      Definition container, Class<? extends Definition> objectType);

  /**
   * This is the same as calling <code>getJavaClassExtends(definition, Mode.DEFAULT)</code>
   *
   * @return The super class name of the Java class representing this object, e.g.
   *     [com.example.AbstractPojo]. If this returns <code>null</code> or an empty string, then no
   *     super class is extended.
   */
  ...
  /**
   * @return The implemented interface names of the global references class for a given definition
   *     type, e.g. [com.example.Pojo]. If this returns <code>null</code> or an empty list, then no
   *     interfaces are implemented.
   */
  List<String> getGlobalReferencesJavaClassImplements(
      Definition container, Class<? extends Definition> objectType);

  /**
   * This is the same as calling <code>getJavaClassImplements(definition, Mode.DEFAULT)</code>
   *
   * @return The implemented interface names of the Java class name representing this object, e.g.
   *     [com.example.Pojo] If this returns <code>null</code> or an empty list, then no interfaces
   *     are implemented.
   */
  ...
  /**
   * @return The Java class name of the global references class for a given definition type, e.g.
   *     [MyTableSuffix]
   */
  String getGlobalReferencesJavaClassName(
      Definition container, Class<? extends Definition> objectType);

  /**
   * This is the same as calling <code>getJavaClassName(definition, Mode.DEFAULT)</code>
   *
  ...
  /**
   * @return The Java package name of the global references class for a given definition type, e.g.
   *     [org.jooq.generated]
   */
  String getGlobalReferencesJavaPackageName(
      Definition container, Class<? extends Definition> objectType);

  /**
   * This is the same as calling <code>getJavaPackageName(definition, Mode.DEFAULT)</code>
   *
  ...
  /**
   * The "java member name" is applied where a definition is used as a member (for POJOs) or as a
   * method argument (for setters). Example definitions are
   *
   * <ul>
   *   <li>{@link ColumnDefinition}
   *   <li>{@link ParameterDefinition}
   *   <li>{@link AttributeDefinition}
   * </ul>
   *
   * This is the same as calling <code>getJavaMemberName(definition, Mode.DEFAULT)</code>
   *
   * @return The Java class name representing this object, starting with a lower case character,
   *     e.g. [myTable]
   */
  ...
  /**
   * @return The full Java class name of the global references class for a given definition type,
   *     e.g. [org.jooq.generated.MyTable]
   */
  String getGlobalReferencesFullJavaClassName(
      Definition container, Class<? extends Definition> objectType);
  ...
  /**
   * This is the same as calling <code>getFullJavaClassName(definition, Mode.DEFAULT)</code>
   *
  ...
  /**
   * @return The Java class file name of the global references class for a given definition type,
   *     e.g. [MyTable.java]
   */
  ...
  /**
   * @return The Java class file name of the global references class for a given definition type,
   *     e.g. [C:\org\jooq\generated\MyTable.java]
   */
  ...
  /**
   * @return The Java class file header of the global references class for a given definition type,
   *     e.g. <code><pre>
   * This file is generated by jOOQ.
   * </pre></code>
   */
  String getGlobalReferencesFileHeader(
      Definition container, Class<? extends Definition> objectType);
  ...
  /**
   * @return The overload suffix to be applied when generating overloaded routine artefacts, e.g.
  ...
  enum Mode {
    ...
    /**
     * The record mode. This is used when a {@link TableDefinition} or a {@link UDTDefinition}'s
     * record class is being rendered.
     */
    RECORD,
