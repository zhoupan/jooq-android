...
public interface Generator {
  ...
  /**
   * Whether implicit join path constructors on generated tables for outgoing foreign key
   * relationships (to-one relationships) should be generated.
   */
  ...
  /** Whether the {@link javax.annotation.processing.Generated} annotation should be generated. */
   ...
   *
   * <p>In SQL and by consequence in jOOQ, non-nullability cannot be guaranteed statically. There
   * may still be some cases (e.g. after unions, outer joins, etc.) where a normally non-null value
   ...
   *
   * <p>Unlike {@link #generateNonnullAnnotation()}, nullability can be guaranteed as in SQL, and by
   * consequence in jOOQ, every column expression can be made nullable using some SQL operation.
   */
  ...
  void setGenerateConstructorPropertiesAnnotationOnPojos(
  ...
  void setGenerateConstructorPropertiesAnnotationOnRecords(
  ...
  /**
   * Whether enums generated as Scala sealed traits by the {@link ScalaGenerator}.
   *
   * @deprecated - [#10998] - 3.15.0 - This is maintained for backwards compatibility only. Do not
   *     reuse this feature, if possible
   */
  @Deprecated
  ...
  /**
   * Whether DAOs should be annotated with useful spring annotations such as <code>@Repository
   * </code> or <code>@Autowired</code>
   */
  ...
  /**
   * Whether kotlin mutable properties should be annotated with <code>set:JvmName</code> as a
   * workaround for problems occurring when kotlin produces <code>setX()</code> instead of <code>
   * setIsX()</code> setters for an <code>isX</code> property.
   */
   ...
   * setIsX()</code> setters for an <code>isX</code> property.
   */
  void setGenerateKotlinSetterJvmNameAnnotationsOnIsPrefix(
      boolean generateKotlinSetterJvmNameAnnotationsOnIsPrefix);
   ...
   * A regular expression matching all the types in generated code that should be fully qualified.
   *
   * @deprecated - Use {@link #setGenerateFullyQualifiedTypes(String)} instead.
   */
  @Deprecated
  ...
  /**
   * Whether the target package should be cleaned to contain only generated code after a generation
   * run.
   */
