...
/**
 * A generator strategy that prefixes / suffixes class names and other artefacts with values taken
 * from JVM parameters.
 *
 * <p>An example variant of the default naming strategy {@link DefaultGeneratorStrategy} adding the
 * prefix and suffixes to generated class names (e.g. to avoid name clashes with existing JPA
 * entities and such).
 *
 * <p>The following JVM parameters are supported:
 *
 * <ul>
 *   <li><code>org.jooq.meta.example.java-identifier-prefix</code>
 *   <li><code>org.jooq.meta.example.java-identifier-suffix</code>
 *   <li><code>org.jooq.meta.example.java-getter-name-prefix</code>
 *   <li><code>org.jooq.meta.example.java-getter-name-suffix</code>
 *   <li><code>org.jooq.meta.example.java-setter-name-prefix</code>
 *   <li><code>org.jooq.meta.example.java-setter-name-suffix</code>
 *   <li><code>org.jooq.meta.example.java-method-name-prefix</code>
 *   <li><code>org.jooq.meta.example.java-method-name-suffix</code>
 *   <li><code>org.jooq.meta.example.java-class-name-prefix</code>
 *   <li><code>org.jooq.meta.example.java-class-name-suffix</code>
 *   <li><code>org.jooq.meta.example.java-package-name-prefix</code>
 *   <li><code>org.jooq.meta.example.java-package-name-suffix</code>
 *   <li><code>org.jooq.meta.example.java-member-name-prefix</code>
 *   <li><code>org.jooq.meta.example.java-member-name-suffix</code>
