...
public abstract class AbstractPostgresBinding<T, U> extends AbstractBinding<T, U> {
   ...
   *
   * <p>Most PostgreSQL vendor specific data types need to be cast explicitly, e.g. <code>?::hstore
   * </code>. Implementations should provide this cast type, e.g. <code>hstore</code>.
   */
  ...
  protected void sqlInline(BindingSQLContext<U> ctx) throws SQLException {
    ...
    if (castType != null) ctx.render().sql("::").sql(castType);
  }
