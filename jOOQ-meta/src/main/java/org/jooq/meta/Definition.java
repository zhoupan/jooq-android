...
public interface Definition {
  ...
  /**
   * @return The schema of this object or <code>null</code> if this object is a {@link
   *     CatalogDefinition}.
   */
  SchemaDefinition getSchema();

  /**
   * @return The package of this object or <code>null</code> if this object is not contained in a
   *     package.
   */
  ...
  /**
   * @return The name of this object, e.g. [my_table], as defined for the target database. This may
   *     differ from the input name if schema / table rewriting is applied.
   */
  ...
  /**
   * @return A path of definitions for this definition, e.g. <code>
   *     [schema].[package].[routine].[parameter]</code>
   */
  ...
  /**
   * @return The source code of this object, if applicable, or <code>null</code>, if no such source
   *     code is available.
   */
  String getSource();
}
