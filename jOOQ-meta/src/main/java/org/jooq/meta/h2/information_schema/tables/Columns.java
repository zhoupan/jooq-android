...
public class Columns extends TableImpl<Record> {
  ...
  public final TableField<Record, String> INTERVAL_TYPE =
      createField(DSL.name("INTERVAL_TYPE"), SQLDataType.VARCHAR(2147483647), this, "");
