...
public class Tables extends TableImpl<Record> {
  ...
  public final TableField<Record, String> TABLE_TYPE =
      createField(DSL.name("TABLE_TYPE"), SQLDataType.VARCHAR(2147483647), this, "");

  /** The column <code>INFORMATION_SCHEMA.TABLES.STORAGE_TYPE</code>. */
  public final TableField<Record, String> STORAGE_TYPE =
      createField(DSL.name("STORAGE_TYPE"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public final TableField<Record, Long> LAST_MODIFICATION =
      createField(DSL.name("LAST_MODIFICATION"), SQLDataType.BIGINT, this, "");
  ...
  public final TableField<Record, String> TABLE_CLASS =
      createField(DSL.name("TABLE_CLASS"), SQLDataType.VARCHAR(2147483647), this, "");

  /** The column <code>INFORMATION_SCHEMA.TABLES.ROW_COUNT_ESTIMATE</code>. */
  public final TableField<Record, Long> ROW_COUNT_ESTIMATE =
      createField(DSL.name("ROW_COUNT_ESTIMATE"), SQLDataType.BIGINT, this, "");
