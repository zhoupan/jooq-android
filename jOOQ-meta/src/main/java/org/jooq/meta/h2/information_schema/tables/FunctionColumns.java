...
public class FunctionColumns extends TableImpl<Record> {
  ...
  public final TableField<Record, Integer> PRECISION =
      createField(DSL.name("PRECISION"), SQLDataType.INTEGER, this, "");

  /** The column <code>INFORMATION_SCHEMA.FUNCTION_COLUMNS.SCALE</code>. */
  public final TableField<Record, Short> SCALE =
      createField(DSL.name("SCALE"), SQLDataType.SMALLINT, this, "");

  /** The column <code>INFORMATION_SCHEMA.FUNCTION_COLUMNS.RADIX</code>. */
  public final TableField<Record, Short> RADIX =
      createField(DSL.name("RADIX"), SQLDataType.SMALLINT, this, "");

  /** The column <code>INFORMATION_SCHEMA.FUNCTION_COLUMNS.NULLABLE</code>. */
  public final TableField<Record, Short> NULLABLE =
      createField(DSL.name("NULLABLE"), SQLDataType.SMALLINT, this, "");

  /** The column <code>INFORMATION_SCHEMA.FUNCTION_COLUMNS.COLUMN_TYPE</code>. */
  public final TableField<Record, Short> COLUMN_TYPE =
      createField(DSL.name("COLUMN_TYPE"), SQLDataType.SMALLINT, this, "");
