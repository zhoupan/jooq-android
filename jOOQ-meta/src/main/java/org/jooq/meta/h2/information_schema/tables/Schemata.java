...
public class Schemata extends TableImpl<Record> {
  ...
  public final TableField<Record, String> DEFAULT_CHARACTER_SET_NAME =
      createField(
          DSL.name("DEFAULT_CHARACTER_SET_NAME"), SQLDataType.VARCHAR(2147483647), this, "");

  /** The column <code>INFORMATION_SCHEMA.SCHEMATA.DEFAULT_COLLATION_NAME</code>. */
  public final TableField<Record, String> DEFAULT_COLLATION_NAME =
      createField(DSL.name("DEFAULT_COLLATION_NAME"), SQLDataType.VARCHAR(2147483647), this, "");

  /** The column <code>INFORMATION_SCHEMA.SCHEMATA.IS_DEFAULT</code>. */
  public final TableField<Record, Boolean> IS_DEFAULT =
      createField(DSL.name("IS_DEFAULT"), SQLDataType.BOOLEAN, this, "");
