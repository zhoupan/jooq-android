...
public class Sequences extends TableImpl<Record> {
  ...
  public final TableField<Record, String> SEQUENCE_CATALOG =
      createField(DSL.name("SEQUENCE_CATALOG"), SQLDataType.VARCHAR(2147483647), this, "");

  /** The column <code>INFORMATION_SCHEMA.SEQUENCES.SEQUENCE_SCHEMA</code>. */
  public final TableField<Record, String> SEQUENCE_SCHEMA =
      createField(DSL.name("SEQUENCE_SCHEMA"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public final TableField<Record, Long> CURRENT_VALUE =
      createField(DSL.name("CURRENT_VALUE"), SQLDataType.BIGINT, this, "");

  /** The column <code>INFORMATION_SCHEMA.SEQUENCES.INCREMENT</code>. */
  public final TableField<Record, Long> INCREMENT =
      createField(DSL.name("INCREMENT"), SQLDataType.BIGINT, this, "");
