...
public class CrossReferences extends TableImpl<Record> {
  ...
  public final TableField<Record, String> PKTABLE_CATALOG =
      createField(DSL.name("PKTABLE_CATALOG"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public final TableField<Record, String> PKTABLE_SCHEMA =
      createField(DSL.name("PKTABLE_SCHEMA"), SQLDataType.VARCHAR(2147483647), this, "");

  /** The column <code>INFORMATION_SCHEMA.CROSS_REFERENCES.PKTABLE_NAME</code>. */
  public final TableField<Record, String> PKTABLE_NAME =
      createField(DSL.name("PKTABLE_NAME"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public final TableField<Record, String> PKCOLUMN_NAME =
      createField(DSL.name("PKCOLUMN_NAME"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public final TableField<Record, String> FKTABLE_CATALOG =
      createField(DSL.name("FKTABLE_CATALOG"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public final TableField<Record, String> FKTABLE_SCHEMA =
      createField(DSL.name("FKTABLE_SCHEMA"), SQLDataType.VARCHAR(2147483647), this, "");

  /** The column <code>INFORMATION_SCHEMA.CROSS_REFERENCES.FKTABLE_NAME</code>. */
  public final TableField<Record, String> FKTABLE_NAME =
      createField(DSL.name("FKTABLE_NAME"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public final TableField<Record, String> FKCOLUMN_NAME =
      createField(DSL.name("FKCOLUMN_NAME"), SQLDataType.VARCHAR(2147483647), this, "");
  ...
  public List<ForeignKey<Record, ?>> getReferences() {
    return Arrays.<ForeignKey<Record, ?>>asList(
        Keys.REFERENCED_CONSTRAINT, Keys.REFERENCING_CONSTRAINT);
  }
