...
public class MatchersCatalogType implements Serializable, XMLAppendable {
  ...
  /**
   * This catalog matcher applies to all unqualified or qualified catalog names matched by this
   * expression. If left empty, this matcher applies to all catalogs.
   */
  ...
  /**
   * This string provides additional interfaces that a generated {@link org.jooq.Catalog} should
   * implement.
   */
