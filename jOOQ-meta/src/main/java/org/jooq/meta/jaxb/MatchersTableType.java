...
public class MatchersTableType implements Serializable, XMLAppendable {
  ...
  /**
   * This table matcher applies to all unqualified or qualified table names matched by this
   * expression. If left empty, this matcher applies to all tables.
   */
  ...
  /**
   * This string provides additional interfaces that a generated {@link org.jooq.Table} should
   * implement.
   */
  ...
  /**
   * This string provides additional interfaces that a generated {@link org.jooq.TableRecord} should
   * implement.
   */
  ...
  /**
   * This rule influences the naming of the generated interface implemented by the {@link
   * org.jooq.TableRecord} and/or the POJO.
   */
  ...
  /**
   * This string provides additional interfaces that a generated interface (which is implemented by
   * the {@link org.jooq.TableRecord} and/or POJO) should implement.
   */
  ...
  /**
   * This string provides additional interfaces that a generated {@link org.jooq.DAO} should
   * implement.
   */
  ...
  public int hashCode() {
    ...
    result =
        ((prime * result) + ((interfaceImplements == null) ? 0 : interfaceImplements.hashCode()));
