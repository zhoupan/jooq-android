...
public class MatchersEmbeddableType implements Serializable, XMLAppendable {
  ...
  /**
   * This table matcher applies to all unqualified or qualified embeddable names matched by this
   * expression. If left empty, this matcher applies to all embeddables.
   */
  ...
  /**
   * This string provides additional interfaces that a generated {@link org.jooq.EmbeddableRecord}
   * should implement.
   */
   ...
   * org.jooq.EmbeddableRecord} and/or the POJO.
   */
   ...
   * the {@link org.jooq.EmbeddableRecord} and/or POJO) should implement.
   */
