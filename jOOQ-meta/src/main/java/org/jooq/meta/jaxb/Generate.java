...
public class Generate implements Serializable, XMLAppendable {
  ...
  /**
   * Primary key / foreign key relations should be generated and used. This is a prerequisite for
  ...
  /**
   * Generate implicit join path constructors on generated tables for outgoing foreign key
   * relationships (to-one relationships)
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Generate deprecation annotations on references to unknown data types. This helps identifying
   * columns, attributes, and parameters, which may not be usable through jOOQ API, without adding
   * custom data type bindings to them.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Generate the {@link javax.annotation.processing.Generated} annotation to indicate jOOQ version
  ...
  /**
   * Whether the {@link javax.annotation.processing.Generated} annotation should include the <code>
   * date</code> attribute.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Whether non-nullable items should be annotated with the annotation type specified in {@link
   * #nonnullAnnotationType}. In SQL and by consequence in jOOQ, non-nullability cannot be
   * guaranteed statically. There may still be some cases (e.g. after unions, outer joins, etc.)
   * where a normally non-null value turns out to be null!
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Specify the qualified annotation name for all non-nullable items in generated code, defaulting
   * to the JSR-305 {@link javax.annotation.Nonnull} type.
   */
  ...
  /**
   * Whether nullable items should be annotated with the annotation type specified in {@link
   * #nullableAnnotationType}. Unlike {@link #nonnullAnnotation}, nullability can be guaranteed as
   * in SQL, and by consequence in jOOQ, every column expression can be made nullable using some SQL
   * operation.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Specify the qualified annotation name for all nullable items in generated code, defaulting to
   * the JSR-305 {@link javax.annotation.Nullable} type.
   */
  ...
  /**
   * Generate the {@link java.beans.ConstructorProperties} annotation on generated POJOs and/or
   * records.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Generate the {@link java.beans.ConstructorProperties} annotation on generated POJOs (defaults
   * to <code>true</code> if {@link #constructorPropertiesAnnotation} is active).
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Generate the {@link java.beans.ConstructorProperties} annotation on generated records (defaults
   * to <code>true</code> if {@link #constructorPropertiesAnnotation} is active).
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Version of JPA specification is to be used to generate version-specific annotations. If it is
   * omitted, the latest version is used by default.
   */
  ...
  /**
   * Workaround for Kotlin generating <code>setX()</code> setters instead of <code>setIsX()</code>
   * in byte code for mutable properties called <code>isX</code>.
   *
   * @return possible object is {@link Boolean }
   */
   ...
   * records, POJOs, interfaces.
   *
   * <p>If this flag is set to false, then:
   *
   * <p>
   *
   * <ul>
   *   <li>Column name : X_INDEX
   *   <li>Attribute name: xIndex
   *   <li>Getter name : getXIndex()
   *   <li>Setter name : setXIndex()
   * </ul>
   *
   * <p>If this flag is set to true, then:
   *
   * <ul>
   *   <li>Getter name : getxIndex()
   *   <li>Setter name : setxIndex()
   * </ul>
   *
   * <p>Custom GeneratorStrategy implementations are unaffected
   *
   * @return possible object is {@link Boolean }
   */
   ...
   *
   * <p>This may lead to compilation warnings in current Java versions.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * The maximum number of members per initialiser, to prevent reaching the 64kb byte code per
   * method limit in generated code.
   */
   ...
   *
   * <p>This can be useful if you have a database object that generates a String class, and you want
   * to avoid naming clashes with the java.lang package by specifying <code>java\.lang\..*</code>
   */
  ...
  /**
   * Whether empty catalogs (e.g. empty because of <excludes/> configurations) should still be
   * generated.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * Whether empty schemas (e.g. empty because of <excludes/> configurations) should still be
   * generated.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * A flag indicating whether Java 8's java.time types should be used by the source code generator,
   * rather than JDBC's java.sql types.
   *
   * <p>This flag is ignored in the commercial Java 6 distribution of jOOQ 3.9+
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * The indentation characters to be used in generated code. If unspecified, an idiomatic default
   * indentation of the language will be used (4 spaces in Java, 2 spaces in Scala). Whitespace
   * characters can be used, e.g. \t
   */
  ...
  /**
   * The print margin to apply to generated Javadoc and other block comments, for automatic line
   * wrapping. The feature is turned off if the print margin is <code>0</code>.
   */
  ...
  public final void appendTo(XMLBuilder builder) {
    ...
    builder.append(
        "constructorPropertiesAnnotationOnPojos", constructorPropertiesAnnotationOnPojos);
    builder.append(
        "constructorPropertiesAnnotationOnRecords", constructorPropertiesAnnotationOnRecords);
    ...
    builder.append(
        "kotlinSetterJvmNameAnnotationsOnIsPrefix", kotlinSetterJvmNameAnnotationsOnIsPrefix);
  ...
  public boolean equals(Object that) {
    ...
    if (constructorPropertiesAnnotationOnPojos == null) {
      ...
      if (!constructorPropertiesAnnotationOnPojos.equals(
          other.constructorPropertiesAnnotationOnPojos)) {
        return false;
      }
    }
    if (constructorPropertiesAnnotationOnRecords == null) {
      ...
      if (!constructorPropertiesAnnotationOnRecords.equals(
          other.constructorPropertiesAnnotationOnRecords)) {
        return false;
      }
    }
    if (routines == null) {
    ...
    if (kotlinSetterJvmNameAnnotationsOnIsPrefix == null) {
      ...
      if (!kotlinSetterJvmNameAnnotationsOnIsPrefix.equals(
          other.kotlinSetterJvmNameAnnotationsOnIsPrefix)) {
        return false;
      }
    }
  ...
  public int hashCode() {
    ...
    result =
        ((prime * result)
            + ((implicitJoinPathsToOne == null) ? 0 : implicitJoinPathsToOne.hashCode()));
    result = ((prime * result) + ((deprecated == null) ? 0 : deprecated.hashCode()));
    result =
        ((prime * result)
            + ((deprecationOnUnknownTypes == null) ? 0 : deprecationOnUnknownTypes.hashCode()));
    result = ((prime * result) + ((instanceFields == null) ? 0 : instanceFields.hashCode()));
    result =
        ((prime * result) + ((visibilityModifier == null) ? 0 : visibilityModifier.hashCode()));
    result =
        ((prime * result) + ((generatedAnnotation == null) ? 0 : generatedAnnotation.hashCode()));
    result =
        ((prime * result)
            + ((generatedAnnotationType == null) ? 0 : generatedAnnotationType.hashCode()));
    result =
        ((prime * result)
            + ((generatedAnnotationDate == null) ? 0 : generatedAnnotationDate.hashCode()));
    result = ((prime * result) + ((nonnullAnnotation == null) ? 0 : nonnullAnnotation.hashCode()));
    result =
        ((prime * result)
            + ((nonnullAnnotationType == null) ? 0 : nonnullAnnotationType.hashCode()));
    result =
        ((prime * result) + ((nullableAnnotation == null) ? 0 : nullableAnnotation.hashCode()));
    result =
        ((prime * result)
            + ((nullableAnnotationType == null) ? 0 : nullableAnnotationType.hashCode()));
    result =
        ((prime * result)
            + ((constructorPropertiesAnnotation == null)
                ? 0
                : constructorPropertiesAnnotation.hashCode()));
    result =
        ((prime * result)
            + ((constructorPropertiesAnnotationOnPojos == null)
                ? 0
                : constructorPropertiesAnnotationOnPojos.hashCode()));
    result =
        ((prime * result)
            + ((constructorPropertiesAnnotationOnRecords == null)
                ? 0
                : constructorPropertiesAnnotationOnRecords.hashCode()));
    ...
    result =
        ((prime * result)
            + ((recordsImplementingRecordN == null) ? 0 : recordsImplementingRecordN.hashCode()));
    result =
        ((prime * result)
            + ((enumsAsScalaSealedTraits == null) ? 0 : enumsAsScalaSealedTraits.hashCode()));
    result = ((prime * result) + ((pojos == null) ? 0 : pojos.hashCode()));
    result =
        ((prime * result)
            + ((pojosEqualsAndHashCode == null) ? 0 : pojosEqualsAndHashCode.hashCode()));
    result = ((prime * result) + ((pojosToString == null) ? 0 : pojosToString.hashCode()));
    result =
        ((prime * result)
            + ((pojosAsJavaRecordClasses == null) ? 0 : pojosAsJavaRecordClasses.hashCode()));
    result =
        ((prime * result)
            + ((pojosAsScalaCaseClasses == null) ? 0 : pojosAsScalaCaseClasses.hashCode()));
    result =
        ((prime * result)
            + ((pojosAsKotlinDataClasses == null) ? 0 : pojosAsKotlinDataClasses.hashCode()));
    ...
    result =
        ((prime * result) + ((immutableInterfaces == null) ? 0 : immutableInterfaces.hashCode()));
    result =
        ((prime * result)
            + ((serializableInterfaces == null) ? 0 : serializableInterfaces.hashCode()));
    ...
    result =
        ((prime * result)
            + ((validationAnnotations == null) ? 0 : validationAnnotations.hashCode()));
    result = ((prime * result) + ((springAnnotations == null) ? 0 : springAnnotations.hashCode()));
    result =
        ((prime * result)
            + ((kotlinSetterJvmNameAnnotationsOnIsPrefix == null)
                ? 0
                : kotlinSetterJvmNameAnnotationsOnIsPrefix.hashCode()));
    result =
        ((prime * result)
            + ((globalObjectReferences == null) ? 0 : globalObjectReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalCatalogReferences == null) ? 0 : globalCatalogReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalSchemaReferences == null) ? 0 : globalSchemaReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalDomainReferences == null) ? 0 : globalDomainReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalTableReferences == null) ? 0 : globalTableReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalSequenceReferences == null) ? 0 : globalSequenceReferences.hashCode()));
    result =
        ((prime * result) + ((globalUDTReferences == null) ? 0 : globalUDTReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalRoutineReferences == null) ? 0 : globalRoutineReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalQueueReferences == null) ? 0 : globalQueueReferences.hashCode()));
    result =
        ((prime * result) + ((globalLinkReferences == null) ? 0 : globalLinkReferences.hashCode()));
    result =
        ((prime * result) + ((globalKeyReferences == null) ? 0 : globalKeyReferences.hashCode()));
    result =
        ((prime * result)
            + ((globalIndexReferences == null) ? 0 : globalIndexReferences.hashCode()));
    result = ((prime * result) + ((javadoc == null) ? 0 : javadoc.hashCode()));
    result = ((prime * result) + ((comments == null) ? 0 : comments.hashCode()));
    result =
        ((prime * result) + ((commentsOnCatalogs == null) ? 0 : commentsOnCatalogs.hashCode()));
    ...
    result =
        ((prime * result)
            + ((commentsOnEmbeddables == null) ? 0 : commentsOnEmbeddables.hashCode()));
    result = ((prime * result) + ((commentsOnUDTs == null) ? 0 : commentsOnUDTs.hashCode()));
    result =
        ((prime * result) + ((commentsOnAttributes == null) ? 0 : commentsOnAttributes.hashCode()));
    result =
        ((prime * result) + ((commentsOnPackages == null) ? 0 : commentsOnPackages.hashCode()));
    result =
        ((prime * result) + ((commentsOnRoutines == null) ? 0 : commentsOnRoutines.hashCode()));
    result =
        ((prime * result) + ((commentsOnParameters == null) ? 0 : commentsOnParameters.hashCode()));
    result =
        ((prime * result) + ((commentsOnSequences == null) ? 0 : commentsOnSequences.hashCode()));
    ...
    result =
        ((prime * result)
            + ((javaBeansGettersAndSetters == null) ? 0 : javaBeansGettersAndSetters.hashCode()));
    result = ((prime * result) + ((varargSetters == null) ? 0 : varargSetters.hashCode()));
    result =
        ((prime * result)
            + ((generatedSerialVersionUID == null) ? 0 : generatedSerialVersionUID.hashCode()));
    result =
        ((prime * result)
            + ((maxMembersPerInitialiser == null) ? 0 : maxMembersPerInitialiser.hashCode()));
    result =
        ((prime * result) + ((fullyQualifiedTypes == null) ? 0 : fullyQualifiedTypes.hashCode()));
    ...
    result =
        ((prime * result)
            + ((printMarginForBlockComment == null) ? 0 : printMarginForBlockComment.hashCode()));
    return result;
  }
}
