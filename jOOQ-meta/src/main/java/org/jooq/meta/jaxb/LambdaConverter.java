...
public class LambdaConverter implements Serializable, XMLAppendable {
  ...
  /**
   * Whether to use {@link org.jooq.Converter#ofNullable(Class, Class, java.util.function.Function,
   * java.util.function.Function)} or {@link org.jooq.Converter#of(Class, Class,
