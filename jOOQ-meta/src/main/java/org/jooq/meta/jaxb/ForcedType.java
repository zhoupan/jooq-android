...
public class ForcedType implements Serializable, XMLAppendable {
  ...
  /**
   * The priority among forced types in which to apply this one. Forced types of equal priority will
   * be applied in the order in which they're added to the forced types list (e.g. the Maven lexical
   * XML order)
   */
   ...
   *
   * <p>If provided, {@link #getName()} will be ignored, and either {@link #getConverter()} or
   * {@link #getBinding()} is required
   */
  ...
  /**
   * A Java regular expression matching columns, parameters, attributes, etc. which must not have
   * this type. Excludes match before includes, i.e. excludes have a higher priority.
   */
  ...
  /**
   * A Java regular expression matching columns, parameters, attributes, etc. to be forced to have
   * this type. If provided, both "includeExpression" and "includeTypes" must match.
   */
  ...
  /**
   * A SQL statement that produces a table with one column containing the matched qualified or
  ...
  /**
   * A Java regular expression matching data types which must not have this type. Excludes match
  ...
  /**
   * A Java regular expression matching data types to be forced to have this type. If provided, both
   * "includeExpression" and "includeTypes" must match.
   */
