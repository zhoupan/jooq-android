...
public class Database implements Serializable, XMLAppendable {
  ...
  /**
   * The database dialect from jooq-meta. Available dialects are named <code>
   * org.util.[database].[database]Database</code>.
   *
   * <p>Natively supported values are:
   *
   * <ul>
   *   <li>{@link org.jooq.meta.ase.ASEDatabase}
   *   <li>{@link org.jooq.meta.cockroachdb.CockroachDBDatabase}
   *   <li>{@link org.jooq.meta.db2.DB2Database}
   *   <li>{@link org.jooq.meta.derby.DerbyDatabase}
   *   <li>{@link org.jooq.meta.firebird.FirebirdDatabase}
   *   <li>{@link org.jooq.meta.h2.H2Database}
   *   <li>{@link org.jooq.meta.hana.HanaDatabase}
   *   <li>{@link org.jooq.meta.hsqldb.HSQLDBDatabase}
   *   <li>{@link org.jooq.meta.informix.InformixDatabase}
   *   <li>{@link org.jooq.meta.ingres.IngresDatabase}
   *   <li>{@link org.jooq.meta.mariadb.MariaDBDatabase}
   *   <li>{@link org.jooq.meta.mysql.MySQLDatabase}
   *   <li>{@link org.jooq.meta.oracle.OracleDatabase}
   *   <li>{@link org.jooq.meta.postgres.PostgresDatabase}
   *   <li>{@link org.jooq.meta.redshift.RedshiftDatabase}
   *   <li>{@link org.jooq.meta.sqlite.SQLiteDatabase}
   *   <li>{@link org.jooq.meta.sqlserver.SQLServerDatabase}
   *   <li>{@link org.jooq.meta.sybase.SybaseDatabase}
   *   <li>{@link org.jooq.meta.vertica.VerticaDatabase}
   * </ul>
   *
   * <p>This value can be used to reverse-engineer generic JDBC DatabaseMetaData (e.g. for MS
   * Access).
   *
   * <ul>
   *   <li>{@link org.jooq.meta.jdbc.JDBCDatabase}
   * </ul>
   *
   * <p>This value can be used to reverse-engineer standard jOOQ-meta XML formats.
   *
   * <ul>
   *   <li>{@link org.jooq.meta.xml.XMLDatabase}
   * </ul>
   *
   * <p>This value can be used to reverse-engineer JPA annotated entities
   *
   * <ul>
   *   <li>{@link org.jooq.meta.extensions.jpa.JPADatabase}
   * </ul>
   *
   * <p>You can also provide your own org.jooq.meta.Database implementation here, if your database
   ...
   *
   * <p>The default value is "COMMENTS CASE_INSENSITIVE"Gets the value of the regexFlags property.
   *
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the regexFlags property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RegexFlag }
   */
  ...
  /**
   * Whether regular expressions that match qualified object names also match partial qualifications
   * (e.g. `table\.column` matches `schema.table.column`) or only full and/or no qualifications
   * (e.g. `schema\.table\.column` and `column` match `schema.table.column`)
   *
   ...
   * `table\.column` matches `schema.table.column`) or only full and/or no qualifications (e.g.
   * `schema\.table\.column` and `column` match `schema.table.column`)
   *
   * @return possible object is {@link Boolean }
   */
   ...
   *
   * <p>This is a Java regular expression. Use the pipe to separate several expressions. Watch out
   * for case-sensitivity. Depending on your database, this might be important!
   *
   * <p>You can create case-insensitive regular expressions using this syntax: <code>(?i:expr)
   * </code>
   *
   * <p>Whitespace is ignored and comments are possible unless overridden in {@link
   * #getRegexFlags()}.
   */
   ...
   *
   * <p>This is a Java regular expression. Use the pipe to separate several expressions. Excludes
   * match before includes, i.e. excludes have a higher priority.
   */
  ...
  /**
   * This flag indicates whether include / exclude patterns should also match routines within
   * packages.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether embeddable types should be included in output produced by this
   * database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether trigger implementation routines should be included in output
   * produced by this database (e.g. in PostgreSQL)
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether routines contained in packages should be included in output
   * produced by this database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether UDTs contained in packages should be included in output produced by
   * this database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether constants contained in packages should be included in output
   * produced by this database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether check constraints should be included in output produced by this
   * database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether system tables should be included in output produced by this
   * database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether system generated indexes should be included in output produced by
   * this database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether system generated check constraints should be included in output
   * produced by this database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether system generated sequences should be included in output produced by
   * this database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether system generated UDTs should be included in output produced by this
   * database
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * This flag indicates whether invisible columns should be included in output produced by this
   * database
   *
   * @return possible object is {@link Boolean }
   */
   ...
   *
   * <p>This is a Java regular expression. Use the pipe to separate several expressions. See {@link
   * org.jooq.UpdatableRecord#store()} and {@link org.jooq.UpdatableRecord#delete()} for details
   ...
   *
   * <p>To be used if columns are not detected as automatically as identities.
   */
  ...
  /**
   * A regular expression matching all columns that participate in "synthetic" primary keys, which
   * should be placed on generated {@link org.jooq.UpdatableRecord}
   *
   * <p>To be used with:
   *
   * <ul>
   *   <li>{@link org.jooq.UpdatableRecord#store()}
   *   <li>{@link org.jooq.UpdatableRecord#update()}
   *   <li>{@link org.jooq.UpdatableRecord#delete()}
   *   <li>{@link org.jooq.UpdatableRecord#refresh()}
   * </ul>
   *
   * <p>Synthetic primary keys will override existing primary keys.
   */
  ...
  /**
   * All (UNIQUE) key names that should be used instead of primary keys on generated {@link
   ...
   * </ul>
   *
   * <p>If several keys match, a warning is emitted and the first one encountered will be used.
   *
   * <p>This flag will also replace synthetic primary keys, if it matches.
   */
  ...
  /**
   * Generate {@link java.sql.Timestamp} fields for DATE columns. This is particularly useful for
   * Oracle databases
   *
   * @return possible object is {@link Boolean }
   */
   ...
   *
   * <p>In jOOQ 3.6.0, #4106 was implemented to support Transact-SQL's optional return values from
   * stored procedures. This turns all procedures into Routine<Integer> (instead of Routine<Void>).
  ...
  /**
   * Include display width in type declaration. In some RDBMS (e.g. MariaDB, MySQL), fixed width
   * integer types are optionally accompanied by a display width. This is sometimes abused to model
   * BOOLEAN types via TINYINT(1). This flag allows for including that display width in the type
   * declaration exposed by jOOQ-meta code, as if it were a numeric precision.
   *
   * @return possible object is {@link Boolean }
   */
   ...
   *
   * <p>This cannot be combined with the {@link #getCatalogs()} configuration element. If left empty
   * (and without any {@link #getCatalogs()} configuration element), jOOQ will generate all
   * available catalogs.
   */
   ...
   *
   * <p>Use this to override your local development catalog name for source code generation. If not
   * specified, this will be the same as {@link #getInputCatalog()}
   *
   * <p>This will be ignored if {@link #isOutputCatalogToDefault()} is set to true
   */
  ...
  /**
   * A flag to indicate that the outputCatalog should be the "default" catalog, which generates
   * catalog-less, unqualified tables, procedures, etc.
   *
   * @return possible object is {@link Boolean }
   */
   ...
   *
   * <p>This cannot be combined with the {@link #getSchemata()} configuration element. If left empty
   * (and without any {@link #getSchemata()} configuration element), jOOQ will generate all
   * available schemata.
   */
   ...
   *
   * <p>Use this to override your local development schema name for source code generation. If not
   * specified, this will be the same as {@link #getInputSchema()}.
   *
   * <p>This will be ignored if {@link #isOutputSchemaToDefault()} is set to true
   */
  ...
  /**
   * A flag to indicate that the outputSchema should be the "default" schema, which generates
   * schema-less, unqualified tables, procedures, etc.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * A custom version number that, if available, will be used to assess whether the {@link
   * #getInputSchema()} will need to be regenerated.
   *
   * <p>There are three operation modes for this element:
   *
   * <ul>
   *   <li>The value is a class that can be found on the classpath and that implements {@link
   *       org.jooq.meta.SchemaVersionProvider}. Such classes must provide a default constructor
   *   <li>The value is a SELECT statement that returns one record with one column. The SELECT
   *       statement may contain a named variable called :schema_name
   *   <li>The value is a constant, such as a Maven property
   * </ul>
   *
   * <p>Schema versions will be generated into the {@link javax.annotation.processing.Generated}
   ...
   * <ul>
   *   <li>The value is a class that can be found on the classpath and that implements {@link
   *       org.jooq.meta.CatalogVersionProvider}. Such classes must provide a default constructor
   *   <li>The value is a SELECT statement that returns one record with one column. The SELECT
   *       statement may contain a named variable called :catalog_name
   *   <li>The value is a constant, such as a Maven property
   *       <p>Catalog versions will be generated into the {@link
   *       javax.annotation.processing.Generated} annotation on generated artefacts.
   */
  ...
  /**
   * A custom {@link java.util.Comparator} that can compare two {@link org.jooq.meta.Definition}
   * objects to determine their order.
   *
   * <p>This comparator can be used to influence the order of any object that is produced by jOOQ
   * meta, and thus, indirectly, the order of declared objects in generated code.
   */
  ...
  /**
   * A regular expression matching all primary key declarations for which wrapper types should be
   * generated, and for their referencing foreign keys.
   *
  ...
  /**
   * A regular expression matching all unique key declarations for which wrapper types should be
   * generated, and for their referencing foreign keys.
   *
   * <p>This feature is available in the commercial distribution only.
   */
  ...
  /**
   * A regular expression matching all domain type declarations for which wrapper types should be
   * generated.
   *
   * <p>This feature is available in the commercial distribution only.
   */
   ...
   * integer type (e.g. NUMBER(2, 0) and less: Byte). This allows for turning off this feature. In
   * case of conflict between this rule and actual {@link #getForcedTypes()}, the latter will win.
   *
   * @return possible object is {@link Boolean }
   */
   ...
   *
   * <p>If this is deactivated, such functions are not generated as tables, but as ordinary
   * routines. This is particularly useful for backwards- compatibility between jOOQ 3.8 and
   * previous versions, when using TABLE and VARRAY types in Oracle.
   *
   * <p>While this flag defaults to true for most databases, it defaults to false for Oracle.
   *
   * @return possible object is {@link Boolean }
   */
  ...
  /**
   * The number of seconds that are considered "slow" before a query is logged to indicate a bug, 0
   * for not logging.
   */
  ...
  /**
   * The number of seconds that are considered "slow" before a result set is logged to indicate a
   * bug, 0 for not logging.
   */
  ...
  public int hashCode() {
    ...
    result =
        ((prime * result)
            + ((regexMatchesPartialQualification == null)
                ? 0
                : regexMatchesPartialQualification.hashCode()));
    result =
        ((prime * result)
            + ((sqlMatchesPartialQualification == null)
                ? 0
                : sqlMatchesPartialQualification.hashCode()));
    result = ((prime * result) + ((includes == null) ? 0 : includes.hashCode()));
    result = ((prime * result) + ((excludes == null) ? 0 : excludes.hashCode()));
    result =
        ((prime * result)
            + ((includeExcludeColumns == null) ? 0 : includeExcludeColumns.hashCode()));
    result =
        ((prime * result)
            + ((includeExcludePackageRoutines == null)
                ? 0
                : includeExcludePackageRoutines.hashCode()));
    result = ((prime * result) + ((includeTables == null) ? 0 : includeTables.hashCode()));
    result =
        ((prime * result) + ((includeEmbeddables == null) ? 0 : includeEmbeddables.hashCode()));
    result = ((prime * result) + ((includeRoutines == null) ? 0 : includeRoutines.hashCode()));
    result =
        ((prime * result)
            + ((includeTriggerRoutines == null) ? 0 : includeTriggerRoutines.hashCode()));
    result = ((prime * result) + ((includePackages == null) ? 0 : includePackages.hashCode()));
    result =
        ((prime * result)
            + ((includePackageRoutines == null) ? 0 : includePackageRoutines.hashCode()));
    result =
        ((prime * result) + ((includePackageUDTs == null) ? 0 : includePackageUDTs.hashCode()));
    result =
        ((prime * result)
            + ((includePackageConstants == null) ? 0 : includePackageConstants.hashCode()));
    ...
    result =
        ((prime * result) + ((includePrimaryKeys == null) ? 0 : includePrimaryKeys.hashCode()));
    result = ((prime * result) + ((includeUniqueKeys == null) ? 0 : includeUniqueKeys.hashCode()));
    result =
        ((prime * result) + ((includeForeignKeys == null) ? 0 : includeForeignKeys.hashCode()));
    result =
        ((prime * result)
            + ((includeCheckConstraints == null) ? 0 : includeCheckConstraints.hashCode()));
    result =
        ((prime * result) + ((includeSystemTables == null) ? 0 : includeSystemTables.hashCode()));
    result =
        ((prime * result) + ((includeSystemIndexes == null) ? 0 : includeSystemIndexes.hashCode()));
    result =
        ((prime * result)
            + ((includeSystemCheckConstraints == null)
                ? 0
                : includeSystemCheckConstraints.hashCode()));
    result =
        ((prime * result)
            + ((includeSystemSequences == null) ? 0 : includeSystemSequences.hashCode()));
    result = ((prime * result) + ((includeSystemUDTs == null) ? 0 : includeSystemUDTs.hashCode()));
    result =
        ((prime * result)
            + ((includeInvisibleColumns == null) ? 0 : includeInvisibleColumns.hashCode()));
    result =
        ((prime * result) + ((recordVersionFields == null) ? 0 : recordVersionFields.hashCode()));
    result =
        ((prime * result)
            + ((recordTimestampFields == null) ? 0 : recordTimestampFields.hashCode()));
    result = ((prime * result) + ((syntheticObjects == null) ? 0 : syntheticObjects.hashCode()));
    result =
        ((prime * result) + ((syntheticIdentities == null) ? 0 : syntheticIdentities.hashCode()));
    result =
        ((prime * result) + ((syntheticPrimaryKeys == null) ? 0 : syntheticPrimaryKeys.hashCode()));
    result =
        ((prime * result) + ((overridePrimaryKeys == null) ? 0 : overridePrimaryKeys.hashCode()));
    result = ((prime * result) + ((dateAsTimestamp == null) ? 0 : dateAsTimestamp.hashCode()));
    result =
        ((prime * result)
            + ((ignoreProcedureReturnValues == null) ? 0 : ignoreProcedureReturnValues.hashCode()));
    result = ((prime * result) + ((unsignedTypes == null) ? 0 : unsignedTypes.hashCode()));
    result =
        ((prime * result) + ((integerDisplayWidths == null) ? 0 : integerDisplayWidths.hashCode()));
    ...
    result =
        ((prime * result)
            + ((outputCatalogToDefault == null) ? 0 : outputCatalogToDefault.hashCode()));
    ...
    result =
        ((prime * result)
            + ((schemaVersionProvider == null) ? 0 : schemaVersionProvider.hashCode()));
    result =
        ((prime * result)
            + ((catalogVersionProvider == null) ? 0 : catalogVersionProvider.hashCode()));
    result = ((prime * result) + ((orderProvider == null) ? 0 : orderProvider.hashCode()));
    result =
        ((prime * result)
            + ((embeddablePrimaryKeys == null) ? 0 : embeddablePrimaryKeys.hashCode()));
    result =
        ((prime * result) + ((embeddableUniqueKeys == null) ? 0 : embeddableUniqueKeys.hashCode()));
    ...
    result =
        ((prime * result) + ((tableValuedFunctions == null) ? 0 : tableValuedFunctions.hashCode()));
    result =
        ((prime * result)
            + ((logSlowQueriesAfterSeconds == null) ? 0 : logSlowQueriesAfterSeconds.hashCode()));
    result =
        ((prime * result)
            + ((logSlowResultsAfterSeconds == null) ? 0 : logSlowResultsAfterSeconds.hashCode()));
