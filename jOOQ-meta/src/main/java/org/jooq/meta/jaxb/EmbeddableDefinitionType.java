...
public class EmbeddableDefinitionType implements Serializable, XMLAppendable {
  ...
  /**
   * The defining catalog of the embeddable type, or the catalog of the first matched table if left
   * empty.
   */
  ...
  /**
   * The defining schema of the embeddable type, or the schema of the first matched table if left
   * empty.
   */
  ...
  /**
   * Specify that the embeddable field replaces its underlying fields in code generation output, and
   * when working with asterisks.
   *
  ...
  public int hashCode() {
    ...
    result =
        ((prime * result) + ((referencingComment == null) ? 0 : referencingComment.hashCode()));
