...
public class MatchersRoutineType implements Serializable, XMLAppendable {
  ...
  /**
   * This routine matcher applies to all unqualified or qualified routine names matched by this
   * expression. If left empty, this matcher applies to all routines.
   */
  ...
  /**
   * This rule influences the naming of generated convenience methods used to call the {@link
   * org.jooq.Routine}.
   */
  ...
  /**
   * This string provides additional interfaces that a generated {@link org.jooq.Routine} should
   * implement.
   */
