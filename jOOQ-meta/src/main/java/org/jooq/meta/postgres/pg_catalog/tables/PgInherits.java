...
public class PgInherits extends TableImpl<Record> {
  ...
  public final TableField<Record, Long> INHRELID =
      createField(DSL.name("inhrelid"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_inherits.inhparent</code>. */
  public final TableField<Record, Long> INHPARENT =
      createField(DSL.name("inhparent"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_inherits.inhseqno</code>. */
  public final TableField<Record, Integer> INHSEQNO =
      createField(DSL.name("inhseqno"), SQLDataType.INTEGER.nullable(false), this, "");
