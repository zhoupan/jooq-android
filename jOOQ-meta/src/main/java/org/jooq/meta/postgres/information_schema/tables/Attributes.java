...
public class Attributes extends TableImpl<Record> {
  ...
  public final TableField<Record, String> ATTRIBUTE_NAME =
      createField(DSL.name("attribute_name"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> ATTRIBUTE_DEFAULT =
      createField(DSL.name("attribute_default"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> ATTRIBUTE_UDT_CATALOG =
      createField(DSL.name("attribute_udt_catalog"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> ATTRIBUTE_UDT_SCHEMA =
      createField(DSL.name("attribute_udt_schema"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> ATTRIBUTE_UDT_NAME =
      createField(DSL.name("attribute_udt_name"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> IS_DERIVED_REFERENCE_ATTRIBUTE =
      createField(DSL.name("is_derived_reference_attribute"), SQLDataType.VARCHAR(3), this, "");
