...
public class ReferentialConstraints extends TableImpl<Record> {
  ...
  public final TableField<Record, String> CONSTRAINT_CATALOG =
      createField(DSL.name("constraint_catalog"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> CONSTRAINT_SCHEMA =
      createField(DSL.name("constraint_schema"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> CONSTRAINT_NAME =
      createField(DSL.name("constraint_name"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> UNIQUE_CONSTRAINT_CATALOG =
      createField(DSL.name("unique_constraint_catalog"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> UNIQUE_CONSTRAINT_SCHEMA =
      createField(DSL.name("unique_constraint_schema"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> UNIQUE_CONSTRAINT_NAME =
      createField(DSL.name("unique_constraint_name"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> MATCH_OPTION =
      createField(DSL.name("match_option"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> UPDATE_RULE =
      createField(DSL.name("update_rule"), SQLDataType.VARCHAR, this, "");
  ...
  public final TableField<Record, String> DELETE_RULE =
      createField(DSL.name("delete_rule"), SQLDataType.VARCHAR, this, "");
