...
public class PostgresTableValuedFunction extends AbstractTableDefinition {
  ...
  public PostgresTableValuedFunction(
      SchemaDefinition schema, String name, String specificName, String comment) {
  ...
  public List<ColumnDefinition> getElements0() throws SQLException {
    ...
    for (Record record :
        create()
            ...
            .join(pg_n)
            .on(r.SPECIFIC_SCHEMA.eq(pg_n.NSPNAME))
            .join(pg_p)
            ...
            .unionAll(
                ...
                select(
                        ...
                        coalesce(c.CHARACTER_MAXIMUM_LENGTH, r.CHARACTER_MAXIMUM_LENGTH)
                            .as(c.CHARACTER_MAXIMUM_LENGTH),
