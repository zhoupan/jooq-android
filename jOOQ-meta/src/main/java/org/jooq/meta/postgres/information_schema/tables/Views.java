...
public class Views extends TableImpl<Record> {
  ...
  public final TableField<Record, String> VIEW_DEFINITION =
      createField(DSL.name("view_definition"), SQLDataType.VARCHAR, this, "");

  /** The column <code>information_schema.views.check_option</code>. */
  public final TableField<Record, String> CHECK_OPTION =
      createField(DSL.name("check_option"), SQLDataType.VARCHAR, this, "");
  ...
  public List<ForeignKey<Record, ?>> getReferences() {
    return Arrays.<ForeignKey<Record, ?>>asList(
        Keys.VIEWS__SYNTHETIC_FK_VIEWS__SYNTHETIC_PK_TABLES);
  }
