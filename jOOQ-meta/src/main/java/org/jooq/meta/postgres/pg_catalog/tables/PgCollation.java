...
public class PgCollation extends TableImpl<Record> {
  ...
  public final TableField<Record, String> COLLNAME =
      createField(DSL.name("collname"), SQLDataType.VARCHAR.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collnamespace</code>. */
  public final TableField<Record, Long> COLLNAMESPACE =
      createField(DSL.name("collnamespace"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collowner</code>. */
  public final TableField<Record, Long> COLLOWNER =
      createField(DSL.name("collowner"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collprovider</code>. */
  public final TableField<Record, String> COLLPROVIDER =
      createField(DSL.name("collprovider"), SQLDataType.CHAR.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collisdeterministic</code>. */
  public final TableField<Record, Boolean> COLLISDETERMINISTIC =
      createField(DSL.name("collisdeterministic"), SQLDataType.BOOLEAN.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collencoding</code>. */
  public final TableField<Record, Integer> COLLENCODING =
      createField(DSL.name("collencoding"), SQLDataType.INTEGER.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collcollate</code>. */
  public final TableField<Record, String> COLLCOLLATE =
      createField(DSL.name("collcollate"), SQLDataType.VARCHAR.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collctype</code>. */
  public final TableField<Record, String> COLLCTYPE =
      createField(DSL.name("collctype"), SQLDataType.VARCHAR.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_collation.collversion</code>. */
  public final TableField<Record, String> COLLVERSION =
      createField(DSL.name("collversion"), SQLDataType.CLOB, this, "");
