...
public class PgNamespace extends TableImpl<Record> {
  ...
  public final TableField<Record, String> NSPNAME =
      createField(DSL.name("nspname"), SQLDataType.VARCHAR.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_namespace.nspowner</code>. */
  public final TableField<Record, Long> NSPOWNER =
      createField(DSL.name("nspowner"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>pg_catalog.pg_namespace.nspacl</code>. */
  public final TableField<Record, String[]> NSPACL =
      createField(DSL.name("nspacl"), SQLDataType.VARCHAR.getArrayDataType(), this, "");
