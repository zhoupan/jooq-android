...
public class Rdb$functions extends TableImpl<Record> {
  ...
  public final TableField<Record, Short> RDB$FUNCTION_TYPE =
      createField(DSL.name("RDB$FUNCTION_TYPE"), SQLDataType.SMALLINT, this, "");
  ...
  public final TableField<Record, String> RDB$ENGINE_NAME =
      createField(DSL.name("RDB$ENGINE_NAME"), SQLDataType.CHAR(31), this, "");
  ...
  public final TableField<Record, Short> RDB$LEGACY_FLAG =
      createField(DSL.name("RDB$LEGACY_FLAG"), SQLDataType.SMALLINT, this, "");

  /** The column <code>RDB$FUNCTIONS.RDB$DETERMINISTIC_FLAG</code>. */
  public final TableField<Record, Short> RDB$DETERMINISTIC_FLAG =
      createField(DSL.name("RDB$DETERMINISTIC_FLAG"), SQLDataType.SMALLINT, this, "");
