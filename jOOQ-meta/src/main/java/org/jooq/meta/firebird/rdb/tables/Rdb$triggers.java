...
public class Rdb$triggers extends TableImpl<Record> {
  ...
  public final TableField<Record, Short> RDB$TRIGGER_INACTIVE =
      createField(DSL.name("RDB$TRIGGER_INACTIVE"), SQLDataType.SMALLINT, this, "");
