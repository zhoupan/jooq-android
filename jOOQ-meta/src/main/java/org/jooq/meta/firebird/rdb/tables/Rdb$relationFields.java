...
public class Rdb$relationFields extends TableImpl<Record> {
  ...
  public final TableField<Record, String> RDB$BASE_FIELD =
      createField(DSL.name("RDB$BASE_FIELD"), SQLDataType.CHAR(31), this, "");
  ...
  public final TableField<Record, Short> RDB$UPDATE_FLAG =
      createField(DSL.name("RDB$UPDATE_FLAG"), SQLDataType.SMALLINT, this, "");
  ...
  public final TableField<Record, Short> RDB$VIEW_CONTEXT =
      createField(DSL.name("RDB$VIEW_CONTEXT"), SQLDataType.SMALLINT, this, "");
  ...
  public final TableField<Record, String> RDB$COMPLEX_NAME =
      createField(DSL.name("RDB$COMPLEX_NAME"), SQLDataType.CHAR(31), this, "");
  ...
  public final TableField<Record, String> RDB$GENERATOR_NAME =
      createField(DSL.name("RDB$GENERATOR_NAME"), SQLDataType.CHAR(31), this, "");

  /** The column <code>RDB$RELATION_FIELDS.RDB$IDENTITY_TYPE</code>. */
  public final TableField<Record, Short> RDB$IDENTITY_TYPE =
      createField(DSL.name("RDB$IDENTITY_TYPE"), SQLDataType.SMALLINT, this, "");
