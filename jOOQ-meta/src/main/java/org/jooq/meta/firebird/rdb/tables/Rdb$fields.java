...
public class Rdb$fields extends TableImpl<Record> {
  ...
  public final TableField<Record, byte[]> RDB$MISSING_VALUE =
      createField(DSL.name("RDB$MISSING_VALUE"), SQLDataType.BLOB, this, "");

  /** The column <code>RDB$FIELDS.RDB$MISSING_SOURCE</code>. */
  public final TableField<Record, String> RDB$MISSING_SOURCE =
      createField(DSL.name("RDB$MISSING_SOURCE"), SQLDataType.CLOB, this, "");
  ...
  public final TableField<Record, String> RDB$SECURITY_CLASS =
      createField(DSL.name("RDB$SECURITY_CLASS"), SQLDataType.CHAR(31), this, "");

  /** The column <code>RDB$FIELDS.RDB$OWNER_NAME</code>. */
  public final TableField<Record, String> RDB$OWNER_NAME =
      createField(DSL.name("RDB$OWNER_NAME"), SQLDataType.CHAR(31), this, "");
