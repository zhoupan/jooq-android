...
public class Rdb$indices extends TableImpl<Record> {
  ...
  public final TableField<Record, Short> RDB$INDEX_ID =
      createField(DSL.name("RDB$INDEX_ID"), SQLDataType.SMALLINT, this, "");

  /** The column <code>RDB$INDICES.RDB$UNIQUE_FLAG</code>. */
  public final TableField<Record, Short> RDB$UNIQUE_FLAG =
      createField(DSL.name("RDB$UNIQUE_FLAG"), SQLDataType.SMALLINT, this, "");
  ...
  public final TableField<Record, Short> RDB$SEGMENT_COUNT =
      createField(DSL.name("RDB$SEGMENT_COUNT"), SQLDataType.SMALLINT, this, "");

  /** The column <code>RDB$INDICES.RDB$INDEX_INACTIVE</code>. */
  public final TableField<Record, Short> RDB$INDEX_INACTIVE =
      createField(DSL.name("RDB$INDEX_INACTIVE"), SQLDataType.SMALLINT, this, "");

  /** The column <code>RDB$INDICES.RDB$INDEX_TYPE</code>. */
  public final TableField<Record, Short> RDB$INDEX_TYPE =
      createField(DSL.name("RDB$INDEX_TYPE"), SQLDataType.SMALLINT, this, "");

  /** The column <code>RDB$INDICES.RDB$FOREIGN_KEY</code>. */
  public final TableField<Record, String> RDB$FOREIGN_KEY =
      createField(DSL.name("RDB$FOREIGN_KEY"), SQLDataType.CHAR(31), this, "");
  ...
  public final TableField<Record, byte[]> RDB$EXPRESSION_BLR =
      createField(DSL.name("RDB$EXPRESSION_BLR"), SQLDataType.BLOB, this, "");

  /** The column <code>RDB$INDICES.RDB$EXPRESSION_SOURCE</code>. */
  public final TableField<Record, String> RDB$EXPRESSION_SOURCE =
      createField(DSL.name("RDB$EXPRESSION_SOURCE"), SQLDataType.CLOB, this, "");
