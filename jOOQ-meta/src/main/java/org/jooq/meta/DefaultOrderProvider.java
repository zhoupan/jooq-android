 ...
 *
 * <p>jOOQ's code generator, by default, implements ordering of objects in a reasonable, predictable
 * way, according to these rules:
 *
 * <p>
 *
 * <ul>
 *   <li><strong>Alphabetic when irrelevant</strong>:<br>
 *       When the order of objects within a parent is irrelevant, they are ordered alphabetically.
 *       Such objects include:
 *       <ul>
 *         <li>{@link SchemaDefinition} within {@link CatalogDefinition}
 *         <li>{@link ArrayDefinition} within {@link SchemaDefinition}
 *         <li>{@link DomainDefinition} within {@link SchemaDefinition}
 *         <li>{@link EnumDefinition} within {@link SchemaDefinition}
 *         <li>{@link PackageDefinition} within {@link SchemaDefinition}
 *         <li>{@link RoutineDefinition} within {@link SchemaDefinition}
 *         <li>{@link UDTDefinition} within {@link SchemaDefinition}
 *         <li>{@link TableDefinition} within {@link SchemaDefinition}
 *         <li>{@link ConstraintDefinition} within {@link TableDefinition}
 *         <li>{@link IndexDefinition} within {@link TableDefinition}
 *         <li>{@link SequenceDefinition} within {@link SchemaDefinition}
 *       </ul>
 *   <li><strong>In given order when relevant</strong>:<br>
 *       When the order of objects within a parent is relevant, and provided by the database vendor,
 *       then that order is used. Such objects include:
 *       <ul>
 *         <li>{@link AttributeDefinition} within {@link UDTDefinition}
 *         <li>{@link ColumnDefinition} within {@link TableDefinition}
 *         <li>{@link IndexColumnDefinition} within {@link IndexDefinition}
 *         <li>{@link ParameterDefinition} within {@link RoutineDefinition}
 *       </ul>
 * </ul>
 *
 * @author Lukas Eder
...
public class DefaultOrderProvider implements Comparator<Definition> {
  ...
  private int compare0(RoutineDefinition r1, RoutineDefinition r2) {
    ...
    return result != 0
        ? result
        : defaultIfNull(r1.getOverload(), "").compareTo(defaultIfNull(r2.getOverload(), ""));
  }
