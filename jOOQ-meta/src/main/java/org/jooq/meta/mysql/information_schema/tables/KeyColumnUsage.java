...
public class KeyColumnUsage extends TableImpl<Record> {
  ...
  public final TableField<Record, String> CONSTRAINT_CATALOG =
      createField(
          DSL.name("CONSTRAINT_CATALOG"),
          SQLDataType.VARCHAR(64).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)),
          this,
          "");
  ...
  public final TableField<Record, UInteger> ORDINAL_POSITION =
      createField(
          ...
          SQLDataType.INTEGERUNSIGNED
              .nullable(false)
              .defaultValue(DSL.inline("0", SQLDataType.INTEGERUNSIGNED)),
          this,
          "");
  ...
  public final TableField<Record, UInteger> POSITION_IN_UNIQUE_CONSTRAINT =
      createField(DSL.name("POSITION_IN_UNIQUE_CONSTRAINT"), SQLDataType.INTEGERUNSIGNED, this, "");
  ...
  public final TableField<Record, String> REFERENCED_TABLE_SCHEMA =
      createField(DSL.name("REFERENCED_TABLE_SCHEMA"), SQLDataType.VARCHAR(64), this, "");
  ...
  public final TableField<Record, String> REFERENCED_TABLE_NAME =
      createField(DSL.name("REFERENCED_TABLE_NAME"), SQLDataType.VARCHAR(64), this, "");
  ...
  public final TableField<Record, String> REFERENCED_COLUMN_NAME =
      createField(DSL.name("REFERENCED_COLUMN_NAME"), SQLDataType.VARCHAR(64), this, "");
