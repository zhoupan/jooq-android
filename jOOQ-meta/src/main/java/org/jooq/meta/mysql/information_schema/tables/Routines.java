...
public class Routines extends TableImpl<Record> {
  ...
  public final TableField<Record, UInteger> NUMERIC_PRECISION =
      createField(DSL.name("NUMERIC_PRECISION"), SQLDataType.INTEGERUNSIGNED, this, "");

  /** The column <code>information_schema.ROUTINES.NUMERIC_SCALE</code>. */
  public final TableField<Record, UInteger> NUMERIC_SCALE =
      createField(DSL.name("NUMERIC_SCALE"), SQLDataType.INTEGERUNSIGNED, this, "");
  ...
  public final TableField<Record, UInteger> DATETIME_PRECISION =
      createField(DSL.name("DATETIME_PRECISION"), SQLDataType.INTEGERUNSIGNED, this, "");
  ...
  public final TableField<Record, String> ROUTINE_DEFINITION =
      createField(DSL.name("ROUTINE_DEFINITION"), SQLDataType.CLOB, this, "");

  /** The column <code>information_schema.ROUTINES.EXTERNAL_NAME</code>. */
  public final TableField<Record, byte[]> EXTERNAL_NAME =
      createField(DSL.name("EXTERNAL_NAME"), SQLDataType.BINARY, this, "");
  ...
  public final TableField<Record, String> EXTERNAL_LANGUAGE =
      createField(
          DSL.name("EXTERNAL_LANGUAGE"),
          SQLDataType.VARCHAR(64)
              .nullable(false)
              .defaultValue(DSL.inline("SQL", SQLDataType.VARCHAR)),
          this,
          "");
  ...
  public final TableField<Record, String> CHARACTER_SET_CLIENT =
      createField(
          DSL.name("CHARACTER_SET_CLIENT"), SQLDataType.VARCHAR(64).nullable(false), this, "");
  ...
  public final TableField<Record, String> COLLATION_CONNECTION =
      createField(
          DSL.name("COLLATION_CONNECTION"), SQLDataType.VARCHAR(64).nullable(false), this, "");
  ...
  public final TableField<Record, String> DATABASE_COLLATION =
      createField(
          DSL.name("DATABASE_COLLATION"), SQLDataType.VARCHAR(64).nullable(false), this, "");
