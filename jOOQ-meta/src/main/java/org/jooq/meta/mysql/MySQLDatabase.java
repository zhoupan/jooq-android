...
public class MySQLDatabase extends AbstractDatabase implements ResultQueryDatabase {
        ...
        create()
            ...
            .and(
                getIncludeSystemIndexes()
                    ? noCondition()
                    : row(STATISTICS.INDEX_SCHEMA, STATISTICS.TABLE_NAME, STATISTICS.INDEX_NAME)
                        .notIn(
                            select(
        ...
        .and(
            primary
                ...
                : STATISTICS
                    .INDEX_NAME
                    .ne(inline("PRIMARY"))
                    .and(STATISTICS.NON_UNIQUE.eq(inline(0))))
        .orderBy(
            STATISTICS.TABLE_SCHEMA,
            STATISTICS.TABLE_NAME,
            STATISTICS.INDEX_NAME,
  ...
  protected void loadForeignKeys(DefaultRelations relations) throws SQLException {
    for (Record record :
        create()
            ...
            .where(
                REFERENTIAL_CONSTRAINTS.CONSTRAINT_SCHEMA.in(workaroundFor5213(getInputSchemata())))
            .orderBy(
        ...
        create()
            .select(
                ...
                when(VIEWS.VIEW_DEFINITION.lower().like(inline("create%")), VIEWS.VIEW_DEFINITION)
                    .else_(
                        inline("create view `")
                            .concat(TABLES.TABLE_NAME)
                            .concat("` as ")
                            .concat(VIEWS.VIEW_DEFINITION))
                    .as(VIEWS.VIEW_DEFINITION))
            .from(TABLES)
            .leftJoin(VIEWS)
  ...
  static final class /* record */ ColumnRecord {
    ...
    public boolean equals(Object o) {
      if (!(o instanceof ColumnRecord)) return false;
      ColumnRecord other = (ColumnRecord) o;
    ...
    @Override
    public int hashCode() {
      return java.util.Objects.hash(this.schema, this.table, this.column, this.type, this.comment);
    }

    @Override
    public String toString() {
      return new StringBuilder("ColumnRecord[")
          .append("schema=")
          .append(this.schema)
          .append(", table=")
          .append(this.table)
        ...
        create()
            ...
            .where(
                COLUMNS
                    .COLUMN_TYPE
                    .like("enum(%)")
                    .and(COLUMNS.TABLE_SCHEMA.in(workaroundFor5213(getInputSchemata()))))
            .orderBy(
  ...
  protected boolean exists0(TableField<?, ?> field) {
    return exists1(
        field, COLUMNS.COLUMNS, COLUMNS.TABLE_SCHEMA, COLUMNS.TABLE_NAME, COLUMNS.COLUMN_NAME);
  }
