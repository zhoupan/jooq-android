...
public class ReferentialConstraints extends TableImpl<Record> {
  ...
  public final TableField<Record, String> CONSTRAINT_CATALOG =
      createField(
          DSL.name("CONSTRAINT_CATALOG"), SQLDataType.VARCHAR(64).nullable(false), this, "");
  ...
  public final TableField<Record, String> CONSTRAINT_SCHEMA =
      createField(DSL.name("CONSTRAINT_SCHEMA"), SQLDataType.VARCHAR(64).nullable(false), this, "");
  ...
  public final TableField<Record, String> CONSTRAINT_NAME =
      createField(DSL.name("CONSTRAINT_NAME"), SQLDataType.VARCHAR(64), this, "");
  ...
  public final TableField<Record, String> UNIQUE_CONSTRAINT_CATALOG =
      createField(
          DSL.name("UNIQUE_CONSTRAINT_CATALOG"), SQLDataType.VARCHAR(64).nullable(false), this, "");
  ...
  public final TableField<Record, String> UNIQUE_CONSTRAINT_SCHEMA =
      createField(
          DSL.name("UNIQUE_CONSTRAINT_SCHEMA"), SQLDataType.VARCHAR(64).nullable(false), this, "");
  ...
  public final TableField<Record, String> UNIQUE_CONSTRAINT_NAME =
      createField(DSL.name("UNIQUE_CONSTRAINT_NAME"), SQLDataType.VARCHAR(64), this, "");
  ...
  public final TableField<Record, String> MATCH_OPTION =
      createField(DSL.name("MATCH_OPTION"), SQLDataType.VARCHAR(7).nullable(false), this, "");
  ...
  public final TableField<Record, String> UPDATE_RULE =
      createField(DSL.name("UPDATE_RULE"), SQLDataType.VARCHAR(11).nullable(false), this, "");
  ...
  public final TableField<Record, String> DELETE_RULE =
      createField(DSL.name("DELETE_RULE"), SQLDataType.VARCHAR(11).nullable(false), this, "");
  ...
  public final TableField<Record, String> REFERENCED_TABLE_NAME =
      createField(
          DSL.name("REFERENCED_TABLE_NAME"), SQLDataType.VARCHAR(64).nullable(false), this, "");
