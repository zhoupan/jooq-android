...
public class Columns extends TableImpl<Record> {
  ...
  public final TableField<Record, UInteger> ORDINAL_POSITION =
      createField(
          DSL.name("ORDINAL_POSITION"), SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

  /** The column <code>information_schema.COLUMNS.COLUMN_DEFAULT</code>. */
  public final TableField<Record, String> COLUMN_DEFAULT =
      createField(DSL.name("COLUMN_DEFAULT"), SQLDataType.CLOB, this, "");
  ...
  public final TableField<Record, ULong> NUMERIC_PRECISION =
      createField(DSL.name("NUMERIC_PRECISION"), SQLDataType.BIGINTUNSIGNED, this, "");

  /** The column <code>information_schema.COLUMNS.NUMERIC_SCALE</code>. */
  public final TableField<Record, ULong> NUMERIC_SCALE =
      createField(DSL.name("NUMERIC_SCALE"), SQLDataType.BIGINTUNSIGNED, this, "");
  ...
  public final TableField<Record, String> GENERATION_EXPRESSION =
      createField(DSL.name("GENERATION_EXPRESSION"), SQLDataType.CLOB.nullable(false), this, "");

  /** The column <code>information_schema.COLUMNS.SRS_ID</code>. */
  public final TableField<Record, UInteger> SRS_ID =
      createField(DSL.name("SRS_ID"), SQLDataType.INTEGERUNSIGNED, this, "");
