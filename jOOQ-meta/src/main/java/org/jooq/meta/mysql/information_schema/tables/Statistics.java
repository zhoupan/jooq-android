...
public class Statistics extends TableImpl<Record> {
  ...
  public final TableField<Record, String> INDEX_SCHEMA =
      createField(DSL.name("INDEX_SCHEMA"), SQLDataType.VARCHAR(64).nullable(false), this, "");

  /** The column <code>information_schema.STATISTICS.INDEX_NAME</code>. */
  public final TableField<Record, String> INDEX_NAME =
      createField(DSL.name("INDEX_NAME"), SQLDataType.VARCHAR(64), this, "");

  /** The column <code>information_schema.STATISTICS.SEQ_IN_INDEX</code>. */
  public final TableField<Record, UInteger> SEQ_IN_INDEX =
      createField(DSL.name("SEQ_IN_INDEX"), SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

  /** The column <code>information_schema.STATISTICS.COLUMN_NAME</code>. */
  public final TableField<Record, String> COLUMN_NAME =
      createField(DSL.name("COLUMN_NAME"), SQLDataType.VARCHAR(64), this, "");

  /** The column <code>information_schema.STATISTICS.COLLATION</code>. */
  public final TableField<Record, String> COLLATION =
      createField(DSL.name("COLLATION"), SQLDataType.VARCHAR(1), this, "");

  /** The column <code>information_schema.STATISTICS.CARDINALITY</code>. */
  public final TableField<Record, Long> CARDINALITY =
      createField(DSL.name("CARDINALITY"), SQLDataType.BIGINT, this, "");

  /** The column <code>information_schema.STATISTICS.SUB_PART</code>. */
  public final TableField<Record, Long> SUB_PART =
      createField(DSL.name("SUB_PART"), SQLDataType.BIGINT, this, "");

  /** The column <code>information_schema.STATISTICS.PACKED</code>. */
  public final TableField<Record, byte[]> PACKED =
      createField(DSL.name("PACKED"), SQLDataType.BINARY, this, "");
  ...
  public final TableField<Record, String> INDEX_TYPE =
      createField(
          DSL.name("INDEX_TYPE"),
          SQLDataType.VARCHAR(11).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)),
          this,
          "");
  ...
  public final TableField<Record, String> COMMENT =
      createField(
          DSL.name("COMMENT"),
          SQLDataType.VARCHAR(8).nullable(false).defaultValue(DSL.inline("", SQLDataType.VARCHAR)),
          this,
          "");

  /** The column <code>information_schema.STATISTICS.INDEX_COMMENT</code>. */
  public final TableField<Record, String> INDEX_COMMENT =
      createField(DSL.name("INDEX_COMMENT"), SQLDataType.VARCHAR(2048).nullable(false), this, "");
  ...
  public final TableField<Record, String> EXPRESSION =
      createField(DSL.name("EXPRESSION"), SQLDataType.CLOB, this, "");
