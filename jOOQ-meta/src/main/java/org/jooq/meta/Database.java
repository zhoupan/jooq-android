...
public interface Database extends AutoCloseable {
   ...
   *
   * <p>This will combine the schemata from all catalogs in a single list. If you're working with a
   * multi-catalog environment, you may want to call {@link #getInputSchemata(String)} instead to
   * disambiguate schema names (e.g. in SQL Server, there are multiple "dbo" schemas).
   */
  ...
  /**
   * Whether zero-scale decimal types should be treated as their most appropriate, corresponding
   * integer type.
   */
  ...
  /**
   * [#3488] Add an additional filter to the database that is applied in addition to include /
   * exclude.
   */
  ...
  /**
   * Filter a list of definitions according to the exclude / include / and filter settings of this
   * database.
   */
  <D extends Definition> List<D> filterExcludeInclude(List<D> definitions);

  /**
   * Sort a list of definitions according to the {@link #getOrderProvider()} defined in this
   * database.
   */
  ...
  /**
   * Whether the regular expressions matching database objects should match partially qualified
   * names as well as fully qualified and unqualified names.
   */
  ...
  /**
   * Whether the SQL statements matching database objects should match partially qualified names as
   * well as fully qualified and unqualified names.
   */
  ...
  /**
   * Table columns matching these regular expressions will be considered as record version fields in
   * generated code.
   */
  ...
  /**
   * Table columns matching these regular expressions will be considered as record timestamp fields
   * in generated code.
   */
  ...
  /**
   * Columns matching these regular expressions will be considered as members of synthetic primary
  ...
  /**
   * Unique keys matching these regular expressions will be considered as primary keys in generated
   * code.
   *
   * @deprecated - 3.14.0 - [#10588] - Use {@link #setConfiguredSyntheticKeys(SyntheticKeysType)}
   *     instead.
  ...
  /**
   * Columns matching these regular expressions will be considered as identity columns in generated
   * code.
   *
   * @deprecated - 3.14.0 - [#10588] - Use {@link #setConfiguredSyntheticKeys(SyntheticKeysType)}
   *     instead.
  ...
  /**
   * Get the configured forced type object for any given {@link Definition}, or <code>null</code> if
   * no {@link ForcedType} matches the definition.
   */
  ...
  /**
   * A regular expression matching domain type definitions for which embeddable types should be
   * generated.
   */
   ...
   * Database properties.
   *
   * <p>These properties are typically used by database implementations like the
   * jooq-meta-extensions's <code>JPADatabase</code> (reverse-engineering JPA-annotated entities:
   * properties are used to describe entity lookup paths) or the <code>XMLDatabase</code>
   * (reverse-engineering an XML file: properties are used to describe the XML file's location).
   *
   * <p>User-defined database implementations may use these properties for the same reason.
   */
