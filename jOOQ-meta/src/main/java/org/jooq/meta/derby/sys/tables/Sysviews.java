...
public class Sysviews extends TableImpl<Record> {
  ...
  public final TableField<Record, String> VIEWDEFINITION =
      createField(DSL.name("VIEWDEFINITION"), SQLDataType.LONGVARCHAR.nullable(false), this, "");

  /** The column <code>SYS.SYSVIEWS.CHECKOPTION</code>. */
  public final TableField<Record, String> CHECKOPTION =
      createField(DSL.name("CHECKOPTION"), SQLDataType.CHAR(1).nullable(false), this, "");

  /** The column <code>SYS.SYSVIEWS.COMPILATIONSCHEMAID</code>. */
  public final TableField<Record, String> COMPILATIONSCHEMAID =
      createField(DSL.name("COMPILATIONSCHEMAID"), SQLDataType.CHAR(36), this, "");
