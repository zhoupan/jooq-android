...
public class Syssequences extends TableImpl<Record> {
  ...
  public final TableField<Record, String> SEQUENCEID =
      createField(DSL.name("SEQUENCEID"), SQLDataType.CHAR(36).nullable(false), this, "");

  /** The column <code>SYS.SYSSEQUENCES.SEQUENCENAME</code>. */
  public final TableField<Record, String> SEQUENCENAME =
      createField(DSL.name("SEQUENCENAME"), SQLDataType.VARCHAR(128).nullable(false), this, "");
  ...
  public List<ForeignKey<Record, ?>> getReferences() {
    return Arrays.<ForeignKey<Record, ?>>asList(
        Keys.SYNTHETIC_FK_SYSSEQUENCES__SYNTHETIC_PK_SYSSCHEMAS);
  }
