...
public class Sysschemas extends TableImpl<Record> {
  ...
  public final TableField<Record, String> SCHEMANAME =
      createField(DSL.name("SCHEMANAME"), SQLDataType.VARCHAR(128).nullable(false), this, "");

  /** The column <code>SYS.SYSSCHEMAS.AUTHORIZATIONID</code>. */
  public final TableField<Record, String> AUTHORIZATIONID =
      createField(DSL.name("AUTHORIZATIONID"), SQLDataType.VARCHAR(128).nullable(false), this, "");
