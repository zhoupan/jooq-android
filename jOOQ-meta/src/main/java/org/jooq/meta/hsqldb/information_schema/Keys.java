...
public class Keys {
  ...
  public static final ForeignKey<Record, Record>
      SYNTHETIC_FK_DOMAIN_CONSTRAINTS__SYNTHETIC_PK_CHECK_CONSTRAINTS =
          Internal.createForeignKey(
              ...
              DSL.name("SYNTHETIC_FK_DOMAIN_CONSTRAINTS__SYNTHETIC_PK_CHECK_CONSTRAINTS"),
              new TableField[] {
                DomainConstraints.DOMAIN_CONSTRAINTS.CONSTRAINT_CATALOG,
                DomainConstraints.DOMAIN_CONSTRAINTS.CONSTRAINT_SCHEMA,
                DomainConstraints.DOMAIN_CONSTRAINTS.CONSTRAINT_NAME
              },
              Keys.SYNTHETIC_PK_CHECK_CONSTRAINTS,
              new TableField[] {
                CheckConstraints.CHECK_CONSTRAINTS.CONSTRAINT_CATALOG,
                CheckConstraints.CHECK_CONSTRAINTS.CONSTRAINT_SCHEMA,
                CheckConstraints.CHECK_CONSTRAINTS.CONSTRAINT_NAME
  ...
  public static final ForeignKey<Record, Record>
      SYNTHETIC_FK_DOMAIN_CONSTRAINTS__SYNTHETIC_PK_DOMAINS =
          Internal.createForeignKey(
              DomainConstraints.DOMAIN_CONSTRAINTS,
              DSL.name("SYNTHETIC_FK_DOMAIN_CONSTRAINTS__SYNTHETIC_PK_DOMAINS"),
              new TableField[] {
                DomainConstraints.DOMAIN_CONSTRAINTS.DOMAIN_CATALOG,
                DomainConstraints.DOMAIN_CONSTRAINTS.DOMAIN_SCHEMA,
                DomainConstraints.DOMAIN_CONSTRAINTS.DOMAIN_NAME
              },
              Keys.SYNTHETIC_PK_DOMAINS,
              new TableField[] {
                Domains.DOMAINS.DOMAIN_CATALOG,
                Domains.DOMAINS.DOMAIN_SCHEMA,
                Domains.DOMAINS.DOMAIN_NAME
