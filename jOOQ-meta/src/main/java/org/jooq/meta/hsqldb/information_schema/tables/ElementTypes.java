...
public class ElementTypes extends TableImpl<Record> {
  ...
  private static final long serialVersionUID = -1012566751;
  ...
  public final TableField<Record, String> COLLECTION_TYPE_IDENTIFIER =
      createField(DSL.name("COLLECTION_TYPE_IDENTIFIER"), SQLDataType.VARCHAR(128), this, "");
